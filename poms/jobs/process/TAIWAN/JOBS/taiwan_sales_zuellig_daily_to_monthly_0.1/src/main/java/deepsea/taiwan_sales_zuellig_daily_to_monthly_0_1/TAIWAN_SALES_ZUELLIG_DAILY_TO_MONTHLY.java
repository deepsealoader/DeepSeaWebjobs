...
package deepsea.taiwan_sales_zuellig_daily_to_monthly_0_1;
...
/**
 * Job: TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_P11dcCgyEemFVuMGViEZbg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY = new byte[0];
    static byte[] commonByteArray_DEEPSEA_TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY.length == 0) {
   					commonByteArray_DEEPSEA_TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		deepsea.taiwan_update_one_month_sales_0_1.TAIWAN_UPDATE_ONE_MONTH_SALES childJob_tRunJob_1 = new deepsea.taiwan_update_one_month_sales_0_1.TAIWAN_UPDATE_ONE_MONTH_SALES();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLYClass = new TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY();

        int exitCode = TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLYClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY.class.getClassLoader().getResourceAsStream("deepsea/taiwan_sales_zuellig_daily_to_monthly_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TAIWAN_SALES_ZUELLIG_DAILY_TO_MONTHLY");
        }
...
/************************************************************************************************
 *     331460 characters generated by Talend Open Studio for Big Data 
 *     on the 15 February, 2019 8:35:25 AM CST
 ************************************************************************************************/