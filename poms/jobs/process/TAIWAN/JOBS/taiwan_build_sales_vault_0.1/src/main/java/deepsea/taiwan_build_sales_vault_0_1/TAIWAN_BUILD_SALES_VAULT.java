...
package deepsea.taiwan_build_sales_vault_0_1;
...
/**
 * Job: TAIWAN_BUILD_SALES_VAULT Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class TAIWAN_BUILD_SALES_VAULT implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "TAIWAN_BUILD_SALES_VAULT";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				TAIWAN_BUILD_SALES_VAULT.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(TAIWAN_BUILD_SALES_VAULT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final TAIWAN_BUILD_SALES_VAULT TAIWAN_BUILD_SALES_VAULTClass = new TAIWAN_BUILD_SALES_VAULT();

        int exitCode = TAIWAN_BUILD_SALES_VAULTClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = TAIWAN_BUILD_SALES_VAULT.class.getClassLoader().getResourceAsStream("deepsea/taiwan_build_sales_vault_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TAIWAN_BUILD_SALES_VAULT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TAIWAN_BUILD_SALES_VAULT");
        }
...
/************************************************************************************************
 *     66847 characters generated by Talend Open Studio for Big Data 
 *     on the 15 February, 2019 6:53:28 AM CST
 ************************************************************************************************/