...
package deepsea.taiwan_build_sales_links_0_1;
...
/**
 * Job: TAIWAN_BUILD_SALES_LINKS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class TAIWAN_BUILD_SALES_LINKS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "TAIWAN_BUILD_SALES_LINKS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				TAIWAN_BUILD_SALES_LINKS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(TAIWAN_BUILD_SALES_LINKS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "sales.zuellig.monthly";
		...
		obj_tRunJob_4 = "taiwan.master.producthierarchy.zuellig";
		if(obj_tRunJob_4!=null) {
		...
		obj_tRunJob_4 = "taiwan.sales.zuellig.monthly";
		if(obj_tRunJob_4!=null) {
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		obj_tRunJob_5 = "sales.zuellig.monthly";
		...
		obj_tRunJob_5 = "taiwan.master.customer.zuellig";
		if(obj_tRunJob_5!=null) {
		...
		obj_tRunJob_5 = "taiwan.sales.zuellig.monthly";
		if(obj_tRunJob_5!=null) {
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		obj_tRunJob_6 = "sales.zuellig.monthly";
		if(obj_tRunJob_6!=null) {
		...
		obj_tRunJob_6 = "taiwan.master.customer.zuellig";
		if(obj_tRunJob_6!=null) {
		...
		obj_tRunJob_6 = "taiwan.sales.zuellig.monthly";
		if(obj_tRunJob_6!=null) {
 ...
 */
    ...
    public static void main(String[] args){
        final TAIWAN_BUILD_SALES_LINKS TAIWAN_BUILD_SALES_LINKSClass = new TAIWAN_BUILD_SALES_LINKS();

        int exitCode = TAIWAN_BUILD_SALES_LINKSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = TAIWAN_BUILD_SALES_LINKS.class.getClassLoader().getResourceAsStream("deepsea/taiwan_build_sales_links_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TAIWAN_BUILD_SALES_LINKS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TAIWAN_BUILD_SALES_LINKS");
        }
...
/************************************************************************************************
 *     62080 characters generated by Talend Open Studio for Big Data 
 *     on the 15 February, 2019 6:53:20 AM CST
 ************************************************************************************************/