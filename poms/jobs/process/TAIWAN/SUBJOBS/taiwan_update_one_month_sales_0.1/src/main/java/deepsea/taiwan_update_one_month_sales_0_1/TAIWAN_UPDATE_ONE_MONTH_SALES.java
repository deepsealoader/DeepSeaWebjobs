...
package deepsea.taiwan_update_one_month_sales_0_1;
...
/**
 * Job: TAIWAN_UPDATE_ONE_MONTH_SALES Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class TAIWAN_UPDATE_ONE_MONTH_SALES implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "TAIWAN_UPDATE_ONE_MONTH_SALES";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("__TIngCguEemFVuMGViEZbg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				TAIWAN_UPDATE_ONE_MONTH_SALES.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(TAIWAN_UPDATE_ONE_MONTH_SALES.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_TAIWAN_UPDATE_ONE_MONTH_SALES = new byte[0];
    static byte[] commonByteArray_DEEPSEA_TAIWAN_UPDATE_ONE_MONTH_SALES = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_TAIWAN_UPDATE_ONE_MONTH_SALES.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_TAIWAN_UPDATE_ONE_MONTH_SALES.length == 0) {
   					commonByteArray_DEEPSEA_TAIWAN_UPDATE_ONE_MONTH_SALES = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_TAIWAN_UPDATE_ONE_MONTH_SALES = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_TAIWAN_UPDATE_ONE_MONTH_SALES, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_TAIWAN_UPDATE_ONE_MONTH_SALES, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_TAIWAN_UPDATE_ONE_MONTH_SALES) {
 ...
 */
    ...
    public static void main(String[] args){
        final TAIWAN_UPDATE_ONE_MONTH_SALES TAIWAN_UPDATE_ONE_MONTH_SALESClass = new TAIWAN_UPDATE_ONE_MONTH_SALES();

        int exitCode = TAIWAN_UPDATE_ONE_MONTH_SALESClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = TAIWAN_UPDATE_ONE_MONTH_SALES.class.getClassLoader().getResourceAsStream("deepsea/taiwan_update_one_month_sales_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TAIWAN_UPDATE_ONE_MONTH_SALES.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TAIWAN_UPDATE_ONE_MONTH_SALES");
        }
...
/************************************************************************************************
 *     350931 characters generated by Talend Open Studio for Big Data 
 *     on the March 20, 2019 9:53:32 AM SGT
 ************************************************************************************************/