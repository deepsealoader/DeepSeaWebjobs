...
package deepsea.taiwan_build_master_hubs_0_1;
...
/**
 * Job: TAIWAN_BUILD_MASTER_HUBS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class TAIWAN_BUILD_MASTER_HUBS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "TAIWAN_BUILD_MASTER_HUBS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				TAIWAN_BUILD_MASTER_HUBS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(TAIWAN_BUILD_MASTER_HUBS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		obj_tRunJob_5 = "taiwan.master.markethierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		obj_tRunJob_7 = "taiwan.master.organizationhierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		obj_tRunJob_6 = "taiwan.master.sourcechannel.servier";
 ...
 */
	...
	Object obj_tRunJob_11 = null;
		...
		obj_tRunJob_11 = "taiwan.master.producthierarchy.zuellig";
		if(obj_tRunJob_11!=null) {
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "taiwan.master.geographyhierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_12 = null;
		...
		obj_tRunJob_12 = "taiwan.master.customer.zuellig";
		if(obj_tRunJob_12!=null) {
 ...
 */
    ...
    public static void main(String[] args){
        final TAIWAN_BUILD_MASTER_HUBS TAIWAN_BUILD_MASTER_HUBSClass = new TAIWAN_BUILD_MASTER_HUBS();

        int exitCode = TAIWAN_BUILD_MASTER_HUBSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = TAIWAN_BUILD_MASTER_HUBS.class.getClassLoader().getResourceAsStream("deepsea/taiwan_build_master_hubs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TAIWAN_BUILD_MASTER_HUBS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TAIWAN_BUILD_MASTER_HUBS");
        }
...
/************************************************************************************************
 *     132129 characters generated by Talend Open Studio for Big Data 
 *     on the 15 February, 2019 6:48:22 AM CST
 ************************************************************************************************/