...
package deepsea.taiwan_build_master_sats_0_1;
...
/**
 * Job: TAIWAN_BUILD_MASTER_SATS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class TAIWAN_BUILD_MASTER_SATS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "TAIWAN_BUILD_MASTER_SATS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				TAIWAN_BUILD_MASTER_SATS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(TAIWAN_BUILD_MASTER_SATS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "taiwan.master.employee.servier";
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = "taiwan.master.markethierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "taiwan.master.organizationhierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		obj_tRunJob_5 = "taiwan.master.producthierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_10 = null;
		...
		obj_tRunJob_10 = "taiwan.master.customer.zuellig";
		if(obj_tRunJob_10!=null) {
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		obj_tRunJob_9 = "taiwan.master.salesobjectiveval.servier";
 ...
 */
    ...
    public static void main(String[] args){
        final TAIWAN_BUILD_MASTER_SATS TAIWAN_BUILD_MASTER_SATSClass = new TAIWAN_BUILD_MASTER_SATS();

        int exitCode = TAIWAN_BUILD_MASTER_SATSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = TAIWAN_BUILD_MASTER_SATS.class.getClassLoader().getResourceAsStream("deepsea/taiwan_build_master_sats_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TAIWAN_BUILD_MASTER_SATS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TAIWAN_BUILD_MASTER_SATS");
        }
...
/************************************************************************************************
 *     112613 characters generated by Talend Open Studio for Big Data 
 *     on the March 20, 2019 11:11:31 AM SGT
 ************************************************************************************************/