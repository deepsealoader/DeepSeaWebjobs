...
package deepsea.hongkong_build_master_links_0_1;
...
/**
 * Job: HONGKONG_BUILD_MASTER_LINKS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HONGKONG_BUILD_MASTER_LINKS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "HONGKONG_BUILD_MASTER_LINKS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				HONGKONG_BUILD_MASTER_LINKS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HONGKONG_BUILD_MASTER_LINKS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "ZUELLIG";
		if(obj_tRunJob_4!=null) {
			paraList_tRunJob_4.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		} else {
			paraList_tRunJob_4.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_4.put("SHEET_NAME", obj_tRunJob_4);
	
		obj_tRunJob_4 = "hongkong.master.producthierarchy.servier";
		if(obj_tRunJob_4!=null) {
		...
		obj_tRunJob_4 = "hongkong.master.producthierarchy.zuellig";
		if(obj_tRunJob_4!=null) {
		...
		obj_tRunJob_4 = "ProductHierarchy";
		if(obj_tRunJob_4!=null) {
		...
		obj_tRunJob_4 = "servierCode";
		if(obj_tRunJob_4!=null) {
			paraList_tRunJob_4.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		} else {
			paraList_tRunJob_4.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_4.put("BUSINESS_KEY1", obj_tRunJob_4);
	
		obj_tRunJob_4 = "providerCode";
		if(obj_tRunJob_4!=null) {
			paraList_tRunJob_4.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		} else {
			paraList_tRunJob_4.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_4.put("BUSINESS_KEY2", obj_tRunJob_4);
	
		obj_tRunJob_4 = "product";
		if(obj_tRunJob_4!=null) {
			paraList_tRunJob_4.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_4));
		} else {
			paraList_tRunJob_4.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_4.put("TABLE", obj_tRunJob_4);
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_19 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_19.put("WEBJOB_NAME", context.WEBJOB_NAME);
			paraList_tRunJob_19.add("--context_type " + "WEBJOB_NAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_19.put("COUNTRY", context.COUNTRY);
			paraList_tRunJob_19.add("--context_type " + "COUNTRY" + "=" + "id_String");
		
			parentContextMap_tRunJob_19.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_19.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
		
			parentContextMap_tRunJob_19.put("DEEPSEA_HOSTNAME", context.DEEPSEA_HOSTNAME);
			paraList_tRunJob_19.add("--context_type " + "DEEPSEA_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_19.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_19.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
		
			parentContextMap_tRunJob_19.put("MONGODB_HOSTNAME", context.MONGODB_HOSTNAME);
			paraList_tRunJob_19.add("--context_type " + "MONGODB_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_19.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_19.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
		
			parentContextMap_tRunJob_19.put("POSTGRES_HOSTNAME", context.POSTGRES_HOSTNAME);
			paraList_tRunJob_19.add("--context_type " + "POSTGRES_HOSTNAME" + "=" + "id_String");
	...
	Object obj_tRunJob_19 = null;
		...
		if(obj_tRunJob_19!=null) {
			paraList_tRunJob_19.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_19));
		} else {
			paraList_tRunJob_19.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_19.put("SHEET_NAME", obj_tRunJob_19);
	
		obj_tRunJob_19 = "hongkong.master.producthierarchy.servier";
		if(obj_tRunJob_19!=null) {
			paraList_tRunJob_19.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_19));
		} else {
			paraList_tRunJob_19.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_19.put("SOURCE1", obj_tRunJob_19);
	
		obj_tRunJob_19 = "hongkong.master.producthierarchy.dkhs";
		if(obj_tRunJob_19!=null) {
			paraList_tRunJob_19.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_19));
		} else {
			paraList_tRunJob_19.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_19.put("SOURCE2", obj_tRunJob_19);
	
		obj_tRunJob_19 = "ProductHierarchy";
		if(obj_tRunJob_19!=null) {
			paraList_tRunJob_19.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_19));
		} else {
			paraList_tRunJob_19.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_19.put("TYPE", obj_tRunJob_19);
	
		obj_tRunJob_19 = "servierCode";
		if(obj_tRunJob_19!=null) {
			paraList_tRunJob_19.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_19));
		} else {
			paraList_tRunJob_19.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_19.put("BUSINESS_KEY1", obj_tRunJob_19);
	
		obj_tRunJob_19 = "providerCode";
		if(obj_tRunJob_19!=null) {
			paraList_tRunJob_19.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_19));
		} else {
			paraList_tRunJob_19.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_19.put("BUSINESS_KEY2", obj_tRunJob_19);
	
		obj_tRunJob_19 = "product";
		if(obj_tRunJob_19!=null) {
			paraList_tRunJob_19.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_19));
		} else {
			paraList_tRunJob_19.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_19.put("TABLE", obj_tRunJob_19);
	
	
		deepsea.sal_master_0_1.SAL_MASTER childJob_tRunJob_19 = new deepsea.sal_master_0_1.SAL_MASTER();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_19 = childJob_tRunJob_19.runJob((String[]) paraList_tRunJob_19.toArray(new String[paraList_tRunJob_19.size()]));
		    ...
		    if (childJob_tRunJob_19.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_19.getErrorCode() != null || ("failure").equals(childJob_tRunJob_19.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_19.getException().getClass().getName() + ": " + childJob_tRunJob_19.getException().getMessage());
				}
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_20 = new java.util.ArrayList<String>();
	        			...
	        			paraList_tRunJob_20.add("--context=Production");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_20 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_20.put("WEBJOB_NAME", context.WEBJOB_NAME);
			paraList_tRunJob_20.add("--context_type " + "WEBJOB_NAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_20.put("COUNTRY", context.COUNTRY);
			paraList_tRunJob_20.add("--context_type " + "COUNTRY" + "=" + "id_String");
		
			parentContextMap_tRunJob_20.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_20.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
		
			parentContextMap_tRunJob_20.put("DEEPSEA_HOSTNAME", context.DEEPSEA_HOSTNAME);
			paraList_tRunJob_20.add("--context_type " + "DEEPSEA_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_20.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_20.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
		
			parentContextMap_tRunJob_20.put("MONGODB_HOSTNAME", context.MONGODB_HOSTNAME);
			paraList_tRunJob_20.add("--context_type " + "MONGODB_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_20.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_20.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
		
			parentContextMap_tRunJob_20.put("POSTGRES_HOSTNAME", context.POSTGRES_HOSTNAME);
			paraList_tRunJob_20.add("--context_type " + "POSTGRES_HOSTNAME" + "=" + "id_String");
	...
	Object obj_tRunJob_20 = null;
		...
		obj_tRunJob_20 = "IQVIA";
		if(obj_tRunJob_20!=null) {
			paraList_tRunJob_20.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_20));
		} else {
			paraList_tRunJob_20.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_20.put("SHEET_NAME", obj_tRunJob_20);
	
		obj_tRunJob_20 = "hongkong.master.producthierarchy.servier";
		if(obj_tRunJob_20!=null) {
			paraList_tRunJob_20.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_20));
		} else {
			paraList_tRunJob_20.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_20.put("SOURCE1", obj_tRunJob_20);
	
		obj_tRunJob_20 = "hongkong.master.producthierarchy.iqvia";
		if(obj_tRunJob_20!=null) {
			paraList_tRunJob_20.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_20));
		} else {
			paraList_tRunJob_20.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_20.put("SOURCE2", obj_tRunJob_20);
	
		obj_tRunJob_20 = "ProductHierarchy";
		if(obj_tRunJob_20!=null) {
			paraList_tRunJob_20.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_20));
		} else {
			paraList_tRunJob_20.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_20.put("TYPE", obj_tRunJob_20);
	
		obj_tRunJob_20 = "servierCode";
		if(obj_tRunJob_20!=null) {
			paraList_tRunJob_20.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_20));
		} else {
			paraList_tRunJob_20.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_20.put("BUSINESS_KEY1", obj_tRunJob_20);
	
		obj_tRunJob_20 = "providerCode";
		if(obj_tRunJob_20!=null) {
			paraList_tRunJob_20.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_20));
		} else {
			paraList_tRunJob_20.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_20.put("BUSINESS_KEY2", obj_tRunJob_20);
	
		obj_tRunJob_20 = "product";
		if(obj_tRunJob_20!=null) {
			paraList_tRunJob_20.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_20));
		} else {
			paraList_tRunJob_20.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_20.put("TABLE", obj_tRunJob_20);
	
	
		deepsea.sal_master_with_empty_0_1.SAL_MASTER_WITH_EMPTY childJob_tRunJob_20 = new deepsea.sal_master_with_empty_0_1.SAL_MASTER_WITH_EMPTY();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_20 = childJob_tRunJob_20.runJob((String[]) paraList_tRunJob_20.toArray(new String[paraList_tRunJob_20.size()]));
		    ...
		    if (childJob_tRunJob_20.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_20.getErrorCode() != null || ("failure").equals(childJob_tRunJob_20.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_20.getException().getClass().getName() + ": " + childJob_tRunJob_20.getException().getMessage());
				}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "hongkong.master.markethierarchy.servier";
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("SOURCE1", obj_tRunJob_1);
	
		obj_tRunJob_1 = "hongkong.master.producthierarchy.servier";
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("SOURCE2", obj_tRunJob_1);
	
		obj_tRunJob_1 = "ProductHierarchy";
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		...
		obj_tRunJob_1 = "ProductHierarchy";
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("SHEET_NAME", obj_tRunJob_1);
	
		obj_tRunJob_1 = "therapeuticClass";
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("BUSINESS_KEY1", obj_tRunJob_1);
	
		obj_tRunJob_1 = "codeLevel3";
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("BUSINESS_KEY2", obj_tRunJob_1);
	
		obj_tRunJob_1 = "market";
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("TABLE1", obj_tRunJob_1);
	
		obj_tRunJob_1 = "product";
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("TABLE2", obj_tRunJob_1);
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_15 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_15.put("WEBJOB_NAME", context.WEBJOB_NAME);
			paraList_tRunJob_15.add("--context_type " + "WEBJOB_NAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_15.put("COUNTRY", context.COUNTRY);
			paraList_tRunJob_15.add("--context_type " + "COUNTRY" + "=" + "id_String");
		
			parentContextMap_tRunJob_15.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_15.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
		
			parentContextMap_tRunJob_15.put("DEEPSEA_HOSTNAME", context.DEEPSEA_HOSTNAME);
			paraList_tRunJob_15.add("--context_type " + "DEEPSEA_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_15.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_15.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
		
			parentContextMap_tRunJob_15.put("MONGODB_HOSTNAME", context.MONGODB_HOSTNAME);
			paraList_tRunJob_15.add("--context_type " + "MONGODB_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_15.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_15.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
		
			parentContextMap_tRunJob_15.put("POSTGRES_HOSTNAME", context.POSTGRES_HOSTNAME);
			paraList_tRunJob_15.add("--context_type " + "POSTGRES_HOSTNAME" + "=" + "id_String");
	...
	Object obj_tRunJob_15 = null;
		...
		obj_tRunJob_15 = "ProductGeography";
		if(obj_tRunJob_15!=null) {
			paraList_tRunJob_15.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_15));
		} else {
			paraList_tRunJob_15.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_15.put("SHEET_NAME", obj_tRunJob_15);
	
		obj_tRunJob_15 = "hongkong.master.geographyhierarchy.servier";
		if(obj_tRunJob_15!=null) {
			paraList_tRunJob_15.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_15));
		} else {
			paraList_tRunJob_15.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_15.put("SOURCE1", obj_tRunJob_15);
	
		obj_tRunJob_15 = "hongkong.master.producthierarchy.servier";
		if(obj_tRunJob_15!=null) {
			paraList_tRunJob_15.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_15));
		} else {
			paraList_tRunJob_15.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_15.put("SOURCE2", obj_tRunJob_15);
	
		obj_tRunJob_15 = "ProductGeography";
		if(obj_tRunJob_15!=null) {
			paraList_tRunJob_15.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_15));
		} else {
			paraList_tRunJob_15.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_15.put("TYPE", obj_tRunJob_15);
	
		obj_tRunJob_15 = "geographyCode";
		if(obj_tRunJob_15!=null) {
			paraList_tRunJob_15.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_15));
		} else {
			paraList_tRunJob_15.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_15.put("BUSINESS_KEY1", obj_tRunJob_15);
	
		obj_tRunJob_15 = "productCode";
		if(obj_tRunJob_15!=null) {
			paraList_tRunJob_15.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_15));
		} else {
			paraList_tRunJob_15.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_15.put("BUSINESS_KEY2", obj_tRunJob_15);
	
		obj_tRunJob_15 = "geography";
		if(obj_tRunJob_15!=null) {
			paraList_tRunJob_15.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_15));
		} else {
			paraList_tRunJob_15.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_15.put("TABLE1", obj_tRunJob_15);
	
		obj_tRunJob_15 = "product";
		if(obj_tRunJob_15!=null) {
			paraList_tRunJob_15.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_15));
		} else {
			paraList_tRunJob_15.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_15.put("TABLE2", obj_tRunJob_15);
	
	
		deepsea.link_master_with_multiple_without_hub_0_1.LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB childJob_tRunJob_15 = new deepsea.link_master_with_multiple_without_hub_0_1.LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_15 = childJob_tRunJob_15.runJob((String[]) paraList_tRunJob_15.toArray(new String[paraList_tRunJob_15.size()]));
		    ...
		    if (childJob_tRunJob_15.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_15.getErrorCode() != null || ("failure").equals(childJob_tRunJob_15.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_15.getException().getClass().getName() + ": " + childJob_tRunJob_15.getException().getMessage());
				}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = "hongkong.master.geographyhierarchy.servier";
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("SOURCE1", obj_tRunJob_2);
	
		obj_tRunJob_2 = "hongkong.master.employee.servier";
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("SOURCE2", obj_tRunJob_2);
	
		obj_tRunJob_2 = "Employee";
		if(obj_tRunJob_2!=null) {
		...
		obj_tRunJob_2 = "Employee";
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("SHEET_NAME", obj_tRunJob_2);
	
		obj_tRunJob_2 = "geographyCode";
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("BUSINESS_KEY1", obj_tRunJob_2);
	
		obj_tRunJob_2 = "servierCode";
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("BUSINESS_KEY2", obj_tRunJob_2);
	
		obj_tRunJob_2 = "geography";
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("TABLE1", obj_tRunJob_2);
	
		obj_tRunJob_2 = "employee";
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("TABLE2", obj_tRunJob_2);
	
	
		deepsea.link_master_with_empty_0_1.LINK_MASTER_WITH_EMPTY childJob_tRunJob_2 = new deepsea.link_master_with_empty_0_1.LINK_MASTER_WITH_EMPTY();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		obj_tRunJob_5 = "hongkong.master.organizationhierarchy.servier";
		...
		obj_tRunJob_5 = "hongkong.master.geographyhierarchy.servier";
		if(obj_tRunJob_5!=null) {
		...
		obj_tRunJob_5 = "GeographyHierarchy";
		if(obj_tRunJob_5!=null) {
			paraList_tRunJob_5.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
		} else {
			paraList_tRunJob_5.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_5.put("TYPE", obj_tRunJob_5);
		...
		obj_tRunJob_5 = "organizationCode";
		if(obj_tRunJob_5!=null) {
			paraList_tRunJob_5.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
		} else {
			paraList_tRunJob_5.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_5.put("BUSINESS_KEY1", obj_tRunJob_5);
	
		obj_tRunJob_5 = "servierCode";
		if(obj_tRunJob_5!=null) {
			paraList_tRunJob_5.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
		} else {
			paraList_tRunJob_5.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_5.put("BUSINESS_KEY2", obj_tRunJob_5);
	
		obj_tRunJob_5 = "organization";
		if(obj_tRunJob_5!=null) {
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = "hongkong.master.organizationhierarchy.servier";
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("SOURCE1", obj_tRunJob_3);
	
		obj_tRunJob_3 = "hongkong.master.employee.servier";
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("SOURCE2", obj_tRunJob_3);
	
		obj_tRunJob_3 = "Employee";
		if(obj_tRunJob_3!=null) {
		...
		obj_tRunJob_3 = "Employee";
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("SHEET_NAME", obj_tRunJob_3);
	
		obj_tRunJob_3 = "organizationCode";
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("BUSINESS_KEY1", obj_tRunJob_3);
	
		obj_tRunJob_3 = "servierCode";
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("BUSINESS_KEY2", obj_tRunJob_3);
	
		obj_tRunJob_3 = "organization";
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("TABLE1", obj_tRunJob_3);
	
		obj_tRunJob_3 = "employee";
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("TABLE2", obj_tRunJob_3);
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		obj_tRunJob_6 = "ZUELLIG";
		if(obj_tRunJob_6!=null) {
			paraList_tRunJob_6.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
		} else {
			paraList_tRunJob_6.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_6.put("SHEET_NAME", obj_tRunJob_6);
	
		obj_tRunJob_6 = "hongkong.master.geographyhierarchy.servier";
		if(obj_tRunJob_6!=null) {
		...
		obj_tRunJob_6 = "hongkong.master.customer.zuellig";
		if(obj_tRunJob_6!=null) {
		...
		if(obj_tRunJob_6!=null) {
			paraList_tRunJob_6.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
		} else {
			paraList_tRunJob_6.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_6.put("TYPE", obj_tRunJob_6);
	
		obj_tRunJob_6 = "geographyCode";
		if(obj_tRunJob_6!=null) {
			paraList_tRunJob_6.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
		} else {
			paraList_tRunJob_6.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_6.put("BUSINESS_KEY1", obj_tRunJob_6);
	
		obj_tRunJob_6 = "providerCode";
		if(obj_tRunJob_6!=null) {
			paraList_tRunJob_6.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
		} else {
			paraList_tRunJob_6.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_6.put("BUSINESS_KEY2", obj_tRunJob_6);
	
		obj_tRunJob_6 = "geography";
		if(obj_tRunJob_6!=null) {
		...
		deepsea.link_master_with_multiple_0_1.LINK_MASTER_WITH_MULTIPLE childJob_tRunJob_6 = new deepsea.link_master_with_multiple_0_1.LINK_MASTER_WITH_MULTIPLE();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_14 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_14.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_14.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
			...
			parentContextMap_tRunJob_14.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_14.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
	...
	Object obj_tRunJob_14 = null;
		...
		obj_tRunJob_14 = "ZUELLIG";
		if(obj_tRunJob_14!=null) {
			paraList_tRunJob_14.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_14));
		} else {
			paraList_tRunJob_14.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_14.put("SHEET_NAME", obj_tRunJob_14);
	
		obj_tRunJob_14 = "hongkong.master.customer.zuellig";
		if(obj_tRunJob_14!=null) {
			paraList_tRunJob_14.add("--context_param SOURCE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_14));
		} else {
			paraList_tRunJob_14.add("--context_param SOURCE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_14.put("SOURCE", obj_tRunJob_14);
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_13 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_13.put("WEBJOB_NAME", context.WEBJOB_NAME);
			paraList_tRunJob_13.add("--context_type " + "WEBJOB_NAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_13.put("COUNTRY", context.COUNTRY);
			paraList_tRunJob_13.add("--context_type " + "COUNTRY" + "=" + "id_String");
		
			parentContextMap_tRunJob_13.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_13.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
		
			parentContextMap_tRunJob_13.put("DEEPSEA_HOSTNAME", context.DEEPSEA_HOSTNAME);
			paraList_tRunJob_13.add("--context_type " + "DEEPSEA_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_13.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_13.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
		
			parentContextMap_tRunJob_13.put("MONGODB_HOSTNAME", context.MONGODB_HOSTNAME);
			paraList_tRunJob_13.add("--context_type " + "MONGODB_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_13.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_13.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
		
			parentContextMap_tRunJob_13.put("POSTGRES_HOSTNAME", context.POSTGRES_HOSTNAME);
			paraList_tRunJob_13.add("--context_type " + "POSTGRES_HOSTNAME" + "=" + "id_String");
	...
	Object obj_tRunJob_13 = null;
		...
		obj_tRunJob_13 = "ZUELLIG";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("SHEET_NAME", obj_tRunJob_13);
	
		obj_tRunJob_13 = "hongkong.master.sourcechannel.servier";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("SOURCE1", obj_tRunJob_13);
	
		obj_tRunJob_13 = "hongkong.master.customer.zuellig";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("SOURCE2", obj_tRunJob_13);
	
		obj_tRunJob_13 = "Customer";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("TYPE", obj_tRunJob_13);
	
		obj_tRunJob_13 = "sourceChannelCode";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("BUSINESS_KEY1", obj_tRunJob_13);
	
		obj_tRunJob_13 = "providerCode";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("BUSINESS_KEY2", obj_tRunJob_13);
	
		obj_tRunJob_13 = "source_channel";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("TABLE1", obj_tRunJob_13);
	
		obj_tRunJob_13 = "customer";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("TABLE2", obj_tRunJob_13);
	
	
		deepsea.link_master_0_1.LINK_MASTER childJob_tRunJob_13 = new deepsea.link_master_0_1.LINK_MASTER();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_13 = childJob_tRunJob_13.runJob((String[]) paraList_tRunJob_13.toArray(new String[paraList_tRunJob_13.size()]));
		    ...
		    if (childJob_tRunJob_13.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_13.getErrorCode() != null || ("failure").equals(childJob_tRunJob_13.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_13.getException().getClass().getName() + ": " + childJob_tRunJob_13.getException().getMessage());
				}
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_16 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_16.put("WEBJOB_NAME", context.WEBJOB_NAME);
			paraList_tRunJob_16.add("--context_type " + "WEBJOB_NAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_16.put("COUNTRY", context.COUNTRY);
			paraList_tRunJob_16.add("--context_type " + "COUNTRY" + "=" + "id_String");
		
			parentContextMap_tRunJob_16.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_16.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
		
			parentContextMap_tRunJob_16.put("DEEPSEA_HOSTNAME", context.DEEPSEA_HOSTNAME);
			paraList_tRunJob_16.add("--context_type " + "DEEPSEA_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_16.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_16.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
		
			parentContextMap_tRunJob_16.put("MONGODB_HOSTNAME", context.MONGODB_HOSTNAME);
			paraList_tRunJob_16.add("--context_type " + "MONGODB_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_16.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_16.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
		
			parentContextMap_tRunJob_16.put("POSTGRES_HOSTNAME", context.POSTGRES_HOSTNAME);
			paraList_tRunJob_16.add("--context_type " + "POSTGRES_HOSTNAME" + "=" + "id_String");
	...
	Object obj_tRunJob_16 = null;
		...
		if(obj_tRunJob_16!=null) {
			paraList_tRunJob_16.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_16));
		} else {
			paraList_tRunJob_16.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_16.put("SHEET_NAME", obj_tRunJob_16);
	
		obj_tRunJob_16 = "hongkong.master.geographyhierarchy.servier";
		if(obj_tRunJob_16!=null) {
			paraList_tRunJob_16.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_16));
		} else {
			paraList_tRunJob_16.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_16.put("SOURCE1", obj_tRunJob_16);
	
		obj_tRunJob_16 = "hongkong.master.customer.dkhs";
		if(obj_tRunJob_16!=null) {
			paraList_tRunJob_16.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_16));
		} else {
			paraList_tRunJob_16.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_16.put("SOURCE2", obj_tRunJob_16);
	
		obj_tRunJob_16 = "Customer";
		if(obj_tRunJob_16!=null) {
			paraList_tRunJob_16.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_16));
		} else {
			paraList_tRunJob_16.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_16.put("TYPE", obj_tRunJob_16);
	
		obj_tRunJob_16 = "geographyCode";
		if(obj_tRunJob_16!=null) {
			paraList_tRunJob_16.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_16));
		} else {
			paraList_tRunJob_16.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_16.put("BUSINESS_KEY1", obj_tRunJob_16);
	
		obj_tRunJob_16 = "providerCode";
		if(obj_tRunJob_16!=null) {
			paraList_tRunJob_16.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_16));
		} else {
			paraList_tRunJob_16.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_16.put("BUSINESS_KEY2", obj_tRunJob_16);
	
		obj_tRunJob_16 = "geography";
		if(obj_tRunJob_16!=null) {
			paraList_tRunJob_16.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_16));
		} else {
			paraList_tRunJob_16.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_16.put("TABLE1", obj_tRunJob_16);
	
		obj_tRunJob_16 = "customer";
		if(obj_tRunJob_16!=null) {
			paraList_tRunJob_16.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_16));
		} else {
			paraList_tRunJob_16.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_16.put("TABLE2", obj_tRunJob_16);
	
	
		deepsea.link_master_with_multiple_0_1.LINK_MASTER_WITH_MULTIPLE childJob_tRunJob_16 = new deepsea.link_master_with_multiple_0_1.LINK_MASTER_WITH_MULTIPLE();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_16 = childJob_tRunJob_16.runJob((String[]) paraList_tRunJob_16.toArray(new String[paraList_tRunJob_16.size()]));
		    ...
		    if (childJob_tRunJob_16.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_16.getErrorCode() != null || ("failure").equals(childJob_tRunJob_16.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_16.getException().getClass().getName() + ": " + childJob_tRunJob_16.getException().getMessage());
				}
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_17 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_17.put("WEBJOB_NAME", context.WEBJOB_NAME);
			paraList_tRunJob_17.add("--context_type " + "WEBJOB_NAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_17.put("COUNTRY", context.COUNTRY);
			paraList_tRunJob_17.add("--context_type " + "COUNTRY" + "=" + "id_String");
		
			parentContextMap_tRunJob_17.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_17.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
		
			parentContextMap_tRunJob_17.put("DEEPSEA_HOSTNAME", context.DEEPSEA_HOSTNAME);
			paraList_tRunJob_17.add("--context_type " + "DEEPSEA_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_17.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_17.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
		
			parentContextMap_tRunJob_17.put("MONGODB_HOSTNAME", context.MONGODB_HOSTNAME);
			paraList_tRunJob_17.add("--context_type " + "MONGODB_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_17.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_17.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
		
			parentContextMap_tRunJob_17.put("POSTGRES_HOSTNAME", context.POSTGRES_HOSTNAME);
			paraList_tRunJob_17.add("--context_type " + "POSTGRES_HOSTNAME" + "=" + "id_String");
	...
	Object obj_tRunJob_17 = null;
		...
		if(obj_tRunJob_17!=null) {
			paraList_tRunJob_17.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_17));
		} else {
			paraList_tRunJob_17.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_17.put("SHEET_NAME", obj_tRunJob_17);
	
		obj_tRunJob_17 = "hongkong.master.customer.dkhs";
		if(obj_tRunJob_17!=null) {
			paraList_tRunJob_17.add("--context_param SOURCE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_17));
		} else {
			paraList_tRunJob_17.add("--context_param SOURCE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_17.put("SOURCE", obj_tRunJob_17);
	
	
		deepsea.check_geography_customer_link_0_1.CHECK_GEOGRAPHY_CUSTOMER_LINK childJob_tRunJob_17 = new deepsea.check_geography_customer_link_0_1.CHECK_GEOGRAPHY_CUSTOMER_LINK();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_17 = childJob_tRunJob_17.runJob((String[]) paraList_tRunJob_17.toArray(new String[paraList_tRunJob_17.size()]));
		    ...
		    if (childJob_tRunJob_17.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_17.getErrorCode() != null || ("failure").equals(childJob_tRunJob_17.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_17.getException().getClass().getName() + ": " + childJob_tRunJob_17.getException().getMessage());
				}
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_18 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_18.put("WEBJOB_NAME", context.WEBJOB_NAME);
			paraList_tRunJob_18.add("--context_type " + "WEBJOB_NAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_18.put("COUNTRY", context.COUNTRY);
			paraList_tRunJob_18.add("--context_type " + "COUNTRY" + "=" + "id_String");
		
			parentContextMap_tRunJob_18.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_18.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
		
			parentContextMap_tRunJob_18.put("DEEPSEA_HOSTNAME", context.DEEPSEA_HOSTNAME);
			paraList_tRunJob_18.add("--context_type " + "DEEPSEA_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_18.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_18.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
		
			parentContextMap_tRunJob_18.put("MONGODB_HOSTNAME", context.MONGODB_HOSTNAME);
			paraList_tRunJob_18.add("--context_type " + "MONGODB_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_18.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_18.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
		
			parentContextMap_tRunJob_18.put("POSTGRES_HOSTNAME", context.POSTGRES_HOSTNAME);
			paraList_tRunJob_18.add("--context_type " + "POSTGRES_HOSTNAME" + "=" + "id_String");
	...
	Object obj_tRunJob_18 = null;
		...
		if(obj_tRunJob_18!=null) {
			paraList_tRunJob_18.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_18));
		} else {
			paraList_tRunJob_18.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_18.put("SHEET_NAME", obj_tRunJob_18);
	
		obj_tRunJob_18 = "hongkong.master.sourcechannel.servier";
		if(obj_tRunJob_18!=null) {
			paraList_tRunJob_18.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_18));
		} else {
			paraList_tRunJob_18.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_18.put("SOURCE1", obj_tRunJob_18);
	
		obj_tRunJob_18 = "hongkong.master.customer.dkhs";
		if(obj_tRunJob_18!=null) {
			paraList_tRunJob_18.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_18));
		} else {
			paraList_tRunJob_18.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_18.put("SOURCE2", obj_tRunJob_18);
	
		obj_tRunJob_18 = "Customer";
		if(obj_tRunJob_18!=null) {
			paraList_tRunJob_18.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_18));
		} else {
			paraList_tRunJob_18.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_18.put("TYPE", obj_tRunJob_18);
	
		obj_tRunJob_18 = "sourceChannelCode";
		if(obj_tRunJob_18!=null) {
			paraList_tRunJob_18.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_18));
		} else {
			paraList_tRunJob_18.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_18.put("BUSINESS_KEY1", obj_tRunJob_18);
	
		obj_tRunJob_18 = "providerCode";
		if(obj_tRunJob_18!=null) {
			paraList_tRunJob_18.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_18));
		} else {
			paraList_tRunJob_18.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_18.put("BUSINESS_KEY2", obj_tRunJob_18);
	
		obj_tRunJob_18 = "source_channel";
		if(obj_tRunJob_18!=null) {
			paraList_tRunJob_18.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_18));
		} else {
			paraList_tRunJob_18.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_18.put("TABLE1", obj_tRunJob_18);
	
		obj_tRunJob_18 = "customer";
		if(obj_tRunJob_18!=null) {
			paraList_tRunJob_18.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_18));
		} else {
			paraList_tRunJob_18.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_18.put("TABLE2", obj_tRunJob_18);
	
	
		deepsea.link_master_0_1.LINK_MASTER childJob_tRunJob_18 = new deepsea.link_master_0_1.LINK_MASTER();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_18 = childJob_tRunJob_18.runJob((String[]) paraList_tRunJob_18.toArray(new String[paraList_tRunJob_18.size()]));
		    ...
		    if (childJob_tRunJob_18.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_18.getErrorCode() != null || ("failure").equals(childJob_tRunJob_18.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_18.getException().getClass().getName() + ": " + childJob_tRunJob_18.getException().getMessage());
				}
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_21 = new java.util.ArrayList<String>();
	        			...
	        			paraList_tRunJob_21.add("--context=Production");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_21 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_21.put("WEBJOB_NAME", context.WEBJOB_NAME);
			paraList_tRunJob_21.add("--context_type " + "WEBJOB_NAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_21.put("COUNTRY", context.COUNTRY);
			paraList_tRunJob_21.add("--context_type " + "COUNTRY" + "=" + "id_String");
		
			parentContextMap_tRunJob_21.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_21.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
		
			parentContextMap_tRunJob_21.put("DEEPSEA_HOSTNAME", context.DEEPSEA_HOSTNAME);
			paraList_tRunJob_21.add("--context_type " + "DEEPSEA_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_21.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_21.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
		
			parentContextMap_tRunJob_21.put("MONGODB_HOSTNAME", context.MONGODB_HOSTNAME);
			paraList_tRunJob_21.add("--context_type " + "MONGODB_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_21.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_21.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
		
			parentContextMap_tRunJob_21.put("POSTGRES_HOSTNAME", context.POSTGRES_HOSTNAME);
			paraList_tRunJob_21.add("--context_type " + "POSTGRES_HOSTNAME" + "=" + "id_String");
	...
	Object obj_tRunJob_21 = null;
		...
		obj_tRunJob_21 = "IQVIA";
		if(obj_tRunJob_21!=null) {
			paraList_tRunJob_21.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_21));
		} else {
			paraList_tRunJob_21.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_21.put("SHEET_NAME", obj_tRunJob_21);
	
		obj_tRunJob_21 = "hongkong.master.geographyhierarchy.servier";
		if(obj_tRunJob_21!=null) {
			paraList_tRunJob_21.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_21));
		} else {
			paraList_tRunJob_21.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_21.put("SOURCE1", obj_tRunJob_21);
	
		obj_tRunJob_21 = "hongkong.master.customer.iqvia";
		if(obj_tRunJob_21!=null) {
			paraList_tRunJob_21.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_21));
		} else {
			paraList_tRunJob_21.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_21.put("SOURCE2", obj_tRunJob_21);
	
		obj_tRunJob_21 = "Customer";
		if(obj_tRunJob_21!=null) {
			paraList_tRunJob_21.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_21));
		} else {
			paraList_tRunJob_21.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_21.put("TYPE", obj_tRunJob_21);
	
		obj_tRunJob_21 = "geographyCode";
		if(obj_tRunJob_21!=null) {
			paraList_tRunJob_21.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_21));
		} else {
			paraList_tRunJob_21.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_21.put("BUSINESS_KEY1", obj_tRunJob_21);
	
		obj_tRunJob_21 = "providerCode";
		if(obj_tRunJob_21!=null) {
			paraList_tRunJob_21.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_21));
		} else {
			paraList_tRunJob_21.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_21.put("BUSINESS_KEY2", obj_tRunJob_21);
	
		obj_tRunJob_21 = "geography";
		if(obj_tRunJob_21!=null) {
			paraList_tRunJob_21.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_21));
		} else {
			paraList_tRunJob_21.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_21.put("TABLE1", obj_tRunJob_21);
	
		obj_tRunJob_21 = "customer";
		if(obj_tRunJob_21!=null) {
			paraList_tRunJob_21.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_21));
		} else {
			paraList_tRunJob_21.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_21.put("TABLE2", obj_tRunJob_21);
	
	
		deepsea.link_master_with_multiple_0_1.LINK_MASTER_WITH_MULTIPLE childJob_tRunJob_21 = new deepsea.link_master_with_multiple_0_1.LINK_MASTER_WITH_MULTIPLE();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_21 = childJob_tRunJob_21.runJob((String[]) paraList_tRunJob_21.toArray(new String[paraList_tRunJob_21.size()]));
		    ...
		    if (childJob_tRunJob_21.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_21.getErrorCode() != null || ("failure").equals(childJob_tRunJob_21.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_21.getException().getClass().getName() + ": " + childJob_tRunJob_21.getException().getMessage());
				}
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_22 = new java.util.ArrayList<String>();
	        			...
	        			paraList_tRunJob_22.add("--context=Production");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_22 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_22.put("WEBJOB_NAME", context.WEBJOB_NAME);
			paraList_tRunJob_22.add("--context_type " + "WEBJOB_NAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_22.put("COUNTRY", context.COUNTRY);
			paraList_tRunJob_22.add("--context_type " + "COUNTRY" + "=" + "id_String");
		
			parentContextMap_tRunJob_22.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_22.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
		
			parentContextMap_tRunJob_22.put("DEEPSEA_HOSTNAME", context.DEEPSEA_HOSTNAME);
			paraList_tRunJob_22.add("--context_type " + "DEEPSEA_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_22.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_22.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
		
			parentContextMap_tRunJob_22.put("MONGODB_HOSTNAME", context.MONGODB_HOSTNAME);
			paraList_tRunJob_22.add("--context_type " + "MONGODB_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_22.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_22.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
		
			parentContextMap_tRunJob_22.put("POSTGRES_HOSTNAME", context.POSTGRES_HOSTNAME);
			paraList_tRunJob_22.add("--context_type " + "POSTGRES_HOSTNAME" + "=" + "id_String");
	...
	Object obj_tRunJob_22 = null;
		...
		obj_tRunJob_22 = "IQVIA";
		if(obj_tRunJob_22!=null) {
			paraList_tRunJob_22.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_22));
		} else {
			paraList_tRunJob_22.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_22.put("SHEET_NAME", obj_tRunJob_22);
	
		obj_tRunJob_22 = "hongkong.master.customer.iqvia";
		if(obj_tRunJob_22!=null) {
			paraList_tRunJob_22.add("--context_param SOURCE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_22));
		} else {
			paraList_tRunJob_22.add("--context_param SOURCE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_22.put("SOURCE", obj_tRunJob_22);
	
	
		deepsea.check_geography_customer_link_0_1.CHECK_GEOGRAPHY_CUSTOMER_LINK childJob_tRunJob_22 = new deepsea.check_geography_customer_link_0_1.CHECK_GEOGRAPHY_CUSTOMER_LINK();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_22 = childJob_tRunJob_22.runJob((String[]) paraList_tRunJob_22.toArray(new String[paraList_tRunJob_22.size()]));
		    ...
		    if (childJob_tRunJob_22.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_22.getErrorCode() != null || ("failure").equals(childJob_tRunJob_22.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_22.getException().getClass().getName() + ": " + childJob_tRunJob_22.getException().getMessage());
				}
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_23 = new java.util.ArrayList<String>();
	        			...
	        			paraList_tRunJob_23.add("--context=Production");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_23 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_23.put("WEBJOB_NAME", context.WEBJOB_NAME);
			paraList_tRunJob_23.add("--context_type " + "WEBJOB_NAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_23.put("COUNTRY", context.COUNTRY);
			paraList_tRunJob_23.add("--context_type " + "COUNTRY" + "=" + "id_String");
		
			parentContextMap_tRunJob_23.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_23.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
		
			parentContextMap_tRunJob_23.put("DEEPSEA_HOSTNAME", context.DEEPSEA_HOSTNAME);
			paraList_tRunJob_23.add("--context_type " + "DEEPSEA_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_23.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_23.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
		
			parentContextMap_tRunJob_23.put("MONGODB_HOSTNAME", context.MONGODB_HOSTNAME);
			paraList_tRunJob_23.add("--context_type " + "MONGODB_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_23.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_23.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
		
			parentContextMap_tRunJob_23.put("POSTGRES_HOSTNAME", context.POSTGRES_HOSTNAME);
			paraList_tRunJob_23.add("--context_type " + "POSTGRES_HOSTNAME" + "=" + "id_String");
	...
	Object obj_tRunJob_23 = null;
		...
		obj_tRunJob_23 = "IQVIA";
		if(obj_tRunJob_23!=null) {
			paraList_tRunJob_23.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_23));
		} else {
			paraList_tRunJob_23.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_23.put("SHEET_NAME", obj_tRunJob_23);
	
		obj_tRunJob_23 = "hongkong.master.sourcechannel.servier";
		if(obj_tRunJob_23!=null) {
			paraList_tRunJob_23.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_23));
		} else {
			paraList_tRunJob_23.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_23.put("SOURCE1", obj_tRunJob_23);
	
		obj_tRunJob_23 = "hongkong.master.customer.iqvia";
		if(obj_tRunJob_23!=null) {
			paraList_tRunJob_23.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_23));
		} else {
			paraList_tRunJob_23.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_23.put("SOURCE2", obj_tRunJob_23);
	
		obj_tRunJob_23 = "Customer";
		if(obj_tRunJob_23!=null) {
			paraList_tRunJob_23.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_23));
		} else {
			paraList_tRunJob_23.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_23.put("TYPE", obj_tRunJob_23);
	
		obj_tRunJob_23 = "sourceChannelCode";
		if(obj_tRunJob_23!=null) {
			paraList_tRunJob_23.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_23));
		} else {
			paraList_tRunJob_23.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_23.put("BUSINESS_KEY1", obj_tRunJob_23);
	
		obj_tRunJob_23 = "providerCode";
		if(obj_tRunJob_23!=null) {
			paraList_tRunJob_23.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_23));
		} else {
			paraList_tRunJob_23.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_23.put("BUSINESS_KEY2", obj_tRunJob_23);
	
		obj_tRunJob_23 = "source_channel";
		if(obj_tRunJob_23!=null) {
			paraList_tRunJob_23.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_23));
		} else {
			paraList_tRunJob_23.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_23.put("TABLE1", obj_tRunJob_23);
	
		obj_tRunJob_23 = "customer";
		if(obj_tRunJob_23!=null) {
			paraList_tRunJob_23.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_23));
		} else {
			paraList_tRunJob_23.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_23.put("TABLE2", obj_tRunJob_23);
	
	
		deepsea.link_master_0_1.LINK_MASTER childJob_tRunJob_23 = new deepsea.link_master_0_1.LINK_MASTER();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_23 = childJob_tRunJob_23.runJob((String[]) paraList_tRunJob_23.toArray(new String[paraList_tRunJob_23.size()]));
		    ...
		    if (childJob_tRunJob_23.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_23.getErrorCode() != null || ("failure").equals(childJob_tRunJob_23.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_23.getException().getClass().getName() + ": " + childJob_tRunJob_23.getException().getMessage());
				}
 ...
 */
	...
	java.util.List<String> paraList_tRunJob_24 = new java.util.ArrayList<String>();
	        			...
	        			paraList_tRunJob_24.add("--context=Production");
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_24 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_24.put("WEBJOB_NAME", context.WEBJOB_NAME);
			paraList_tRunJob_24.add("--context_type " + "WEBJOB_NAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_24.put("COUNTRY", context.COUNTRY);
			paraList_tRunJob_24.add("--context_type " + "COUNTRY" + "=" + "id_String");
		
			parentContextMap_tRunJob_24.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_24.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
		
			parentContextMap_tRunJob_24.put("DEEPSEA_HOSTNAME", context.DEEPSEA_HOSTNAME);
			paraList_tRunJob_24.add("--context_type " + "DEEPSEA_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_24.put("DEFAULT_DATE_FORMAT", context.DEFAULT_DATE_FORMAT);
			paraList_tRunJob_24.add("--context_type " + "DEFAULT_DATE_FORMAT" + "=" + "id_String");
		
			parentContextMap_tRunJob_24.put("MONGODB_HOSTNAME", context.MONGODB_HOSTNAME);
			paraList_tRunJob_24.add("--context_type " + "MONGODB_HOSTNAME" + "=" + "id_String");
		
			parentContextMap_tRunJob_24.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_24.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
		
			parentContextMap_tRunJob_24.put("POSTGRES_HOSTNAME", context.POSTGRES_HOSTNAME);
			paraList_tRunJob_24.add("--context_type " + "POSTGRES_HOSTNAME" + "=" + "id_String");
	...
	Object obj_tRunJob_24 = null;
		...
		obj_tRunJob_24 = "hongkong.master.markethierarchy.servier";
		if(obj_tRunJob_24!=null) {
			paraList_tRunJob_24.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_24));
		} else {
			paraList_tRunJob_24.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_24.put("SOURCE1", obj_tRunJob_24);
	
		obj_tRunJob_24 = "hongkong.master.producthierarchy.iqvia";
		if(obj_tRunJob_24!=null) {
			paraList_tRunJob_24.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_24));
		} else {
			paraList_tRunJob_24.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_24.put("SOURCE2", obj_tRunJob_24);
	
		obj_tRunJob_24 = "ProductHierarchy";
		if(obj_tRunJob_24!=null) {
			paraList_tRunJob_24.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_24));
		} else {
			paraList_tRunJob_24.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_24.put("TYPE", obj_tRunJob_24);
	
		obj_tRunJob_24 = "IQVIA";
		if(obj_tRunJob_24!=null) {
			paraList_tRunJob_24.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_24));
		} else {
			paraList_tRunJob_24.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_24.put("SHEET_NAME", obj_tRunJob_24);
	
		obj_tRunJob_24 = "therapeuticClass";
		if(obj_tRunJob_24!=null) {
			paraList_tRunJob_24.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_24));
		} else {
			paraList_tRunJob_24.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_24.put("BUSINESS_KEY1", obj_tRunJob_24);
	
		obj_tRunJob_24 = "providerCode";
		if(obj_tRunJob_24!=null) {
			paraList_tRunJob_24.add("--context_param BUSINESS_KEY2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_24));
		} else {
			paraList_tRunJob_24.add("--context_param BUSINESS_KEY2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_24.put("BUSINESS_KEY2", obj_tRunJob_24);
	
		obj_tRunJob_24 = "market";
		if(obj_tRunJob_24!=null) {
			paraList_tRunJob_24.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_24));
		} else {
			paraList_tRunJob_24.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_24.put("TABLE1", obj_tRunJob_24);
	
		obj_tRunJob_24 = "product";
		if(obj_tRunJob_24!=null) {
			paraList_tRunJob_24.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_24));
		} else {
			paraList_tRunJob_24.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_24.put("TABLE2", obj_tRunJob_24);
	
	
		deepsea.link_master_0_1.LINK_MASTER childJob_tRunJob_24 = new deepsea.link_master_0_1.LINK_MASTER();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_24 = childJob_tRunJob_24.runJob((String[]) paraList_tRunJob_24.toArray(new String[paraList_tRunJob_24.size()]));
		    ...
		    if (childJob_tRunJob_24.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_24.getErrorCode() != null || ("failure").equals(childJob_tRunJob_24.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_24.getException().getClass().getName() + ": " + childJob_tRunJob_24.getException().getMessage());
				}
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_7 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_7.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_7.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
			...
			parentContextMap_tRunJob_7.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_7.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
	...
	Object obj_tRunJob_7 = null;
		...
		obj_tRunJob_7 = "hongkong.master.producthierarchy.servier";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("SOURCE1", obj_tRunJob_7);
	
		obj_tRunJob_7 = "hongkong.master.salesobjectiveqty.servier";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("SOURCE2", obj_tRunJob_7);
	
		obj_tRunJob_7 = "SalesObjective";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("TYPE", obj_tRunJob_7);
	
		obj_tRunJob_7 = "Quantity";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param QUOTA_TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param QUOTA_TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("QUOTA_TYPE", obj_tRunJob_7);
	
		obj_tRunJob_7 = "productCode";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("BUSINESS_KEY1", obj_tRunJob_7);
	
		obj_tRunJob_7 = "product";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("TABLE1", obj_tRunJob_7);
	
		obj_tRunJob_7 = "sales_objective_qty";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("TABLE2", obj_tRunJob_7);
	
	
		deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE childJob_tRunJob_7 = new deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_8 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_8.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_8.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
			...
			parentContextMap_tRunJob_8.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_8.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
	...
	Object obj_tRunJob_8 = null;
		...
		obj_tRunJob_8 = "hongkong.master.geographyhierarchy.servier";
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("SOURCE1", obj_tRunJob_8);
	
		obj_tRunJob_8 = "hongkong.master.salesobjectiveqty.servier";
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("SOURCE2", obj_tRunJob_8);
		...
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param QUOTA_TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param QUOTA_TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("QUOTA_TYPE", obj_tRunJob_8);
	
		obj_tRunJob_8 = "geographyCode";
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("BUSINESS_KEY1", obj_tRunJob_8);
	
		obj_tRunJob_8 = "geography";
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("TABLE1", obj_tRunJob_8);
	
		obj_tRunJob_8 = "sales_objective_qty";
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("TABLE2", obj_tRunJob_8);
	
	
		deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE childJob_tRunJob_8 = new deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_9 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_9.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_9.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
			...
			parentContextMap_tRunJob_9.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_9.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
	...
	Object obj_tRunJob_9 = null;
		...
		obj_tRunJob_9 = "hongkong.master.sourcechannel.servier";
		if(obj_tRunJob_9!=null) {
			paraList_tRunJob_9.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_9));
		} else {
			paraList_tRunJob_9.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_9.put("SOURCE1", obj_tRunJob_9);
	
		obj_tRunJob_9 = "hongkong.master.salesobjectiveqty.servier";
		if(obj_tRunJob_9!=null) {
			paraList_tRunJob_9.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_9));
		} else {
			paraList_tRunJob_9.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_9.put("SOURCE2", obj_tRunJob_9);
		...
		obj_tRunJob_9 = "Quantity";
		if(obj_tRunJob_9!=null) {
			paraList_tRunJob_9.add("--context_param QUOTA_TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_9));
		} else {
			paraList_tRunJob_9.add("--context_param QUOTA_TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_9.put("QUOTA_TYPE", obj_tRunJob_9);
	
		obj_tRunJob_9 = "sourceChannelCode";
		if(obj_tRunJob_9!=null) {
			paraList_tRunJob_9.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_9));
		} else {
			paraList_tRunJob_9.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_9.put("BUSINESS_KEY1", obj_tRunJob_9);
	
		obj_tRunJob_9 = "source_channel";
		if(obj_tRunJob_9!=null) {
			paraList_tRunJob_9.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_9));
		} else {
			paraList_tRunJob_9.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_9.put("TABLE1", obj_tRunJob_9);
	
		obj_tRunJob_9 = "sales_objective_qty";
		if(obj_tRunJob_9!=null) {
			paraList_tRunJob_9.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_9));
		} else {
			paraList_tRunJob_9.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_9.put("TABLE2", obj_tRunJob_9);
	
	
		deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE childJob_tRunJob_9 = new deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_10 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_10.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_10.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
			...
			parentContextMap_tRunJob_10.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_10.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
	...
	Object obj_tRunJob_10 = null;
		...
		obj_tRunJob_10 = "hongkong.master.producthierarchy.servier";
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("SOURCE1", obj_tRunJob_10);
	
		obj_tRunJob_10 = "hongkong.master.salesobjectiveval.servier";
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("SOURCE2", obj_tRunJob_10);
	
		obj_tRunJob_10 = "SalesObjective";
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("TYPE", obj_tRunJob_10);
	
		obj_tRunJob_10 = "Value";
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param QUOTA_TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param QUOTA_TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("QUOTA_TYPE", obj_tRunJob_10);
	
		obj_tRunJob_10 = "productCode";
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("BUSINESS_KEY1", obj_tRunJob_10);
	
		obj_tRunJob_10 = "product";
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("TABLE1", obj_tRunJob_10);
	
		obj_tRunJob_10 = "sales_objective_val";
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("TABLE2", obj_tRunJob_10);
	
	
		deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE childJob_tRunJob_10 = new deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_11 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_11.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_11.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
			...
			parentContextMap_tRunJob_11.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_11.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
	...
	Object obj_tRunJob_11 = null;
		...
		obj_tRunJob_11 = "hongkong.master.geographyhierarchy.servier";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("SOURCE1", obj_tRunJob_11);
	
		obj_tRunJob_11 = "hongkong.master.salesobjectiveval.servier";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("SOURCE2", obj_tRunJob_11);
	
		obj_tRunJob_11 = "SalesObjective";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("TYPE", obj_tRunJob_11);
	
		obj_tRunJob_11 = "Value";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param QUOTA_TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param QUOTA_TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("QUOTA_TYPE", obj_tRunJob_11);
	
		obj_tRunJob_11 = "geographyCode";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("BUSINESS_KEY1", obj_tRunJob_11);
	
		obj_tRunJob_11 = "geography";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("TABLE1", obj_tRunJob_11);
	
		obj_tRunJob_11 = "sales_objective_val";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("TABLE2", obj_tRunJob_11);
	
	
		deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE childJob_tRunJob_11 = new deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_11 = childJob_tRunJob_11.runJob((String[]) paraList_tRunJob_11.toArray(new String[paraList_tRunJob_11.size()]));
		    ...
		    if (childJob_tRunJob_11.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_11.getErrorCode() != null || ("failure").equals(childJob_tRunJob_11.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_11.getException().getClass().getName() + ": " + childJob_tRunJob_11.getException().getMessage());
				}
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_12 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_12.put("DEEPSEA_AUTH_TOKEN", context.DEEPSEA_AUTH_TOKEN);
			paraList_tRunJob_12.add("--context_type " + "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");
			...
			parentContextMap_tRunJob_12.put("POSTGRES_DATABASE", context.POSTGRES_DATABASE);
			paraList_tRunJob_12.add("--context_type " + "POSTGRES_DATABASE" + "=" + "id_String");
	...
	Object obj_tRunJob_12 = null;
		...
		obj_tRunJob_12 = "hongkong.master.sourcechannel.servier";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param SOURCE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param SOURCE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("SOURCE1", obj_tRunJob_12);
	
		obj_tRunJob_12 = "hongkong.master.salesobjectiveval.servier";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param SOURCE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param SOURCE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("SOURCE2", obj_tRunJob_12);
	
		obj_tRunJob_12 = "SalesObjective";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("TYPE", obj_tRunJob_12);
	
		obj_tRunJob_12 = "Value";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param QUOTA_TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param QUOTA_TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("QUOTA_TYPE", obj_tRunJob_12);
	
		obj_tRunJob_12 = "sourceChannelCode";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param BUSINESS_KEY1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param BUSINESS_KEY1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("BUSINESS_KEY1", obj_tRunJob_12);
	
		obj_tRunJob_12 = "source_channel";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param TABLE1=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param TABLE1=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("TABLE1", obj_tRunJob_12);
	
		obj_tRunJob_12 = "sales_objective_val";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param TABLE2=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param TABLE2=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("TABLE2", obj_tRunJob_12);
	
	
		deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE childJob_tRunJob_12 = new deepsea.link_master_sales_objective_0_1.LINK_MASTER_SALES_OBJECTIVE();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_12 = childJob_tRunJob_12.runJob((String[]) paraList_tRunJob_12.toArray(new String[paraList_tRunJob_12.size()]));
		    ...
		    if (childJob_tRunJob_12.getExceptionStackTrace() != null) { 
				...
				if (childJob_tRunJob_12.getErrorCode() != null || ("failure").equals(childJob_tRunJob_12.getStatus())) {
	        		throw new RuntimeException("Child job running failed.\n"+childJob_tRunJob_12.getException().getClass().getName() + ": " + childJob_tRunJob_12.getException().getMessage());
				}
 ...
 */
    ...
    public static void main(String[] args){
        final HONGKONG_BUILD_MASTER_LINKS HONGKONG_BUILD_MASTER_LINKSClass = new HONGKONG_BUILD_MASTER_LINKS();

        int exitCode = HONGKONG_BUILD_MASTER_LINKSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HONGKONG_BUILD_MASTER_LINKS.class.getClassLoader().getResourceAsStream("deepsea/hongkong_build_master_links_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HONGKONG_BUILD_MASTER_LINKS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HONGKONG_BUILD_MASTER_LINKS");
        }
...
/************************************************************************************************
 *     295800 characters generated by Talend Open Studio for Big Data 
 *     on the September 1, 2019 7:29:31 PM CST
 ************************************************************************************************/