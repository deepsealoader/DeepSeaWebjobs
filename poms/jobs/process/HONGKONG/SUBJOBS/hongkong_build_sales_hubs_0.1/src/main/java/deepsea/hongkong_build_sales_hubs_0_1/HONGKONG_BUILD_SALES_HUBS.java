...
package deepsea.hongkong_build_sales_hubs_0_1;
...
/**
 * Job: HONGKONG_BUILD_SALES_HUBS Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HONGKONG_BUILD_SALES_HUBS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "HONGKONG_BUILD_SALES_HUBS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				HONGKONG_BUILD_SALES_HUBS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HONGKONG_BUILD_SALES_HUBS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		deepsea.hub_sales_0_1.HUB_SALES childJob_tRunJob_1 = new deepsea.hub_sales_0_1.HUB_SALES();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = "sales.dkhs.monthly";
		...
		obj_tRunJob_2 = "hongkong.sales.dkhs.monthly";
		if(obj_tRunJob_2!=null) {
		...
		deepsea.hub_sales_0_1.HUB_SALES childJob_tRunJob_2 = new deepsea.hub_sales_0_1.HUB_SALES();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = "hongkong.sales.iqvia";
		if(obj_tRunJob_3!=null) {
		...
		deepsea.hub_sales_0_1.HUB_SALES childJob_tRunJob_3 = new deepsea.hub_sales_0_1.HUB_SALES();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final HONGKONG_BUILD_SALES_HUBS HONGKONG_BUILD_SALES_HUBSClass = new HONGKONG_BUILD_SALES_HUBS();

        int exitCode = HONGKONG_BUILD_SALES_HUBSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HONGKONG_BUILD_SALES_HUBS.class.getClassLoader().getResourceAsStream("deepsea/hongkong_build_sales_hubs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HONGKONG_BUILD_SALES_HUBS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HONGKONG_BUILD_SALES_HUBS");
        }
...
/************************************************************************************************
 *     54464 characters generated by Talend Open Studio for Big Data 
