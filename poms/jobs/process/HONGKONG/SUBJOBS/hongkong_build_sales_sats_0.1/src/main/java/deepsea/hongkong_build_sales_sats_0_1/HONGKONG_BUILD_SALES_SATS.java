...
package deepsea.hongkong_build_sales_sats_0_1;
...
/**
 * Job: HONGKONG_BUILD_SALES_SATS Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HONGKONG_BUILD_SALES_SATS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "HONGKONG_BUILD_SALES_SATS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				HONGKONG_BUILD_SALES_SATS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HONGKONG_BUILD_SALES_SATS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		deepsea.sat_sales_0_1.SAT_SALES childJob_tRunJob_1 = new deepsea.sat_sales_0_1.SAT_SALES();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		deepsea.sat_sales_0_1.SAT_SALES childJob_tRunJob_2 = new deepsea.sat_sales_0_1.SAT_SALES();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		deepsea.sat_sales_0_1.SAT_SALES childJob_tRunJob_3 = new deepsea.sat_sales_0_1.SAT_SALES();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final HONGKONG_BUILD_SALES_SATS HONGKONG_BUILD_SALES_SATSClass = new HONGKONG_BUILD_SALES_SATS();

        int exitCode = HONGKONG_BUILD_SALES_SATSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HONGKONG_BUILD_SALES_SATS.class.getClassLoader().getResourceAsStream("deepsea/hongkong_build_sales_sats_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HONGKONG_BUILD_SALES_SATS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HONGKONG_BUILD_SALES_SATS");
        }
