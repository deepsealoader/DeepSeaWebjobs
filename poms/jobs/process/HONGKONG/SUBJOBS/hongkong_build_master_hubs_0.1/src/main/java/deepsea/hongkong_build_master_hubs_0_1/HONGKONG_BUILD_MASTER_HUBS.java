...
package deepsea.hongkong_build_master_hubs_0_1;
...
/**
 * Job: HONGKONG_BUILD_MASTER_HUBS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HONGKONG_BUILD_MASTER_HUBS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "HONGKONG_BUILD_MASTER_HUBS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				HONGKONG_BUILD_MASTER_HUBS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HONGKONG_BUILD_MASTER_HUBS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		obj_tRunJob_5 = "hongkong.master.markethierarchy.servier";
		...
		obj_tRunJob_5 = "therapeuticClass";
		if(obj_tRunJob_5!=null) {
		...
		obj_tRunJob_5 = "market";
		if(obj_tRunJob_5!=null) {
			paraList_tRunJob_5.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_5));
		} else {
			paraList_tRunJob_5.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_5.put("TABLE", obj_tRunJob_5);
	
	
		deepsea.hub_master_with_duplicates_0_1.HUB_MASTER_WITH_DUPLICATES childJob_tRunJob_5 = new deepsea.hub_master_with_duplicates_0_1.HUB_MASTER_WITH_DUPLICATES();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		obj_tRunJob_7 = "hongkong.master.organizationhierarchy.servier";
		...
		obj_tRunJob_7 = "OrganizationHierarchy";
		if(obj_tRunJob_7!=null) {
		...
		obj_tRunJob_7 = "OrganizationHierarchy";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("SHEET_NAME", obj_tRunJob_7);
	
		obj_tRunJob_7 = "servierCode";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param BUSINESS_KEY=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param BUSINESS_KEY=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("BUSINESS_KEY", obj_tRunJob_7);
	
		obj_tRunJob_7 = "organization";
		if(obj_tRunJob_7!=null) {
			paraList_tRunJob_7.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_7));
		} else {
			paraList_tRunJob_7.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_7.put("TABLE", obj_tRunJob_7);
	
	
		deepsea.hub_master_0_1.HUB_MASTER childJob_tRunJob_7 = new deepsea.hub_master_0_1.HUB_MASTER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		obj_tRunJob_6 = "hongkong.master.sourcechannel.servier";
		...
		obj_tRunJob_6 = "source_channel";
		if(obj_tRunJob_6!=null) {
			paraList_tRunJob_6.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_6));
		} else {
			paraList_tRunJob_6.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_6.put("TABLE", obj_tRunJob_6);
	
	
		deepsea.hub_master_0_1.HUB_MASTER childJob_tRunJob_6 = new deepsea.hub_master_0_1.HUB_MASTER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param BUSINESS_KEY=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param BUSINESS_KEY=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("BUSINESS_KEY", obj_tRunJob_1);
	
		obj_tRunJob_1 = "product";
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("TABLE", obj_tRunJob_1);
	
	
		deepsea.hub_master_0_1.HUB_MASTER childJob_tRunJob_1 = new deepsea.hub_master_0_1.HUB_MASTER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = "hongkong.master.producthierarchy.zuellig";
		if(obj_tRunJob_3!=null) {
		...
		obj_tRunJob_3 = "ProductHierarchy";
		if(obj_tRunJob_3!=null) {
		...
		obj_tRunJob_3 = "providerCode";
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param BUSINESS_KEY=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param BUSINESS_KEY=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("BUSINESS_KEY", obj_tRunJob_3);
	
		obj_tRunJob_3 = "product";
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("TABLE", obj_tRunJob_3);
	
	
		deepsea.hub_master_0_1.HUB_MASTER childJob_tRunJob_3 = new deepsea.hub_master_0_1.HUB_MASTER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_11 = null;
		...
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("SHEET_NAME", obj_tRunJob_11);
	
		obj_tRunJob_11 = "hongkong.master.producthierarchy.dkhs";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param SOURCE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param SOURCE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("SOURCE", obj_tRunJob_11);
	
		obj_tRunJob_11 = "ProductHierarchy";
		if(obj_tRunJob_11!=null) {
		...
		obj_tRunJob_11 = "providerCode";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param BUSINESS_KEY=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param BUSINESS_KEY=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("BUSINESS_KEY", obj_tRunJob_11);
	
		obj_tRunJob_11 = "product";
		if(obj_tRunJob_11!=null) {
			paraList_tRunJob_11.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_11));
		} else {
			paraList_tRunJob_11.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_11.put("TABLE", obj_tRunJob_11);
	
	
		deepsea.hub_master_0_1.HUB_MASTER childJob_tRunJob_11 = new deepsea.hub_master_0_1.HUB_MASTER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_13 = null;
		...
		obj_tRunJob_13 = "hongkong.master.producthierarchy.iqvia";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param SOURCE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param SOURCE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("SOURCE", obj_tRunJob_13);
	
		obj_tRunJob_13 = "ProductHierarchy";
		if(obj_tRunJob_13!=null) {
		...
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param BUSINESS_KEY=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param BUSINESS_KEY=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("BUSINESS_KEY", obj_tRunJob_13);
	
		obj_tRunJob_13 = "product";
		if(obj_tRunJob_13!=null) {
			paraList_tRunJob_13.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_13));
		} else {
			paraList_tRunJob_13.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_13.put("TABLE", obj_tRunJob_13);
	
	
		deepsea.hub_master_0_1.HUB_MASTER childJob_tRunJob_13 = new deepsea.hub_master_0_1.HUB_MASTER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "hongkong.master.geographyhierarchy.servier";
		...
		obj_tRunJob_4 = "GeographyHierarchy";
		if(obj_tRunJob_4!=null) {
		...
		deepsea.hub_master_0_1.HUB_MASTER childJob_tRunJob_4 = new deepsea.hub_master_0_1.HUB_MASTER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		obj_tRunJob_8 = "hongkong.master.customer.zuellig";
		...
		obj_tRunJob_8 = "ZUELLIG";
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("SHEET_NAME", obj_tRunJob_8);
	
		obj_tRunJob_8 = "providerCode";
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param BUSINESS_KEY=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param BUSINESS_KEY=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("BUSINESS_KEY", obj_tRunJob_8);
	
		obj_tRunJob_8 = "customer";
		if(obj_tRunJob_8!=null) {
			paraList_tRunJob_8.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_8));
		} else {
			paraList_tRunJob_8.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_8.put("TABLE", obj_tRunJob_8);
	
	
		deepsea.hub_master_with_duplicates_0_1.HUB_MASTER_WITH_DUPLICATES childJob_tRunJob_8 = new deepsea.hub_master_with_duplicates_0_1.HUB_MASTER_WITH_DUPLICATES();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_12 = null;
		...
		obj_tRunJob_12 = "hongkong.master.customer.dkhs";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param SOURCE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param SOURCE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("SOURCE", obj_tRunJob_12);
	
		obj_tRunJob_12 = "Customer";
		if(obj_tRunJob_12!=null) {
		...
		obj_tRunJob_12 = "DKHS";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param SHEET_NAME=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param SHEET_NAME=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("SHEET_NAME", obj_tRunJob_12);
	
		obj_tRunJob_12 = "providerCode";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param BUSINESS_KEY=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param BUSINESS_KEY=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("BUSINESS_KEY", obj_tRunJob_12);
	
		obj_tRunJob_12 = "customer";
		if(obj_tRunJob_12!=null) {
			paraList_tRunJob_12.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_12));
		} else {
			paraList_tRunJob_12.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_12.put("TABLE", obj_tRunJob_12);
	
	
		deepsea.hub_master_with_duplicates_0_1.HUB_MASTER_WITH_DUPLICATES childJob_tRunJob_12 = new deepsea.hub_master_with_duplicates_0_1.HUB_MASTER_WITH_DUPLICATES();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_14 = null;
		...
		obj_tRunJob_14 = "hongkong.master.customer.iqvia";
		...
		obj_tRunJob_14 = "Customer";
		if(obj_tRunJob_14!=null) {
			paraList_tRunJob_14.add("--context_param TYPE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_14));
		} else {
			paraList_tRunJob_14.add("--context_param TYPE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_14.put("TYPE", obj_tRunJob_14);
	
		obj_tRunJob_14 = "IQVIA";
		if(obj_tRunJob_14!=null) {
		...
		obj_tRunJob_14 = "providerCode";
		if(obj_tRunJob_14!=null) {
			paraList_tRunJob_14.add("--context_param BUSINESS_KEY=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_14));
		} else {
			paraList_tRunJob_14.add("--context_param BUSINESS_KEY=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_14.put("BUSINESS_KEY", obj_tRunJob_14);
	
		obj_tRunJob_14 = "customer";
		if(obj_tRunJob_14!=null) {
			paraList_tRunJob_14.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_14));
		} else {
			paraList_tRunJob_14.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_14.put("TABLE", obj_tRunJob_14);
	
	
		deepsea.hub_master_with_duplicates_0_1.HUB_MASTER_WITH_DUPLICATES childJob_tRunJob_14 = new deepsea.hub_master_with_duplicates_0_1.HUB_MASTER_WITH_DUPLICATES();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param BUSINESS_KEY=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param BUSINESS_KEY=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("BUSINESS_KEY", obj_tRunJob_2);
	
		obj_tRunJob_2 = "employee";
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("TABLE", obj_tRunJob_2);
	
	
		deepsea.hub_master_0_1.HUB_MASTER childJob_tRunJob_2 = new deepsea.hub_master_0_1.HUB_MASTER();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		obj_tRunJob_9 = "sales_objective";
		if(obj_tRunJob_9!=null) {
			paraList_tRunJob_9.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_9));
		} else {
			paraList_tRunJob_9.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_9.put("TABLE", obj_tRunJob_9);
	
	
		deepsea.hub_master_sales_objectives_0_1.HUB_MASTER_SALES_OBJECTIVES childJob_tRunJob_9 = new deepsea.hub_master_sales_objectives_0_1.HUB_MASTER_SALES_OBJECTIVES();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_10 = null;
		...
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param SOURCE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param SOURCE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("SOURCE", obj_tRunJob_10);
		...
		obj_tRunJob_10 = "sales_objective";
		if(obj_tRunJob_10!=null) {
			paraList_tRunJob_10.add("--context_param TABLE=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_10));
		} else {
			paraList_tRunJob_10.add("--context_param TABLE=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_10.put("TABLE", obj_tRunJob_10);
	
	
		deepsea.hub_master_sales_objectives_0_1.HUB_MASTER_SALES_OBJECTIVES childJob_tRunJob_10 = new deepsea.hub_master_sales_objectives_0_1.HUB_MASTER_SALES_OBJECTIVES();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final HONGKONG_BUILD_MASTER_HUBS HONGKONG_BUILD_MASTER_HUBSClass = new HONGKONG_BUILD_MASTER_HUBS();

        int exitCode = HONGKONG_BUILD_MASTER_HUBSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HONGKONG_BUILD_MASTER_HUBS.class.getClassLoader().getResourceAsStream("deepsea/hongkong_build_master_hubs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HONGKONG_BUILD_MASTER_HUBS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HONGKONG_BUILD_MASTER_HUBS");
        }
...
/************************************************************************************************
 *     171947 characters generated by Talend Open Studio for Big Data 
 *     on the September 1, 2019 8:05:56 PM CST
 ************************************************************************************************/