...
/**
 * Job: test3 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class test3 implements TalendJob {
	...
	private final String jobName = "test3";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(test3.this, new Object[] { e,
	...
	public void tSampleRow_1_error(Exception exception, String errorComponent,
		...
		tSampleRow_1_onSubJobError(exception, errorComponent, globalMap);
	}
	...
	public void tSampleRow_1_onSubJobError(Exception exception,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_test3 = new byte[0];
		static byte[] commonByteArray_DEEPSEA_test3 = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_DEEPSEA_test3) {
	...
	public void tSampleRow_1Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		globalMap.put("tSampleRow_1_SUBPROCESS_STATE", 0);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String[] rangetSampleRow_1 = "1,5,10..20".split(",");
		...
		globalMap.put("tSampleRow_1_SUBPROCESS_STATE", 1);
	}
	...
	public static void main(String[] args) {
		final test3 test3Class = new test3();

		int exitCode = test3Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test3.class.getClassLoader()
					.getResourceAsStream(
							"deepsea/test3_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = test3.class.getClassLoader().getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : test3");
		}
...
/************************************************************************************************
 * 29856 characters generated by Talend Open Studio for Big Data on the 21
 * January, 2019 3:08:42 AM GMT
 ************************************************************************************************/
