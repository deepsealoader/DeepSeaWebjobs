	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.hongkong_build_sales_links_0_1.HONGKONG_BUILD_SALES_LINKS childJob_tRunJob_3 = new deepsea.hongkong_build_sales_links_0_1.HONGKONG_BUILD_SALES_LINKS();
				// pass DataSources
...
/************************************************************************************************
 * 51842 characters generated by Talend Open Studio for Big Data on the January
 * 13, 2019 10:47:25 AM CST
 ************************************************************************************************/
