...
public class HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY.this,
	...
	public void tCreateTemporaryFile_2_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tMongoDBInput_5_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tMongoDBInput_8_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tCreateTemporaryFile_2_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tMongoDBInput_5_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tMongoDBInput_8_onSubJobError(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY.length == 0) {
				...
				dis.readFully(
						commonByteArray_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY,
						0, length);
	...
	public void tFileInputDelimited_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				 ...
				 */
				globalMap.get("tCreateTemporaryFile_1_FILEPATH").toString()/**
				 * End
	...
	public void tFileInputDelimited_3Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					while (limittFileInputDelimited_3 != 0
						...
						if (row1 != null) {
							...
							if (tHash_Lookup_row3 != null
								...
								// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.batchDate = '"
								// + row3HashKey.batchDate + "', row3.hash = '"
								// + row3HashKey.hash + "'");
							} // G 071
				...
				tFlowMeterCatcher_1.addMessage("newRow", new Integer(
				 ...
				 */
				globalMap.get("tCreateTemporaryFile_2_FILEPATH").toString()/**
				 * End
				...
				tFlowMeterCatcher_1.addMessage("orgRow", new Integer(
				...
				for (AggOperationStruct_tAggregateRow_2 aggregated_row_tAggregateRow_2 : values_tAggregateRow_2) { // G_AggR_600
					...
					parentContextMap_tRunJob_1.put("COLLECTION1",
							context.COLLECTION1);
					paraList_tRunJob_1.add("--context_type " + "COLLECTION1"
							+ "=" + "id_String");

					parentContextMap_tRunJob_1.put("COLLECTION2",
							context.COLLECTION2);
					paraList_tRunJob_1.add("--context_type " + "COLLECTION2"
							+ "=" + "id_String");
					...
					obj_tRunJob_1 = TalendDate.formatDate("yyyy-MM-dd",
							row8.batchDate);
					if (obj_tRunJob_1 != null) {
						paraList_tRunJob_1.add("--context_param BATCH_DATE="
								+ RuntimeUtils
										.tRunJobConvertContext(obj_tRunJob_1));
					} else {
						paraList_tRunJob_1
								.add("--context_param BATCH_DATE="
										+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
					}
					...
					if (obj_tRunJob_1 != null) {
						paraList_tRunJob_1.add("--context_param COLLECTION1="
								+ RuntimeUtils
										.tRunJobConvertContext(obj_tRunJob_1));
					} else {
						paraList_tRunJob_1
								.add("--context_param COLLECTION1="
										+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
					}

					parentContextMap_tRunJob_1
							.put("COLLECTION1", obj_tRunJob_1);

					obj_tRunJob_1 = context.getCOLLECTION2();
					if (obj_tRunJob_1 != null) {
						paraList_tRunJob_1.add("--context_param COLLECTION2="
								+ RuntimeUtils
										.tRunJobConvertContext(obj_tRunJob_1));
					} else {
						paraList_tRunJob_1
								.add("--context_param COLLECTION2="
										+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
					}

					parentContextMap_tRunJob_1
							.put("COLLECTION2", obj_tRunJob_1);

					obj_tRunJob_1 = context.getCOLLECTION2() + "-";
					if (obj_tRunJob_1 != null) {
						paraList_tRunJob_1.add("--context_param FILE_PREFIX="
								+ RuntimeUtils
										.tRunJobConvertContext(obj_tRunJob_1));
					} else {
						paraList_tRunJob_1
								.add("--context_param FILE_PREFIX="
										+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
					}

					parentContextMap_tRunJob_1
							.put("FILE_PREFIX", obj_tRunJob_1);

					obj_tRunJob_1 = "M/d/yy";
					if (obj_tRunJob_1 != null) {
						paraList_tRunJob_1.add("--context_param DATE_FORMAT="
								+ RuntimeUtils
										.tRunJobConvertContext(obj_tRunJob_1));
					} else {
						paraList_tRunJob_1
								.add("--context_param DATE_FORMAT="
										+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
					}

					parentContextMap_tRunJob_1
							.put("DATE_FORMAT", obj_tRunJob_1);
	...
	public void tFileInputDelimited_4Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(after_tFileInputDelimited_3) outputs:(row3,row3) |
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					for (com.mongodb.DBObject index : coll_tMongoDBInput_4
						...
						for (String key : ((com.mongodb.DBObject) index
							...
							// - there is no comma between the the DBcolumnName
							// and the colon
							if (("{'country.$id': ObjectId('"
									+ globalMap.get("COUNTRY_ID").toString()
									+ "'),'name': '" + context.getCOLLECTION1() + "'}, {'_id':1}")
									.matches(".*" + key + "[^,]*:.*")) {
								// We have an index, do not print error message
								needIndexWarning = false;
							} else {
				...
				org.bson.Document myQuery_tMongoDBInput_4 = org.bson.Document
						.parse("{'country.$id': ObjectId('"
								+ globalMap.get("COUNTRY_ID").toString()
								+ "'),'name': '" + context.getCOLLECTION1()
								+ "'}, {'_id':1}");
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tMongoDBInput_4:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public void tMongoDBInput_5Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				mongo_tMongoDBInput_5 = (com.mongodb.MongoClient) globalMap
						.get("mongo_tMongoDBConnection_1");
				db_tMongoDBInput_5 = (com.mongodb.client.MongoDatabase) globalMap
						.get("db_tMongoDBConnection_1");

				com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBInput_5 = db_tMongoDBInput_5
						.getCollection("collections");
				...
				try {
					...
					for (com.mongodb.DBObject index : coll_tMongoDBInput_5
							.listIndexes(com.mongodb.DBObject.class)) {
						...
						for (String key : ((com.mongodb.DBObject) index
							...
							if (("{'country.$id': ObjectId('"
									+ globalMap.get("COUNTRY_ID").toString()
									+ "'),'name': '" + context.getCOLLECTION2() + "'}, {'_id':1}")
									.matches(".*" + key + "[^,]*:.*")) {
								// We have an index, do not print error message
								needIndexWarning = false;
							} else {
					...
					if ((!"".equals(indexList)) && (needIndexWarning)) {
						...
						System.err
								.println("tMongoDBInput_5 - The query does not contain any reference an index.  ["
										+ indexList.substring(1) + " ]");
				...
				org.bson.Document myQuery_tMongoDBInput_5 = org.bson.Document
						.parse("{'country.$id': ObjectId('"
								+ globalMap.get("COUNTRY_ID").toString()
								+ "'),'name': '" + context.getCOLLECTION2()
								+ "'}, {'_id':1}");
				com.mongodb.client.FindIterable<org.bson.Document> fi_tMongoDBInput_5 = coll_tMongoDBInput_5
						.find(myQuery_tMongoDBInput_5).noCursorTimeout(false);
				...
				com.mongodb.client.MongoCursor<org.bson.Document> cursor_tMongoDBInput_5 = fi_tMongoDBInput_5
						.iterator();

				while (cursor_tMongoDBInput_5.hasNext()) {
					org.bson.Document o_tMongoDBInput_5 = cursor_tMongoDBInput_5
							.next();
					nb_line_tMongoDBInput_5++;
					Object valueObj_tMongoDBInput_5 = null;
					valueObj_tMongoDBInput_5 = dbObjectInputUtil_tMongoDBInput_5
							.getValue(pathMap_tMongoDBInput_5.get("id"), "_id",
									o_tMongoDBInput_5);
					if (valueObj_tMongoDBInput_5 != null
							&& valueObj_tMongoDBInput_5.toString().length() > 0) {
				...
				globalMap.put("tMongoDBInput_5_NB_LINE",
						nb_line_tMongoDBInput_5);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(globalMap
						.get("tCreateTemporaryFile_1_FILEPATH").toString()))
				...
				aggregationStages.add(org.bson.Document
						.parse("{ $match : {'country.$id': ObjectId('"
								+ globalMap.get("COUNTRY_ID").toString()
								+ "'), 'collection.$id' : ObjectId('"
								+ globalMap.get("COLLECTION1_ID").toString()
								+ "')} }"));
				...
				while (cursor_tMongoDBInput_2.hasNext()) {
					...
					if (valueObj_tMongoDBInput_2 != null
						...
						if (valueObj_tMongoDBInput_2 instanceof java.util.Date) {
							row12.batchDate = ParserUtils.parseTo_Date(
					...
					valueObj_tMongoDBInput_2 = dbObjectInputUtil_tMongoDBInput_2
							.getValue(pathMap_tMongoDBInput_2.get("hash"),
									"hash", o_tMongoDBInput_2);
					if (valueObj_tMongoDBInput_2 != null
							&& valueObj_tMongoDBInput_2.toString().length() > 0) {
					...
					rowtFileOutputDelimited_1[0] = row12.batchDate == null ? null
							: FormatterUtils.format_Date(row12.batchDate,
									"dd-MM-yyyy");
					rowtFileOutputDelimited_1[1] = row12.hash == null ? null
							: row12.hash;
	...
	public void tMongoDBInput_8Process(
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File(globalMap
						.get("tCreateTemporaryFile_2_FILEPATH").toString()))
						.getAbsolutePath().replace("\\", "/");
				...
				mongo_tMongoDBInput_8 = (com.mongodb.MongoClient) globalMap
						.get("mongo_tMongoDBConnection_1");
				db_tMongoDBInput_8 = (com.mongodb.client.MongoDatabase) globalMap
						.get("db_tMongoDBConnection_1");

				com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBInput_8 = db_tMongoDBInput_8
				...
				try {
					...
					for (com.mongodb.DBObject index : coll_tMongoDBInput_8
							.listIndexes(com.mongodb.DBObject.class)) {
					...
					if ((!"".equals(indexList)) && (needIndexWarning)) {
						...
						System.err
								.println("tMongoDBInput_8 - The query does not contain any reference an index.  ["
										+ indexList.substring(1) + " ]");
				...
				aggregationStages
						.add(org.bson.Document
								.parse("{$project: {'file': {$arrayElemAt: [{$filter: {input: { $objectToArray: '$file' }, cond: { $eq: [ '$$this.k', {$literal:'$id'} ] } } }, 0 ]}, 'fields': {$arrayToObject: {$filter: {input: {$map: {input: '$fields', in: { 'k': '$$this.tag', 'v': '$$this.value' } } }, cond: { $eq: [ '$$this.k', 'hash' ] } } } }, '_id': 0 } }"));

				aggregationStages.add(org.bson.Document
						.parse("{$match: { 'fields.hash': {$ne: null} } }"));

				aggregationStages
						.add(org.bson.Document
								.parse("{$group: { _id : { 'file_id': '$file.v', 'hash': '$fields.hash' } } }"));

				aggregationStages
						.add(org.bson.Document
								.parse("{$lookup: {from: 'transactions.files', localField: '_id.file_id', foreignField: '_id', as: 'file'} }"));

				aggregationStages.add(org.bson.Document
						.parse("{$match: {'file.country.$id': ObjectId('"
								+ globalMap.get("COUNTRY_ID").toString()
								+ "'), 'file.collection.$id' : ObjectId('"
								+ globalMap.get("COLLECTION2_ID").toString()
								+ "') } }"));

				aggregationStages
						.add(org.bson.Document
								.parse("{$group: { _id : { 'batchDate': { $arrayElemAt: [ '$file.batchDate', 0] }, 'hash': '$_id.hash' } } }"));

				aggregationStages
						.add(org.bson.Document
								.parse("{$project: { _id: 0, 'batchDate': '$_id.batchDate', 'hash': '$_id.hash' } }"));

				com.mongodb.client.MongoCursor<org.bson.Document> cursor_tMongoDBInput_8 = coll_tMongoDBInput_8
						.aggregate(aggregationStages).allowDiskUse(false)
						.iterator();
				...
				while (cursor_tMongoDBInput_8.hasNext()) {
					org.bson.Document o_tMongoDBInput_8 = cursor_tMongoDBInput_8
							.next();
					nb_line_tMongoDBInput_8++;
					Object valueObj_tMongoDBInput_8 = null;
					valueObj_tMongoDBInput_8 = dbObjectInputUtil_tMongoDBInput_8
							.getValue(pathMap_tMongoDBInput_8.get("batchDate"),
									"batchDate", o_tMongoDBInput_8);
					if (valueObj_tMongoDBInput_8 != null
							&& valueObj_tMongoDBInput_8.toString().length() > 0) {
						if (valueObj_tMongoDBInput_8 instanceof java.util.Date) {
							row17.batchDate = ParserUtils.parseTo_Date(
									(java.util.Date) valueObj_tMongoDBInput_8,
									"dd-MM-yyyy");
						} else {
							row17.batchDate = ParserUtils.parseTo_Date(
									(String) valueObj_tMongoDBInput_8,
									"dd-MM-yyyy");
						}
					} else {
					...
					valueObj_tMongoDBInput_8 = dbObjectInputUtil_tMongoDBInput_8
							.getValue(pathMap_tMongoDBInput_8.get("hash"),
									"hash", o_tMongoDBInput_8);
					if (valueObj_tMongoDBInput_8 != null
							&& valueObj_tMongoDBInput_8.toString().length() > 0) {
					...
					if (execStat) {
						runStat.updateStatOnConnection("row17" + iterateId, 1,
								1);
					}

					String[] rowtFileOutputDelimited_2 = new String[2];
					rowtFileOutputDelimited_2[0] = row17.batchDate == null ? null
							: FormatterUtils.format_Date(row17.batchDate,
									"dd-MM-yyyy");
					rowtFileOutputDelimited_2[1] = row17.hash == null ? null
							: row17.hash;
					synchronized (multiThreadLockWrite) {
						nb_line_tFileOutputDelimited_2++;
						resourceMap.put("nb_line_tFileOutputDelimited_2",
				...
				globalMap.put("tMongoDBInput_8_NB_LINE",
						nb_line_tMongoDBInput_8);
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tMongoDBInput_8:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public static void main(String[] args) {
		...
		int exitCode = HONGKONG_SALES_DKHS_DAILY_TO_MONTHLYClass
				.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY.class
					.getClassLoader().getResourceAsStream(
							"deepsea/hongkong_sales_dkhs_daily_to_monthly_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY");
		}
...
/************************************************************************************************
 * 316860 characters generated by Talend Open Studio for Big Data on the January
 * 20, 2019 2:33:18 PM CST
 ************************************************************************************************/
