...
package deepsea.hongkong_sales_dkhs_daily_to_monthly_0_1;
...
/**
 * Job: HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_vCYM0BxcEemq1ufngkpuaw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY = new byte[0];
    static byte[] commonByteArray_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY.length == 0) {
   					commonByteArray_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY) {
 ...
 */
    ...
    public static void main(String[] args){
        final HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY HONGKONG_SALES_DKHS_DAILY_TO_MONTHLYClass = new HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY();

        int exitCode = HONGKONG_SALES_DKHS_DAILY_TO_MONTHLYClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY.class.getClassLoader().getResourceAsStream("deepsea/hongkong_sales_dkhs_daily_to_monthly_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HONGKONG_SALES_DKHS_DAILY_TO_MONTHLY");
        }
...
/************************************************************************************************
 *     317997 characters generated by Talend Open Studio for Big Data 
 *     on the September 1, 2019 7:34:11 PM CST
 ************************************************************************************************/