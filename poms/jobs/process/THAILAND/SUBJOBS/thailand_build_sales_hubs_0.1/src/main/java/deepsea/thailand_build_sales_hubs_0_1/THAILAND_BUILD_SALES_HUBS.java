...
package deepsea.thailand_build_sales_hubs_0_1;
...
/**
 * Job: THAILAND_BUILD_SALES_HUBS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class THAILAND_BUILD_SALES_HUBS implements TalendJob {
...
public String getWEBJOB_NAME(){
	...
	private final String jobName = "THAILAND_BUILD_SALES_HUBS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				THAILAND_BUILD_SALES_HUBS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(THAILAND_BUILD_SALES_HUBS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = "thailand.sales.dkhs.monthly";
		if(obj_tRunJob_2!=null) {
 ...
 */
    ...
    public static void main(String[] args){
        final THAILAND_BUILD_SALES_HUBS THAILAND_BUILD_SALES_HUBSClass = new THAILAND_BUILD_SALES_HUBS();

        int exitCode = THAILAND_BUILD_SALES_HUBSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = THAILAND_BUILD_SALES_HUBS.class.getClassLoader().getResourceAsStream("deepsea/thailand_build_sales_hubs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = THAILAND_BUILD_SALES_HUBS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : THAILAND_BUILD_SALES_HUBS");
        }
...
/************************************************************************************************
 *     35202 characters generated by Talend Open Studio for Big Data 
