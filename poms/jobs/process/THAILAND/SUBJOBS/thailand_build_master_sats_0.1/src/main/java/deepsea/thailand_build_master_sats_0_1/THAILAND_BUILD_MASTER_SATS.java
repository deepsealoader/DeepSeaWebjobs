...
package deepsea.thailand_build_master_sats_0_1;
...
/**
 * Job: THAILAND_BUILD_MASTER_SATS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class THAILAND_BUILD_MASTER_SATS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "THAILAND_BUILD_MASTER_SATS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				THAILAND_BUILD_MASTER_SATS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(THAILAND_BUILD_MASTER_SATS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "thailand.master.employee.servier";
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = "thailand.master.markethierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "thailand.master.organizationhierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		obj_tRunJob_5 = "thailand.master.producthierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_10 = null;
		...
		obj_tRunJob_10 = "thailand.master.customer.dksh";
		if(obj_tRunJob_10!=null) {
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		obj_tRunJob_9 = "thailand.master.salesobjectiveval.servier";
 ...
 */
    ...
    public static void main(String[] args){
        final THAILAND_BUILD_MASTER_SATS THAILAND_BUILD_MASTER_SATSClass = new THAILAND_BUILD_MASTER_SATS();

        int exitCode = THAILAND_BUILD_MASTER_SATSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = THAILAND_BUILD_MASTER_SATS.class.getClassLoader().getResourceAsStream("deepsea/thailand_build_master_sats_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = THAILAND_BUILD_MASTER_SATS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : THAILAND_BUILD_MASTER_SATS");
        }
...
/************************************************************************************************
 *     113453 characters generated by Talend Open Studio for Big Data 
 *     on the May 23, 2019 7:36:57 PM SGT
 ************************************************************************************************/