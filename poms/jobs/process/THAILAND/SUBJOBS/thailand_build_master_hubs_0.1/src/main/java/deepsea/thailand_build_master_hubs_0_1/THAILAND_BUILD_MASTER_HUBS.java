...
package deepsea.thailand_build_master_hubs_0_1;
...
/**
 * Job: THAILAND_BUILD_MASTER_HUBS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class THAILAND_BUILD_MASTER_HUBS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "THAILAND_BUILD_MASTER_HUBS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				THAILAND_BUILD_MASTER_HUBS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(THAILAND_BUILD_MASTER_HUBS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		obj_tRunJob_5 = "thailand.master.markethierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		obj_tRunJob_7 = "thailand.master.organizationhierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		obj_tRunJob_6 = "thailand.master.sourcechannel.servier";
 ...
 */
	...
	Object obj_tRunJob_11 = null;
		...
		obj_tRunJob_11 = "thailand.master.producthierarchy.dksh";
		if(obj_tRunJob_11!=null) {
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "thailand.master.geographyhierarchy.servier";
 ...
 */
	...
	Object obj_tRunJob_12 = null;
		...
		obj_tRunJob_12 = "thailand.master.customer.dksh";
 ...
 */
    ...
    public static void main(String[] args){
        final THAILAND_BUILD_MASTER_HUBS THAILAND_BUILD_MASTER_HUBSClass = new THAILAND_BUILD_MASTER_HUBS();

        int exitCode = THAILAND_BUILD_MASTER_HUBSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = THAILAND_BUILD_MASTER_HUBS.class.getClassLoader().getResourceAsStream("deepsea/thailand_build_master_hubs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = THAILAND_BUILD_MASTER_HUBS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : THAILAND_BUILD_MASTER_HUBS");
        }
...
/************************************************************************************************
 *     134613 characters generated by Talend Open Studio for Big Data 
 *     on the May 23, 2019 7:36:39 PM SGT
 ************************************************************************************************/