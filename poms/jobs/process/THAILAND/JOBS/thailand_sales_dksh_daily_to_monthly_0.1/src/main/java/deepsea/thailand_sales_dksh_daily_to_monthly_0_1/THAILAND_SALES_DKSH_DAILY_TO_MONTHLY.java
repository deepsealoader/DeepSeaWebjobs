...
package deepsea.thailand_sales_dksh_daily_to_monthly_0_1;
...
/**
 * Job: THAILAND_SALES_DKSH_DAILY_TO_MONTHLY Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class THAILAND_SALES_DKSH_DAILY_TO_MONTHLY implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "THAILAND_SALES_DKSH_DAILY_TO_MONTHLY";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_eiE-gCgpEemFVuMGViEZbg", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				THAILAND_SALES_DKSH_DAILY_TO_MONTHLY.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(THAILAND_SALES_DKSH_DAILY_TO_MONTHLY.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_THAILAND_SALES_DKSH_DAILY_TO_MONTHLY = new byte[0];
    static byte[] commonByteArray_DEEPSEA_THAILAND_SALES_DKSH_DAILY_TO_MONTHLY = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_THAILAND_SALES_DKSH_DAILY_TO_MONTHLY.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_THAILAND_SALES_DKSH_DAILY_TO_MONTHLY.length == 0) {
   					commonByteArray_DEEPSEA_THAILAND_SALES_DKSH_DAILY_TO_MONTHLY = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_THAILAND_SALES_DKSH_DAILY_TO_MONTHLY = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_THAILAND_SALES_DKSH_DAILY_TO_MONTHLY, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_THAILAND_SALES_DKSH_DAILY_TO_MONTHLY, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_THAILAND_SALES_DKSH_DAILY_TO_MONTHLY) {
				...
				try{
					...
					for (com.mongodb.DBObject index: coll_tMongoDBInput_2.listIndexes(com.mongodb.DBObject.class)) {
	                    ...
	                    for (String key: ((com.mongodb.DBObject)index.get("key")).keySet()) {
	                        ...
	                        // - is followed at some point by a colon
	                        // - there is no comma between the the DBcolumnName and the colon
	                        if  (("{'country.$id': ObjectId('" + globalMap.get("COUNTRY_ID").toString() + "'), 'collection.$id': ObjectId('" + globalMap.get("COLLECTION1_ID").toString() + "')}, , {'_id':1, 'hash':1, 'bashDate':1}").matches(".*" + key + "[^,]*:.*")) {
	                            // We have an index, do not print error message
	                            needIndexWarning = false;
	                        } else {
	                            // This index is not in the query, add it into the indexList
					...
					org.bson.Document myQuery_tMongoDBInput_2 = org.bson.Document.parse("{'country.$id': ObjectId('" + globalMap.get("COUNTRY_ID").toString() + "'), 'collection.$id': ObjectId('" + globalMap.get("COLLECTION1_ID").toString() + "')}, , {'_id':1, 'hash':1, 'bashDate':1}");
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		deepsea.thailand_update_one_month_sales_0_1.THAILAND_UPDATE_ONE_MONTH_SALES childJob_tRunJob_1 = new deepsea.thailand_update_one_month_sales_0_1.THAILAND_UPDATE_ONE_MONTH_SALES();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final THAILAND_SALES_DKSH_DAILY_TO_MONTHLY THAILAND_SALES_DKSH_DAILY_TO_MONTHLYClass = new THAILAND_SALES_DKSH_DAILY_TO_MONTHLY();

        int exitCode = THAILAND_SALES_DKSH_DAILY_TO_MONTHLYClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = THAILAND_SALES_DKSH_DAILY_TO_MONTHLY.class.getClassLoader().getResourceAsStream("deepsea/thailand_sales_dksh_daily_to_monthly_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = THAILAND_SALES_DKSH_DAILY_TO_MONTHLY.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : THAILAND_SALES_DKSH_DAILY_TO_MONTHLY");
        }
...
/************************************************************************************************
 *     332250 characters generated by Talend Open Studio for Big Data 
 *     on the March 29, 2019 2:53:23 PM SGT
 ************************************************************************************************/