...
package deepsea.thailand_build_master_vault_0_1;
...
/**
 * Job: THAILAND_BUILD_MASTER_VAULT Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class THAILAND_BUILD_MASTER_VAULT implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "THAILAND_BUILD_MASTER_VAULT";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				THAILAND_BUILD_MASTER_VAULT.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(THAILAND_BUILD_MASTER_VAULT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
	...
	java.util.List<String> paraList_tRunJob_3 = new java.util.ArrayList<String>();
			...
			if (osName_tRunJob_3 != null && osName_tRunJob_3.toLowerCase().startsWith("win")){
						...
						paraList_tRunJob_3.add("java");
								...
								paraList_tRunJob_3.add(dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/advancedPersistentLookupLib-1.2.jar:$ROOT_PATH/../lib/commons-collections-3.2.2.jar:$ROOT_PATH/../lib/commons-lang-2.6.jar:$ROOT_PATH/../lib/dom4j-1.6.1.jar:$ROOT_PATH/../lib/jboss-serialization.jar:$ROOT_PATH/../lib/jersey-client-1.4.jar:$ROOT_PATH/../lib/jersey-core-1.4.jar:$ROOT_PATH/../lib/log4j-1.2.15.jar:$ROOT_PATH/../lib/log4j-1.2.16.jar:$ROOT_PATH/../lib/mongo-java-driver-3.5.0.jar:$ROOT_PATH/../lib/postgresql-8.3-603.jdbc3.jar:$ROOT_PATH/../lib/talendcsv.jar:$ROOT_PATH/../lib/trove.jar:$ROOT_PATH/thailand_build_master_sats_0_1.jar:$ROOT_PATH/sat_product_0_1.jar:$ROOT_PATH/sat_market_0_1.jar:$ROOT_PATH/dsendexception_0_1.jar:$ROOT_PATH/sat_employee_0_1.jar:$ROOT_PATH/sat_source_channel_0_1.jar:$ROOT_PATH/sat_customer_0_1.jar:$ROOT_PATH/sat_sales_objective_0_1.jar:$ROOT_PATH/sat_organization_0_1.jar:$ROOT_PATH/sat_geography_0_1.jar:").replace("$ROOT_PATH",System.getProperty("user.dir")));
	...
	java.util.List<String> paraList_tRunJob_2 = new java.util.ArrayList<String>();
			...
			if (osName_tRunJob_2 != null && osName_tRunJob_2.toLowerCase().startsWith("win")){
		      			...
		      			paraList_tRunJob_2.add("java");
		        				...
		        				paraList_tRunJob_2.add(dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/advancedPersistentLookupLib-1.2.jar;../lib/commons-collections-3.2.2.jar;../lib/dom4j-1.6.1.jar;../lib/jboss-serialization.jar;../lib/jersey-client-1.4.jar;../lib/jersey-core-1.4.jar;../lib/log4j-1.2.15.jar;../lib/log4j-1.2.16.jar;../lib/mongo-java-driver-3.5.0.jar;../lib/postgresql-8.3-603.jdbc3.jar;../lib/talendcsv.jar;../lib/trove.jar;thailand_build_master_links_0_1.jar;dsendexception_0_1.jar;link_master_with_multiple_0_1.jar;link_master_with_empty_0_1.jar;check_geography_customer_link_0_1.jar;link_master_sales_objective_0_1.jar;sal_master_0_1.jar;link_master_0_1.jar;"));
		      				
		      					paraList_tRunJob_2.add("deepsea.thailand_build_master_links_0_1.THAILAND_BUILD_MASTER_LINKS");
 ...
 */
    ...
    public static void main(String[] args){
        final THAILAND_BUILD_MASTER_VAULT THAILAND_BUILD_MASTER_VAULTClass = new THAILAND_BUILD_MASTER_VAULT();

        int exitCode = THAILAND_BUILD_MASTER_VAULTClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = THAILAND_BUILD_MASTER_VAULT.class.getClassLoader().getResourceAsStream("deepsea/thailand_build_master_vault_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = THAILAND_BUILD_MASTER_VAULT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : THAILAND_BUILD_MASTER_VAULT");
        }
...
/************************************************************************************************
 *     64942 characters generated by Talend Open Studio for Big Data 
 *     on the February 6, 2019 10:13:29 AM CST
 ************************************************************************************************/