...
package deepsea.hub_master_0_1;
...
/**
 * Job: HUB_MASTER Purpose: Update Master HUB<br>
 * Description: Update Master HUB <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HUB_MASTER implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "HUB_MASTER";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_mNHqkL5dEeiCjvO30csXeA", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HUB_MASTER.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
}				exception2.source = row10.source;			exception2.businessKey = row10.businessKey;			exception2.hash = row10.hash;			
}
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","Duplicated key","", "");
	globalMap.put("tWarn_1_WARN_MESSAGES", "Duplicated key"); 
 ...
 */
    ...
    public static void main(String[] args){
        final HUB_MASTER HUB_MASTERClass = new HUB_MASTER();

        int exitCode = HUB_MASTERClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HUB_MASTER.class.getClassLoader().getResourceAsStream("deepsea/hub_master_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HUB_MASTER.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HUB_MASTER");
        }
...
/************************************************************************************************
 *     294440 characters generated by Talend Open Studio for Big Data 
