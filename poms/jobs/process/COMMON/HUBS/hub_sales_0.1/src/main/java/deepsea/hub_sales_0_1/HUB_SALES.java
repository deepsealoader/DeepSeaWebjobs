...
/**
 * Job: HUB_SALES Purpose: Update Sales HUB<br>
 * Description: Update Sales HUB <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HUB_SALES implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "HUB_SALES";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_ht0VcM-7Eeib9oVpaXTd6w", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HUB_SALES.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row11Struct implements routines.system.IPersistableRow<row11Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_HUB_SALES = new byte[0];
    static byte[] commonByteArray_DEEPSEA_HUB_SALES = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_HUB_SALES.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_HUB_SALES.length == 0) {
   					commonByteArray_DEEPSEA_HUB_SALES = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_HUB_SALES = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_HUB_SALES, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_HUB_SALES, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_HUB_SALES) {
	...
	int nb_line_tMongoDBInput_4 = 0;
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_4=null;
				...
				if(valueObj_tMongoDBInput_4!=null && valueObj_tMongoDBInput_4.toString().length() > 0) {
					row11.id = valueObj_tMongoDBInput_4.toString();
				}else{
					row11.id = null;
				}
...
globalMap.put("COLLECTION_ID", row10.id);
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("row9", new Integer(count_tFlowMeter_11), "null", "", "tFlowMeter_11");
	...
	int nb_line_tMongoDBInput_5 = 0;
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_5=null;
				...
				if(valueObj_tMongoDBInput_5!=null && valueObj_tMongoDBInput_5.toString().length() > 0) {
					row8.hash = valueObj_tMongoDBInput_5.toString();
				}else{
					row8.hash = null;
				}
 ...
 */
	...
	currentComponent="tFlowToIterate_1";
            ...
            globalMap.put("row12.hash", row12.hash);
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_1=null;
				...
				try{
	            	...
	            	// maybe due to authorization
							...
							aggregationStages.add(org.bson.Document.parse("{ $match : {'file.country.$id': ObjectId('" + globalMap.get("COUNTRY_ID").toString() + "'), 'file.collection.$id': ObjectId('" + globalMap.get("COLLECTION_ID").toString() + "'), 'file.hash': '" + globalMap.get("row12.hash").toString() + "'} }"));
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("row17", new Integer(count_tFlowMeter_16), "null", "", "tFlowMeter_16");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
        ...
        new BytesLimit65535_tAdvancedHash_row4().limitLog4jByte();
			   		...
			   		// linked node: tMap_2 - inputs:(row3,row4) outputs:(row9)
	...
	int nb_line_tMongoDBInput_2 = 0;
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_2=null;
				...
				try{
					...
					org.bson.Document myQuery_tMongoDBInput_2 = org.bson.Document.parse("{'country.$id': ObjectId('" + globalMap.get("COUNTRY_ID").toString() + "'), 'collection.$id': ObjectId('" + globalMap.get("COLLECTION_ID").toString() + "')}, {_id: 1}");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row15";
        ...
        new BytesLimit65535_tAdvancedHash_row15().limitLog4jByte();
			   		...
			   		// source node:tDBInput_2 - inputs:(after_tMongoDBInput_5) outputs:(row15,row15) | target node:tAdvancedHash_row15 - inputs:(row15) outputs:()
			   		// linked node: tMap_3 - inputs:(row8,row15) outputs:(row17)
 ...
 */
	...
	currentComponent="tDBInput_2";
        ...
        new BytesLimit65535_tDBInput_2().limitLog4jByte();
        	...
        	row15.hash = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final HUB_SALES HUB_SALESClass = new HUB_SALES();

        int exitCode = HUB_SALESClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HUB_SALES.class.getClassLoader().getResourceAsStream("deepsea/hub_sales_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HUB_SALES.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("SOURCE")) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HUB_SALES");
        }
...
/************************************************************************************************
 *     250687 characters generated by Talend Open Studio for Big Data 
 *     on the 3 December, 2018 11:37:01 PM AEDT
 ************************************************************************************************/