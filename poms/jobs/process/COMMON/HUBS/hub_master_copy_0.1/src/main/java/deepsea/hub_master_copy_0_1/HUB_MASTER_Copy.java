...
package deepsea.hub_master_copy_0_1;
...
/**
 * Job: HUB_MASTER_Copy Purpose: Update Master HUB<br>
 * Description: Update Master HUB <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HUB_MASTER_Copy implements TalendJob {
	...
	private final String jobName = "HUB_MASTER_Copy";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					HUB_MASTER_Copy.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(HUB_MASTER_Copy.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_HUB_MASTER_Copy = new byte[0];
		static byte[] commonByteArray_DEEPSEA_HUB_MASTER_Copy = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_HUB_MASTER_Copy.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_HUB_MASTER_Copy.length == 0) {
						commonByteArray_DEEPSEA_HUB_MASTER_Copy = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_HUB_MASTER_Copy = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_HUB_MASTER_Copy, 0,
						length);
				strReturn = new String(commonByteArray_DEEPSEA_HUB_MASTER_Copy,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_HUB_MASTER_Copy) {
	...
	public static class ou1Struct implements
			routines.system.IPersistableRow<ou1Struct> {
		final static byte[] commonByteArrayLock_DEEPSEA_HUB_MASTER_Copy = new byte[0];
		static byte[] commonByteArray_DEEPSEA_HUB_MASTER_Copy = new byte[0];
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "hub_" + context.getTABLE();
				} else {
				...
				String delete_tDBOutput_1 = "DELETE FROM \""
						+ tableName_tDBOutput_1 + "\" WHERE \"hash\" = ?";
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement(delete_tDBOutput_1);
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row3.hash = routines.system.JDBCUtil.getString(
						...
						if (ou1 != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection("ou1"
										+ iterateId, 1, 1);
							}
							...
							if (row2.hash == null) {
								...
								pstmt_tDBOutput_1.setString(1, row2.hash);
							}
				...
				tFlowMeterCatcher_1.addMessage("Number of files deleted",
						new Integer(count_tFlowMeter_11), "null", "",
						"tFlowMeter_11");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_2 == null
					...
					tableName_tDBOutput_2 = (String) globalMap.get("HUB_TABLE");
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\""
							+ (String) globalMap.get("HUB_TABLE");
				}
				...
				String insert_tDBOutput_2 = "INSERT INTO \""
						...
						+ "\" (\"source\",\"business_key\",\"hash\") VALUES (?,?,?)";
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime
									* result
									+ ((this.businessKey == null) ? 0
											: this.businessKey.hashCode());
				...
				class RowSetValueUtil_tSchemaComplianceCheck_1 {
					...
					void setRowValue_0(row5Struct row5) {
						...
						if ((row5.source == null) || ("".equals(row5.source))) {
						...
						errorMessageThrough = "";
						// validate nullable (empty as null)
						if ((row5.businessKey == null)
								|| ("".equals(row5.businessKey))) {
							ifPassedThrough = false;
							errorCodeThrough += 4;
							errorMessageThrough += "|empty or null";
						}
						...
						errorMessageThrough = "";
						// validate nullable (empty as null)
						if ((row5.hash == null) || ("".equals(row5.hash))) {
							ifPassedThrough = false;
							errorCodeThrough += 4;
							errorMessageThrough += "|empty or null";
						}
				...
				aggregationStages
						.add(org.bson.Document
								.parse("{ $lookup: {from: 'master.files', localField: '_fileRef.id', foreignField: '_id', as: 'file'} }"));
				...
				aggregationStages.add(org.bson.Document
						.parse("{ $match : {'file.country.$id': ObjectId('"
								...
								+ "'), 'file.metadata.type' : '"
								+ context.getTYPE() + "', 'sheetName' : '"
								+ context.getSHEET_NAME() + "' } }"));
				...
				while (cursor_tMongoDBInput_1.hasNext()) {
					...
					if (tHash_Lookup_row8 != null
						...
						// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row8' and it contains more one result from keys :  row8.hash = '"
						// + row8HashKey.hash + "'");
					} // G 071
					...
					{ // start of Var scope
						...
						if (rejectedInnerJoin_tMap_1) {
							row7_tmp.id = row1.id;
							row7_tmp.source = context.getSOURCE();
					...
					if (row7 != null) {
						...
						row5.source = row11.source;
						row5.businessKey = utility_tExtractFields_1.UnPivot(
								doc_tExtractFields_1, "tag", "value",
								context.getBUSINESS_KEY());
						row5.hash = row11.hash;
						...
						if (row5 != null) {
							...
							if (rsvUtil_tSchemaComplianceCheck_1.ifPassedThrough) {
								...
								row10.source = row5.source;
								row10.businessKey = row5.businessKey;
								row10.hash = row5.hash;
							}
							if (!rsvUtil_tSchemaComplianceCheck_1.ifPassedThrough) {
								exception1 = new exception1Struct();
								exception1.source = row5.source;
								exception1.businessKey = row5.businessKey;
								exception1.hash = row5.hash;
							...
							/**
							 * [tSchemaComplianceCheck_1 process_data_begin ]
							 * start
							 */
							...
							if (row10 != null) {
								...
								if (row10.source == null) {
									...
									finder_tUniqRow_1.source = row10.source
											.toLowerCase();
								}
								if (row10.businessKey == null) {
									finder_tUniqRow_1.businessKey = null;
								} else {
									finder_tUniqRow_1.businessKey = row10.businessKey
											.toLowerCase();
								}
								if (row10.hash == null) {
									finder_tUniqRow_1.hash = null;
								} else {
									finder_tUniqRow_1.hash = row10.hash
											.toLowerCase();
								}
								...
								if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
									...
									if (row10.source == null) {
										...
										new_tUniqRow_1.source = row10.source
												.toLowerCase();
									}
									if (row10.businessKey == null) {
										new_tUniqRow_1.businessKey = null;
									} else {
										new_tUniqRow_1.businessKey = row10.businessKey
												.toLowerCase();
									}
									if (row10.hash == null) {
										new_tUniqRow_1.hash = null;
									} else {
										new_tUniqRow_1.hash = row10.hash
												.toLowerCase();
									}
									...
									row9.source = row10.source;
									row9.businessKey = row10.businessKey;
									row9.hash = row10.hash;
									nb_uniques_tUniqRow_1++;
								} else {
									if (!keysForDuplicatedtUniqRow_1
										...
										keysForDuplicatedtUniqRow_1
												.add(new_tUniqRow_1);

										if (exception2 == null) {

											exception2 = new exception2Struct();
										}
										exception2.source = row10.source;
										exception2.businessKey = row10.businessKey;
										exception2.hash = row10.hash;
									}
								...
								if (exception2 != null) {
									...
									parentContextMap_tRunJob_2.put("TYPE",
											context.TYPE);
									...
									paraList_tRunJob_2.add("--context_type "
											+ "SHEET_NAME" + "=" + "id_String");

									parentContextMap_tRunJob_2.put("SOURCE",
											context.SOURCE);
									paraList_tRunJob_2.add("--context_type "
											+ "SOURCE" + "=" + "id_String");
									...
									parentContextMap_tRunJob_2.put("TABLE",
											context.TABLE);
									paraList_tRunJob_2.add("--context_type "
											+ "TABLE" + "=" + "id_String");

									parentContextMap_tRunJob_2.put(
											"WEBJOB_NAME", context.WEBJOB_NAME);
									paraList_tRunJob_2
											.add("--context_type "
													+ "WEBJOB_NAME" + "="
													+ "id_String");

									parentContextMap_tRunJob_2.put("COUNTRY",
											context.COUNTRY);
									paraList_tRunJob_2.add("--context_type "
											+ "COUNTRY" + "=" + "id_String");
									...
									parentContextMap_tRunJob_2.put("WEBJOB_ID",
											obj_tRunJob_2);

									obj_tRunJob_2 = row1.id;
									if (obj_tRunJob_2 != null) {
										paraList_tRunJob_2
									...
									parentContextMap_tRunJob_2.put("RECORD_ID",
											obj_tRunJob_2);

									obj_tRunJob_2 = context.getBUSINESS_KEY();
									if (obj_tRunJob_2 != null) {
										paraList_tRunJob_2
									...
									parentContextMap_tRunJob_2.put(
											"FIELD_NAME", obj_tRunJob_2);

									obj_tRunJob_2 = exception2.businessKey;
									if (obj_tRunJob_2 != null) {
										paraList_tRunJob_2
									...
									parentContextMap_tRunJob_2.put(
											"FIELD_VALUE", obj_tRunJob_2);

									obj_tRunJob_2 = "Duplicated keys";
									if (obj_tRunJob_2 != null) {
										paraList_tRunJob_2
									...
									parentContextMap_tRunJob_2.put("REASON",
											obj_tRunJob_2);
									...
									try {
										...
										globalMap.put("tWarn_1_WARN_MESSAGES",
												"Duplicated key");
										globalMap.put("tWarn_1_WARN_PRIORITY",
												4);
							...
							if (exception1 != null) {
								...
								row15.source = exception1.source;

								row15.businessKey = exception1.businessKey;

								row15.hash = exception1.hash;

								row15.errorCode = exception1.errorCode;

								row15.errorMessage = exception1.errorMessage;
								...
								parentContextMap_tRunJob_1.put("TYPE",
										context.TYPE);
								paraList_tRunJob_1.add("--context_type "
										+ "TYPE" + "=" + "id_String");

								parentContextMap_tRunJob_1.put("SHEET_NAME",
										context.SHEET_NAME);
								paraList_tRunJob_1.add("--context_type "
										+ "SHEET_NAME" + "=" + "id_String");

								parentContextMap_tRunJob_1.put("SOURCE",
										context.SOURCE);
								paraList_tRunJob_1.add("--context_type "
										+ "SOURCE" + "=" + "id_String");

								parentContextMap_tRunJob_1.put("BUSINESS_KEY",
										context.BUSINESS_KEY);
								paraList_tRunJob_1.add("--context_type "
										+ "BUSINESS_KEY" + "=" + "id_String");

								parentContextMap_tRunJob_1.put("TABLE",
										context.TABLE);
								paraList_tRunJob_1.add("--context_type "
										+ "TABLE" + "=" + "id_String");
								...
								parentContextMap_tRunJob_1.put("WEBJOB_NAME",
										context.WEBJOB_NAME);
								paraList_tRunJob_1.add("--context_type "
										+ "WEBJOB_NAME" + "=" + "id_String");

								parentContextMap_tRunJob_1.put("COUNTRY",
										context.COUNTRY);
								paraList_tRunJob_1.add("--context_type "
										+ "COUNTRY" + "=" + "id_String");
								...
								parentContextMap_tRunJob_1.put("COUNTRY_ID",
										obj_tRunJob_1);
								...
								parentContextMap_tRunJob_1.put("WEBJOB_ID",
										obj_tRunJob_1);
								...
								parentContextMap_tRunJob_1.put("RECORD_ID",
										obj_tRunJob_1);

								obj_tRunJob_1 = context.getBUSINESS_KEY();
								if (obj_tRunJob_1 != null) {
									paraList_tRunJob_1
											.add("--context_param FIELD_NAME="
													+ RuntimeUtils
								...
								parentContextMap_tRunJob_1.put("FIELD_NAME",
										obj_tRunJob_1);

								obj_tRunJob_1 = exception1.businessKey;
								if (obj_tRunJob_1 != null) {
									paraList_tRunJob_1
											.add("--context_param FIELD_VALUE="
													+ RuntimeUtils
								...
								parentContextMap_tRunJob_1.put("FIELD_VALUE",
										obj_tRunJob_1);
								...
								parentContextMap_tRunJob_1.put("REASON",
										obj_tRunJob_1);
								...
								try {
									...
									System.err.println("Schema invalid:"
											+ exception1.errorMessage
											+ ", abort ...");
							...
							/**
							 * [tSchemaComplianceCheck_1 process_data_end ]
							 * start
							 */
				...
				tFlowMeterCatcher_1.addMessage("Number of records read",
						new Integer(count_tFlowMeter_18), "null", "",
						"tFlowMeter_18");
				...
				tFlowMeterCatcher_1.addMessage("Number of records integrated",
						new Integer(count_tFlowMeter_13), "null", "",
						"tFlowMeter_13");
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row8.hash = routines.system.JDBCUtil.getString(
	...
	public void tMongoDBInput_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tMongoDBInput_2 - inputs:(after_tDBInput_1)
				// outputs:(row4,row4) | target node:tAdvancedHash_row4 -
				// inputs:(row4) outputs:()
				// linked node: tMap_2 - inputs:(row3,row4) outputs:(ou1)
				...
				while (cursor_tMongoDBInput_2.hasNext()) {
					...
					if (valueObj_tMongoDBInput_2 != null
						...
						row4.hash = valueObj_tMongoDBInput_2.toString();
					} else {
						row4.hash = null;
					}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				while (cursor_tMongoDBInput_4.hasNext()) {
					...
					if (valueObj_tMongoDBInput_4 != null
						...
						row12.id = valueObj_tMongoDBInput_4.toString();
					} else {
						row12.id = null;
					}
	...
	public static void main(String[] args) {
		final HUB_MASTER_Copy HUB_MASTER_CopyClass = new HUB_MASTER_Copy();

		int exitCode = HUB_MASTER_CopyClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HUB_MASTER_Copy.class
					.getClassLoader().getResourceAsStream(
							"deepsea/hub_master_copy_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = HUB_MASTER_Copy.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("SHEET_NAME")) {
				context.SHEET_NAME = (String) parentContextMap
						.get("SHEET_NAME");
			}
			...
			if (parentContextMap.containsKey("BUSINESS_KEY")) {
				context.BUSINESS_KEY = (String) parentContextMap
						.get("BUSINESS_KEY");
			}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : HUB_MASTER_Copy");
		}
...
/************************************************************************************************
 * 309782 characters generated by Talend Open Studio for Big Data on the May 29,
 * 2019 4:46:11 PM KST
 ************************************************************************************************/
