...
package deepsea.hub_master_with_duplicates_0_1;
...
/**
 * Job: HUB_MASTER_WITH_DUPLICATES Purpose: Update Master HUB with possible duplicates<br>
 * Description: Update Master HUB wit possible duplicates of the business key. If the business key is duplicated, it is aggregated so the business key is unique in the HUB. <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HUB_MASTER_WITH_DUPLICATES implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "HUB_MASTER_WITH_DUPLICATES";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_jrcToAKbEem79L_UZPEC6Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				HUB_MASTER_WITH_DUPLICATES.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HUB_MASTER_WITH_DUPLICATES.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row12Struct implements routines.system.IPersistableRow<row12Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_HUB_MASTER_WITH_DUPLICATES = new byte[0];
    static byte[] commonByteArray_DEEPSEA_HUB_MASTER_WITH_DUPLICATES = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_HUB_MASTER_WITH_DUPLICATES.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_HUB_MASTER_WITH_DUPLICATES.length == 0) {
   					commonByteArray_DEEPSEA_HUB_MASTER_WITH_DUPLICATES = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_HUB_MASTER_WITH_DUPLICATES = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_HUB_MASTER_WITH_DUPLICATES, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_HUB_MASTER_WITH_DUPLICATES, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_HUB_MASTER_WITH_DUPLICATES) {
	...
	int nb_line_tMongoDBInput_4 = 0;
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_4=null;
				...
				db_tMongoDBInput_4 = (com.mongodb.client.MongoDatabase) globalMap.get("db_tMongoDBConnection_1");
					...
					com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBInput_4 = db_tMongoDBInput_4.getCollection("countries");
				...
				try{
					...
					org.bson.Document myQuery_tMongoDBInput_4 = org.bson.Document.parse("{'name': '" + context.getCOUNTRY() + "'}, {'_id':1}");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + "hub_" + context.getTABLE();
}
 ...
 */
	...
	currentComponent="tDBInput_1";
        ...
        new BytesLimit65535_tDBInput_1().limitLog4jByte();
        	...
        	row3.hash = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
...
} else {pstmt_tDBOutput_1.setString(1, row2.hash);
}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	...
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + (String) globalMap.get("HUB_TABLE");
}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"source\",\"business_key\",\"hash\") VALUES (?,?,?)";
 ...
 */
	...
	if ((row5.source == null) || ("".equals(row5.source))) {
		...
		row5.source != null
			...
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row5.source);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row5.businessKey == null) || ("".equals(row5.businessKey))) {
		ifPassedThrough = false;
		errorCodeThrough += 4;
		errorMessageThrough += "|empty or null";
	}	try {
		...
		row5.businessKey != null
			...
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row5.businessKey);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		errorMessageThrough += "|wrong type";
			...
			resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
			errorCodeThrough = 0;
			resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"businessKey:");
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row5.hash == null) || ("".equals(row5.hash))) {
		...
		row5.hash != null
			...
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row5.hash);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		errorMessageThrough += "|wrong type";
			...
			resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
			errorCodeThrough = 0;
			resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"hash:");
			errorMessageThrough = "";
		}
	}
...
if(row5 != null) { 
	...
	row10 = null;	exception1 = null;
	rsvUtil_tSchemaComplianceCheck_1.setRowValue_0(row5);
...
if(row10.source == null){
	...
	finder_tUniqRow_1.source = row10.source.toLowerCase();
}
if(row10.businessKey == null){
	finder_tUniqRow_1.businessKey = null;
}else{
	finder_tUniqRow_1.businessKey = row10.businessKey.toLowerCase();
}
if(row10.hash == null){
	finder_tUniqRow_1.hash = null;
}else{
	finder_tUniqRow_1.hash = row10.hash.toLowerCase();
}	
...
if(row10.source == null){
	...
	new_tUniqRow_1.source = row10.source.toLowerCase();
}
if(row10.businessKey == null){
	new_tUniqRow_1.businessKey = null;
}else{
	new_tUniqRow_1.businessKey = row10.businessKey.toLowerCase();
}
if(row10.hash == null){
	new_tUniqRow_1.hash = null;
}else{
	new_tUniqRow_1.hash = row10.hash.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row9 == null){ 
	
	row9 = new row9Struct();
}row9.source = row10.source;			row9.businessKey = row10.businessKey;			row9.hash = row10.hash;					
...
} else {pstmt_tDBOutput_2.setString(1, row13.source);
}

                    if(row13.businessKey == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, row13.businessKey);
}

                    if(row13.hash == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, row13.hash);
}
...
if(exception1 != null) { 
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
			...
			parentContextMap_tRunJob_1.put("BUSINESS_KEY", context.BUSINESS_KEY);
			paraList_tRunJob_1.add("--context_type " + "BUSINESS_KEY" + "=" + "id_String");
 ...
 */
	...
	System.err.println("Schema invalid:" + exception1.errorMessage + ", abort ...");
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Schema invalid:" + exception1.errorMessage + ", abort ...");
	globalMap.put("tDie_1_DIE_MESSAGES", "Schema invalid:" + exception1.errorMessage + ", abort ...");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
        ...
        new BytesLimit65535_tAdvancedHash_row4().limitLog4jByte();
			   		...
			   		// source node:tMongoDBInput_2 - inputs:(after_tDBInput_1) outputs:(row4,row4) | target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
	...
	int nb_line_tMongoDBInput_2 = 0;
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_2=null;
				...
				db_tMongoDBInput_2 = (com.mongodb.client.MongoDatabase) globalMap.get("db_tMongoDBConnection_1");
					...
					com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBInput_2 = db_tMongoDBInput_2.getCollection("master.files");
				...
				try{
					...
					org.bson.Document myQuery_tMongoDBInput_2 = org.bson.Document.parse("{'country.$id': ObjectId('" + globalMap.get("COUNTRY_ID").toString() + "'), 'metadata.type' : '" + context.getTYPE() + "'}, {_id: 1}");
 ...
 */
    ...
    public static void main(String[] args){
        final HUB_MASTER_WITH_DUPLICATES HUB_MASTER_WITH_DUPLICATESClass = new HUB_MASTER_WITH_DUPLICATES();

        int exitCode = HUB_MASTER_WITH_DUPLICATESClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HUB_MASTER_WITH_DUPLICATES.class.getClassLoader().getResourceAsStream("deepsea/hub_master_with_duplicates_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HUB_MASTER_WITH_DUPLICATES.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HUB_MASTER_WITH_DUPLICATES");
        }
...
/************************************************************************************************
 *     275609 characters generated by Talend Open Studio for Big Data 
 *     on the September 1, 2019 7:26:17 PM CST
 ************************************************************************************************/