 ...
 */
    ...
    row3.jobTitleEn = utility_tExtractFields_1.UnPivot(doc_tExtractFields_1, "tag", "value", "jobTitleEn");
    row3.jobTitleLo = utility_tExtractFields_1.UnPivot(doc_tExtractFields_1, "tag", "value", "jobTitleLo");
...
if(row3 != null) { 
  ...
  boolean bHasError_tConvertType_1 = false;             
          ...
          try {
              ...
              row2.arrivalDate=TypeConvert.String2Date(row3.arrivalDate, context.DEFAULT_DATE_FORMAT);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              ...
              row2.departureDate=TypeConvert.String2Date(row3.departureDate, context.DEFAULT_DATE_FORMAT);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              if ("".equals(row3.jobTitleEn)){  
                row3.jobTitleEn = null;
              }
              row2.jobTitleEn=TypeConvert.String2String(row3.jobTitleEn);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              if ("".equals(row3.jobTitleLo)){  
                row3.jobTitleLo = null;
              }
              row2.jobTitleLo=TypeConvert.String2String(row3.jobTitleLo);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }
...
row8_tmp.jobTitleEn = row2.jobTitleEn ;
row8_tmp.jobTitleLo = row2.jobTitleLo ;
row8 = row8_tmp;
...
/************************************************************************************************
 *     217076 characters generated by Talend Open Studio for Big Data 
