...
package deepsea.sat_market_0_1;
...
/**
 * Job: SAT_MARKET Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAT_MARKET implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "SAT_MARKET";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_TNFg8L-WEeip__KOlv70Sw", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAT_MARKET.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row9Struct implements routines.system.IPersistableRow<row9Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_SAT_MARKET = new byte[0];
    static byte[] commonByteArray_DEEPSEA_SAT_MARKET = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_SAT_MARKET.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_SAT_MARKET.length == 0) {
   					commonByteArray_DEEPSEA_SAT_MARKET = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_SAT_MARKET = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_SAT_MARKET, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_SAT_MARKET, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAT_MARKET) {
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"hub_id\",\"source\",\"market\",\"therapeutic_class\",\"market_coef\") VALUES (?,?,?,?,?)";
...
if(row3 != null) { 
  ...
  boolean bHasError_tConvertType_1 = false;             
          try {
              if ("".equals(row3.market)){  
                row3.market = null;
              }
              row2.market=TypeConvert.String2String(row3.market);            
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		...
                        		    		row5HashKey.businessKey = row2.therapeuticClass ;
...
} else {pstmt_tDBOutput_1.setString(3, row9.market);
}
...
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
                    ...
                    pstmt_tDBOutput_1.setFloat(5, row9.marketCoef);
 ...
 */
    ...
    public static void main(String[] args){
        final SAT_MARKET SAT_MARKETClass = new SAT_MARKET();

        int exitCode = SAT_MARKETClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAT_MARKET.class.getClassLoader().getResourceAsStream("deepsea/sat_market_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAT_MARKET.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAT_MARKET");
        }
...
/************************************************************************************************
 *     198094 characters generated by Talend Open Studio for Big Data 
