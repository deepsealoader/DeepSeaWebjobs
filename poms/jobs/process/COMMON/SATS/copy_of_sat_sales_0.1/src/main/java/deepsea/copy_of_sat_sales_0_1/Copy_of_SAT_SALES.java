...
package deepsea.copy_of_sat_sales_0_1;
...
/**
 * Job: Copy_of_SAT_SALES Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class Copy_of_SAT_SALES implements TalendJob {
	...
	private final String jobName = "Copy_of_SAT_SALES";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_SAT_SALES.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_SAT_SALES.this, new Object[] { e,
	...
	public static class row6Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_Copy_of_SAT_SALES = new byte[0];
		static byte[] commonByteArray_DEEPSEA_Copy_of_SAT_SALES = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_Copy_of_SAT_SALES.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_Copy_of_SAT_SALES.length == 0) {
						commonByteArray_DEEPSEA_Copy_of_SAT_SALES = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_Copy_of_SAT_SALES = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_Copy_of_SAT_SALES, 0,
						length);
				strReturn = new String(
						commonByteArray_DEEPSEA_Copy_of_SAT_SALES, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_Copy_of_SAT_SALES) {
	...
	public static class exception1Struct implements
			routines.system.IPersistableRow<exception1Struct> {
		final static byte[] commonByteArrayLock_DEEPSEA_Copy_of_SAT_SALES = new byte[0];
		static byte[] commonByteArray_DEEPSEA_Copy_of_SAT_SALES = new byte[0];
	...
	public static class after_tMongoDBInput_5Struct implements
			routines.system.IPersistableRow<after_tMongoDBInput_5Struct> {
		final static byte[] commonByteArrayLock_DEEPSEA_Copy_of_SAT_SALES = new byte[0];
		static byte[] commonByteArray_DEEPSEA_Copy_of_SAT_SALES = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(after_tMongoDBInput_5Struct other) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					for (com.mongodb.DBObject index : coll_tMongoDBInput_5
						...
						for (String key : ((com.mongodb.DBObject) index
							...
							if (("{'country.$id': ObjectId('"
									...
									+ globalMap.get("COLLECTION_ID").toString() + "')}, , {'_id':1, 'hash':1}")
									.matches(".*" + key + "[^,]*:.*")) {
				...
				while (cursor_tMongoDBInput_5.hasNext()) {
					...
					valueObj_tMongoDBInput_5 = dbObjectInputUtil_tMongoDBInput_5
							.getValue(pathMap_tMongoDBInput_5.get("hash"),
									"hash", o_tMongoDBInput_5);
					if (valueObj_tMongoDBInput_5 != null
							&& valueObj_tMongoDBInput_5.toString().length() > 0) {
					...
					if (tHash_Lookup_row15 != null
						...
						// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row15' and it contains more one result from keys :  row15.hash = '"
						// + row15HashKey.hash + "'");
					} // G 071
					...
					if (row17 != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection("OnComponentOk3", 3,
									0);
						}
						...
						if (execStat) {
							runStat.updateStatOnConnection("iterate1", 1,
									"exec" + NB_ITERATE_tMongoDBInput_1);
							// Thread.sleep(1000);
						}
						...
						if (dbschema_tDBOutput_1 == null
							...
							tableName_tDBOutput_1 = (String) globalMap
									.get("SAT_TABLE");
						} else {
							tableName_tDBOutput_1 = dbschema_tDBOutput_1
									+ "\".\""
									+ (String) globalMap.get("SAT_TABLE");
						}
						...
						String insert_tDBOutput_1 = "INSERT INTO \""
								...
								+ "\" (\"hub_id\",\"source\",\"geography_code\",\"locality\",\"admin_area1\",\"customer_code\",\"customer_name\",\"customer_type\",\"product_code\",\"product_name\",\"amount\",\"quantity\",\"sales_date\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
						...
						if (execStat) {
							if (resourceMap.get("inIterateVComp") == null) {
								...
								runStat.updateStatOnConnection("exception1"
										+ iterateId, 0, 0);
						...
						new BytesLimit65535_tSchemaComplianceCheck_1()
								.limitLog4jByte();
						...
						class RowSetValueUtil_tSchemaComplianceCheck_1 {
							...
							void handleBigdecimalPrecision(String data,
									int iPrecision, int maxLength) {
								// number of digits before the decimal
								// point(ignoring frontend zeroes)
								int len1 = 0;
								int len2 = 0;
								ifPassed = true;
								errorCode = 0;
							...
							void setRowValue_0(row10Struct row9) {
								resultErrorCodeThrough = handleErrorCode(
										errorCodeThrough,
										resultErrorCodeThrough);
								errorCodeThrough = 0;
								resultErrorMessageThrough = handleErrorMessage(
										errorMessageThrough,
										resultErrorMessageThrough, "hubId:");
								errorMessageThrough = "";
								...
								resultErrorMessageThrough = handleErrorMessage(
										errorMessageThrough,
										resultErrorMessageThrough, "source:");
								errorMessageThrough = "";
								try {
									if (row9.geographyCode != null
											&& (!"".equals(row9.geographyCode))) {
										String tester_tSchemaComplianceCheck_1 = String
												.valueOf(row9.geographyCode);
									}
								} catch (java.lang.Exception e) {
									ifPassedThrough = false;
									errorCodeThrough += 2;
								...
								errorMessageThrough = "";
								try {
									if (row9.locality != null
											&& (!"".equals(row9.locality))) {
										String tester_tSchemaComplianceCheck_1 = String
												.valueOf(row9.locality);
									}
								} catch (java.lang.Exception e) {
									ifPassedThrough = false;
									errorCodeThrough += 2;
								...
								resultErrorMessageThrough = handleErrorMessage(
										errorMessageThrough,
										resultErrorMessageThrough, "locality:");
								errorMessageThrough = "";
								try {
									if (row9.adminArea1 != null
											&& (!"".equals(row9.adminArea1))) {
										String tester_tSchemaComplianceCheck_1 = String
												.valueOf(row9.adminArea1);
									}
								} catch (java.lang.Exception e) {
									ifPassedThrough = false;
									errorCodeThrough += 2;
								...
								resultErrorMessageThrough = handleErrorMessage(
										errorMessageThrough,
										resultErrorMessageThrough, "amount:");
								errorMessageThrough = "";
								resultErrorCodeThrough = handleErrorCode(
										errorCodeThrough,
										resultErrorCodeThrough);
								...
								resultErrorMessageThrough = handleErrorMessage(
										errorMessageThrough,
										resultErrorMessageThrough, "quantity:");
								errorMessageThrough = "";
								// validate nullable (empty as null)
								if ((row9.date == null)
										|| ("".equals(row9.date))) {
								...
								resultErrorMessageThrough = handleErrorMessage(
										errorMessageThrough,
										resultErrorMessageThrough, "date:");
								errorMessageThrough = "";
							}
						}
						...
						start_Hash.put("tExtractFields_1",
								System.currentTimeMillis());
						...
						start_Hash.put("tMongoDBInput_1",
								System.currentTimeMillis());
						...
						try {
							...
							for (com.mongodb.DBObject index : coll_tMongoDBInput_1
								...
								for (String key : ((com.mongodb.DBObject) index
									...
									// backslashed quotes
									// - is followed at some point by a colon
									// - there is no comma between the the
									// DBcolumnName and the colon
									if (("{'file.$id': ObjectId('"
											+ globalMap.get("row4.id")
													.toString() + "')}, {'_id':1, 'num':1, 'fields':1}")
											.matches(".*" + key + "[^,]*:.*")) {
										// We have an index, do not print error
										// message
										needIndexWarning = false;
									} else {
										// This index is not in the query, add
										// it into the indexList
										indexList += ", " + key;
									}
								}
							}
							...
							// caught an exception after issuing the
							// getIndexInfo()
							// don't fail the whole job
							// maybe due to authorization
						}
						...
						org.bson.Document myQuery_tMongoDBInput_1 = org.bson.Document
								.parse("{'file.$id': ObjectId('"
										+ globalMap.get("row4.id").toString()
										+ "')}, {'_id':1, 'num':1, 'fields':1}");
						com.mongodb.client.FindIterable<org.bson.Document> fi_tMongoDBInput_1 = coll_tMongoDBInput_1
								.find(myQuery_tMongoDBInput_1).noCursorTimeout(
										false);
						...
						while (cursor_tMongoDBInput_1.hasNext()) {
							...
							valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1
									.getValue(
											pathMap_tMongoDBInput_1.get("id"),
							...
							valueObj_tMongoDBInput_1 = dbObjectInputUtil_tMongoDBInput_1
									.getValue(
											pathMap_tMongoDBInput_1.get("num"),
							...
							row3.num = row7.num;
							row3.geographyCode = utility_tExtractFields_1
									.UnPivot(doc_tExtractFields_1, "tag",
											"value", "geographyCode");
							row3.locality = utility_tExtractFields_1.UnPivot(
									doc_tExtractFields_1, "tag", "value",
									"locality");
							row3.adminArea1 = utility_tExtractFields_1.UnPivot(
									doc_tExtractFields_1, "tag", "value",
									"adminArea1");
							row3.customerCode = utility_tExtractFields_1
									.UnPivot(doc_tExtractFields_1, "tag",
											"value", "customerCode");
							row3.customerName = utility_tExtractFields_1
									.UnPivot(doc_tExtractFields_1, "tag",
											"value", "customerName");
							row3.customerType = utility_tExtractFields_1
									.UnPivot(doc_tExtractFields_1, "tag",
											"value", "customerType");
							row3.productCode = utility_tExtractFields_1
									.UnPivot(doc_tExtractFields_1, "tag",
											"value", "productCode");
							row3.productName = utility_tExtractFields_1
									.UnPivot(doc_tExtractFields_1, "tag",
											"value", "productName");
							row3.amount = utility_tExtractFields_1.UnPivot(
									doc_tExtractFields_1, "tag", "value",
									"amount");
							row3.quantity = utility_tExtractFields_1.UnPivot(
									doc_tExtractFields_1, "tag", "value",
									"quantity");
							row3.date = utility_tExtractFields_1.UnPivot(
									doc_tExtractFields_1, "tag", "value",
									"date");
							...
							if (row3 != null) {
								...
								try {
									...
									row2.geographyCode = TypeConvert
											.String2String(row3.geographyCode);
								} catch (java.lang.Exception e) {
									bHasError_tConvertType_1 = true;
									System.err.println(e.getMessage());
								}
								try {
									if ("".equals(row3.locality)) {
										row3.locality = null;
									}
									row2.locality = TypeConvert
											.String2String(row3.locality);
								} catch (java.lang.Exception e) {
									bHasError_tConvertType_1 = true;
									System.err.println(e.getMessage());
								}
								try {
									if ("".equals(row3.adminArea1)) {
										row3.adminArea1 = null;
									}
									row2.adminArea1 = TypeConvert
											.String2String(row3.adminArea1);
								} catch (java.lang.Exception e) {
									bHasError_tConvertType_1 = true;
									System.err.println(e.getMessage());
								}
								try {
									if ("".equals(row3.customerCode)) {
										row3.customerCode = null;
									}
									row2.customerCode = TypeConvert
											.String2String(row3.customerCode);
								} catch (java.lang.Exception e) {
									bHasError_tConvertType_1 = true;
									System.err.println(e.getMessage());
								}
								try {
									if ("".equals(row3.customerName)) {
										row3.customerName = null;
									}
									row2.customerName = TypeConvert
											.String2String(row3.customerName);
								} catch (java.lang.Exception e) {
									bHasError_tConvertType_1 = true;
									System.err.println(e.getMessage());
								}
								try {
									if ("".equals(row3.customerType)) {
										row3.customerType = null;
									}
									row2.customerType = TypeConvert
											.String2String(row3.customerType);
								} catch (java.lang.Exception e) {
									bHasError_tConvertType_1 = true;
									System.err.println(e.getMessage());
								}
								try {
									if ("".equals(row3.productCode)) {
										row3.productCode = null;
									}
									row2.productCode = TypeConvert
											.String2String(row3.productCode);
								} catch (java.lang.Exception e) {
									bHasError_tConvertType_1 = true;
									System.err.println(e.getMessage());
								}
								try {
									if ("".equals(row3.productName)) {
										row3.productName = null;
									}
									row2.productName = TypeConvert
											.String2String(row3.productName);
								} catch (java.lang.Exception e) {
									bHasError_tConvertType_1 = true;
									System.err.println(e.getMessage());
								}
								try {
									...
									row2.amount = TypeConvert
											.String2Float(row3.amount);
								} catch (java.lang.Exception e) {
									bHasError_tConvertType_1 = true;
									System.err.println(e.getMessage());
								}
								try {
									...
									row2.quantity = TypeConvert
											.String2float(row3.quantity);
								} catch (java.lang.Exception e) {
									bHasError_tConvertType_1 = true;
									System.err.println(e.getMessage());
								}
								try {
									...
									row2.date = TypeConvert.String2Date(
											row3.date, "dd/MM/yy");
								} catch (java.lang.Exception e) {
									bHasError_tConvertType_1 = true;
									System.err.println(e.getMessage());
								...
								if (row2 != null) {
									...
									if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
										...
										row5HashKey.businessKey = String
												.valueOf(row2.num);

										row5HashKey.hash = globalMap.get(
												"row4.hash").toString();
									...
									if (tHash_Lookup_row5 != null
										...
										// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.businessKey = '"
										// + row5HashKey.businessKey +
										// "', row5.hash = '" + row5HashKey.hash
										// + "'");
									} // G 071
									...
									{ // start of Var scope
										...
										if (!rejectedInnerJoin_tMap_2) {
											...
											row8_tmp.customerName = row2.customerName;
									...
									if (row8 != null) {
										...
										row10.adminArea1 = row8.adminArea1;

										row10.customerCode = row8.customerCode;

										row10.customerName = row8.customerName;

										row10.customerType = row8.customerType;

										row10.productCode = row8.productCode;

										row10.productName = row8.productName;

										row10.amount = row8.amount;

										row10.quantity = row8.quantity;
										...
										/**
										 * [tFlowMeter_13 process_data_begin ]
										 * start
										 */
										...
										if (rsvUtil_tSchemaComplianceCheck_1.ifPassedThrough) {
											...
											row14.customerName = row9.customerName;
											row14.customerType = row9.customerType;
											row14.productCode = row9.productCode;
											row14.productName = row9.productName;
										...
										if (!rsvUtil_tSchemaComplianceCheck_1.ifPassedThrough) {
											...
											exception1.customerName = row9.customerName;
											exception1.customerType = row9.customerType;
											exception1.productCode = row9.productCode;
											exception1.productName = row9.productName;
											exception1.amount = row9.amount;
											exception1.quantity = row9.quantity;
											exception1.date = row9.date;
											exception1.errorCode = String
										...
										if (row14 != null) {
											...
											if (row14.amount == null) {
												...
												pstmt_tDBOutput_1.setFloat(11,
														row14.amount);
											}

											pstmt_tDBOutput_1.setFloat(12,
													row14.quantity);
										...
										if (exception1 != null) {
											...
											obj_tRunJob_1 = globalMap
													.get("COUNTRY_ID");
											if (obj_tRunJob_1 != null) {
												paraList_tRunJob_1
														.add("--context_param COUNTRY_ID="
																+ RuntimeUtils
											...
											parentContextMap_tRunJob_1.put(
													"WEBJOB_ID", obj_tRunJob_1);

											obj_tRunJob_1 = row1.id;
											if (obj_tRunJob_1 != null) {
												paraList_tRunJob_1
														.add("--context_param RECORD_ID="
																+ RuntimeUtils
																		.tRunJobConvertContext(obj_tRunJob_1));
											} else {
												paraList_tRunJob_1
											...
											parentContextMap_tRunJob_1.put(
													"RECORD_ID", obj_tRunJob_1);

											obj_tRunJob_1 = exception1.errorMessage
													.split(":")[0];
											if (obj_tRunJob_1 != null) {
												paraList_tRunJob_1
														.add("--context_param FIELD_NAME="
																+ RuntimeUtils
																		.tRunJobConvertContext(obj_tRunJob_1));
											} else {
												paraList_tRunJob_1
											...
											obj_tRunJob_1 = "Schema invalid:"
													+ exception1.errorMessage;
											if (obj_tRunJob_1 != null) {
												paraList_tRunJob_1
														.add("--context_param REASON="
																+ RuntimeUtils
																		.tRunJobConvertContext(obj_tRunJob_1));
											} else {
												paraList_tRunJob_1
										...
										/**
										 * [tFlowMeter_13 process_data_end ]
										 * start
										 */
						...
						tFlowMeterCatcher_1.addMessage(
								"Number of records read", new Integer(
										count_tFlowMeter_11), "null", "",
								"tFlowMeter_11");
						...
						globalMap.put("tConvertType_1_NB_LINE",
								nb_line_tConvertType_1);
						if (execStat) {
							if (resourceMap.get("inIterateVComp") == null
									|| !((Boolean) resourceMap
						...
						tFlowMeterCatcher_1.addMessage(
								"Number of records integrated", new Integer(
										count_tFlowMeter_13), "null", "",
								"tFlowMeter_13");
				...
				tFlowMeterCatcher_1.addMessage("Number of files integrated",
						new Integer(count_tFlowMeter_19), "null", "",
						"tFlowMeter_19");
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_1 - inputs:(after_tMongoDBInput_5)
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row5.businessKey = routines.system.JDBCUtil
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row5.hash = routines.system.JDBCUtil.getString(
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_3 - inputs:(after_tMongoDBInput_5)
				// outputs:(row15,row15) | target node:tAdvancedHash_row15 -
				// inputs:(row15) outputs:()
				// linked node: tMap_3 - inputs:(row13,row15) outputs:(row17)
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							row15.hash = routines.system.JDBCUtil.getString(
				...
				try {
					...
					for (com.mongodb.DBObject index : coll_tMongoDBInput_3
						...
						for (String key : ((com.mongodb.DBObject) index
							...
							if (("{'country.$id': ObjectId('"
									+ globalMap.get("COUNTRY_ID").toString()
									+ "'),'name': '" + context.getCOLLECTION() + "'}, {'_id':1}")
									.matches(".*" + key + "[^,]*:.*")) {
								// We have an index, do not print error message
								needIndexWarning = false;
							} else {
				...
				try {
					...
					for (com.mongodb.DBObject index : coll_tMongoDBInput_4
						...
						for (String key : ((com.mongodb.DBObject) index
							...
							if (("{'country.$id': ObjectId('"
									+ globalMap.get("COUNTRY_ID").toString()
									+ "'),'name': '" + context.getWEBJOB_NAME() + "'}, {'_id':1}")
									.matches(".*" + key + "[^,]*:.*")) {
								// We have an index, do not print error message
								needIndexWarning = false;
							} else {
	...
	public static void main(String[] args) {
		final Copy_of_SAT_SALES Copy_of_SAT_SALESClass = new Copy_of_SAT_SALES();

		int exitCode = Copy_of_SAT_SALESClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_SAT_SALES.class
					.getClassLoader().getResourceAsStream(
							"deepsea/copy_of_sat_sales_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_SAT_SALES.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Copy_of_SAT_SALES");
		}
...
/************************************************************************************************
 * 310068 characters generated by Talend Open Studio for Big Data on the January
 * 12, 2019 10:29:30 PM CST
 ************************************************************************************************/
