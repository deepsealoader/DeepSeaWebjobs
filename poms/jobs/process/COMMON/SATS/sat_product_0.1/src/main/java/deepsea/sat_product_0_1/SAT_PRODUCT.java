...
public static class row9Struct implements routines.system.IPersistableRow<row9Struct> {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAT_PRODUCT) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.packageUnit = dis.readFloat();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// float
		            	...
		            	dos.writeFloat(this.packageUnit);
    ...
    public String toString() {
		...
		sb.append(",packageUnit="+String.valueOf(packageUnit));
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAT_PRODUCT) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.packageUnit = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.packageUnit,dos);
    ...
    public String toString() {
		...
		sb.append(",nameLevel4="+nameLevel4);
		sb.append(",nameLevel5="+nameLevel5);
		sb.append(",packageUnit="+packageUnit);
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"hub_id\",\"source\",\"codelevel1\",\"codelevel2\",\"codelevel3\",\"codelevel4\",\"codelevel5\",\"namelevel1\",\"namelevel2\",\"namelevel3\",\"namelevel4\",\"namelevel5\",\"package_unit\",\"std_box_coef\",\"market_coef\",\"manufacturer_name\",\"therapeutic_class\",\"disease\",\"molecule\",\"attribute1\",\"attribute2\",\"attribute3\",\"attribute4\",\"attribute5\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
    ...
    row3.packageUnit = utility_tExtractFields_1.UnPivot(doc_tExtractFields_1, "tag", "value", "packageUnit");
...
if(row3 != null) { 
  ...
  boolean bHasError_tConvertType_1 = false;             
          ...
          try {
              if ("".equals(row3.packageUnit)){  
                row3.packageUnit = null;
              }
              row2.packageUnit=TypeConvert.String2float(row3.packageUnit);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		...
                        		    		row5HashKey.businessKey = context.BUSINESS_KEY.equals("codeLevel1") ? row2.codeLevel1 : (context.BUSINESS_KEY.equals("codeLevel2") ? row2.codeLevel2 : (context.BUSINESS_KEY.equals("codeLevel3") ? row2.codeLevel3 : (context.BUSINESS_KEY.equals("codeLevel4") ? row2.codeLevel4 : row2.codeLevel5))) ;
...
row8_tmp.packageUnit = row2.packageUnit ;
...
if(row8 != null) { 
	...
	row10.packageUnit = row8.packageUnit;
...
/************************************************************************************************
 *     238781 characters generated by Talend Open Studio for Big Data 
 *     on the September 1, 2019 7:29:24 PM CST
 ************************************************************************************************/