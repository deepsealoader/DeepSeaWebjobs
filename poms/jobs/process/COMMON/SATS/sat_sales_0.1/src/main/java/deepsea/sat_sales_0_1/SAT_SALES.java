...
/**
 * Job: SAT_SALES Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAT_SALES implements TalendJob {
...
public String getWEBJOB_NAME(){
	...
	private final String jobName = "SAT_SALES";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_Vw0JMM_BEeib9oVpaXTd6w", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAT_SALES.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row11Struct implements routines.system.IPersistableRow<row11Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_SAT_SALES = new byte[0];
    static byte[] commonByteArray_DEEPSEA_SAT_SALES = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_SAT_SALES.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_SAT_SALES.length == 0) {
   					commonByteArray_DEEPSEA_SAT_SALES = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_SAT_SALES = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_SAT_SALES, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_SAT_SALES, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAT_SALES) {
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
								  ...
								  if(!tHash_Lookup_row15.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row15 != null && tHash_Lookup_row15.getCount(row15HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row15' and it contains more one result from keys :  row15.hash = '" + row15HashKey.hash + "'");
								} // G 071
 ...
 */
	...
	if ((row9.source == null) || ("".equals(row9.source))) {
		...
		&& (!"".equals(row9.locality))
			...
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row9.locality);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";	try {
		if(
		row9.adminArea1 != null
		&& (!"".equals(row9.adminArea1))
		) {
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row9.adminArea1);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row9.customerCode == null) || ("".equals(row9.customerCode))) {
		ifPassedThrough = false;
		errorCodeThrough += 4;
		errorMessageThrough += "|empty or null";
	}	try {
		...
		&& (!"".equals(row9.customerName))
			...
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row9.customerName);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";	try {
		if(
		row9.customerType != null
		&& (!"".equals(row9.customerType))
		) {
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row9.customerType);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
	...
	if ((row9.productCode == null) || ("".equals(row9.productCode))) {
		...
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";	try {
		if(
		row9.productName != null
		&& (!"".equals(row9.productName))
		) {
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row9.productName);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_1=null;
				...
				try{
	            	...
	            	// maybe due to authorization
							...
							aggregationStages.add(org.bson.Document.parse("{ $match : {'file.country.$id': ObjectId('" + globalMap.get("COUNTRY_ID").toString() + "'), 'file.collection.$id' : ObjectId('" + globalMap.get("COLLECTION_ID").toString() + "'), 'file.hash': '" + globalMap.get("row4.hash").toString() + "'} }"));
...
// # Output table : 'row18'
row18_tmp.hash = row1.hash ;
row18_tmp.num = row1.num ;
row18_tmp.fields = row1.fields;
row18 = row18_tmp;
// ###############################
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		...
                        		    		row5HashKey.businessKey = String.valueOf(row2.num) ;
								  ...
								  if(!tHash_Lookup_row5.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.businessKey = '" + row5HashKey.businessKey + "', row5.hash = '" + row5HashKey.hash + "'");
								} // G 071
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("row18", new Integer(count_tFlowMeter_11), "null", "", "tFlowMeter_11");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
        ...
        new BytesLimit65535_tAdvancedHash_row5().limitLog4jByte();
			   		...
			   		// source node:tDBInput_1 - inputs:(after_tMongoDBInput_5) outputs:(row5,row5) | target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
 ...
 */
	...
	currentComponent="tDBInput_1";
        ...
        new BytesLimit65535_tDBInput_1().limitLog4jByte();
        	...
        	row5.hash = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row15";
        ...
        new BytesLimit65535_tAdvancedHash_row15().limitLog4jByte();
			   		...
			   		// source node:tDBInput_3 - inputs:(after_tMongoDBInput_5) outputs:(row15,row15) | target node:tAdvancedHash_row15 - inputs:(row15) outputs:()
 ...
 */
	...
	currentComponent="tDBInput_3";
        ...
        new BytesLimit65535_tDBInput_3().limitLog4jByte();
        	...
        	row15.hash = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final SAT_SALES SAT_SALESClass = new SAT_SALES();

        int exitCode = SAT_SALESClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAT_SALES.class.getClassLoader().getResourceAsStream("deepsea/sat_sales_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAT_SALES.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAT_SALES");
        }
...
/************************************************************************************************
 *     326342 characters generated by Talend Open Studio for Big Data 
 *     on the 3 December, 2018 11:37:26 PM AEDT
 ************************************************************************************************/