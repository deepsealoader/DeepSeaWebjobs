...
package deepsea.sat_product_provider_0_1;
...
/**
 * Job: SAT_PRODUCT_PROVIDER Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAT_PRODUCT_PROVIDER implements TalendJob {
...
public String getTABLE1(){
	...
	private final String jobName = "SAT_PRODUCT_PROVIDER";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_80pyUKkkEemYLOBYZkLOYA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SAT_PRODUCT_PROVIDER.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAT_PRODUCT_PROVIDER.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row9Struct implements routines.system.IPersistableRow<row9Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_SAT_PRODUCT_PROVIDER = new byte[0];
    static byte[] commonByteArray_DEEPSEA_SAT_PRODUCT_PROVIDER = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_SAT_PRODUCT_PROVIDER.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_SAT_PRODUCT_PROVIDER.length == 0) {
   					commonByteArray_DEEPSEA_SAT_PRODUCT_PROVIDER = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_SAT_PRODUCT_PROVIDER = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_SAT_PRODUCT_PROVIDER, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_SAT_PRODUCT_PROVIDER, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAT_PRODUCT_PROVIDER) {
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"hub_id\",\"source\",\"servier_code\",\"provider_code\",\"group\",\"name\",\"manufacturer_name\",\"therapeutic_class\",\"disease\",\"molecule\",\"attribute1\",\"attribute2\",\"attribute3\",\"attribute4\",\"attribute5\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
if(row3 != null) { 
  ...
  boolean bHasError_tConvertType_1 = false;             
          ...
          try {
              if ("".equals(row3.group)){  
                row3.group = null;
              }
              row2.group=TypeConvert.String2String(row3.group);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              ...
              row2.name=TypeConvert.String2String(row3.name);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
...
row8_tmp.servierCode = row2.servierCode ;
...
if(row8 != null) { 
	...
	row10.servierCode = row8.servierCode;

	
	row10.providerCode = row8.providerCode;

	
	row10.group = row8.group;
...
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
                    ...
                    if(row9.servierCode == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row9.servierCode);
}

                    if(row9.providerCode == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, row9.providerCode);
}

                    if(row9.group == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row9.group);
}
...
} else {pstmt_tDBOutput_1.setString(9, row9.disease);
}

                    if(row9.molecule == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, row9.molecule);
}

                    if(row9.attribute1 == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, row9.attribute1);
}

                    if(row9.attribute2 == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, row9.attribute2);
}

                    if(row9.attribute3 == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(13, row9.attribute3);
}

                    if(row9.attribute4 == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(14, row9.attribute4);
}

                    if(row9.attribute5 == null) {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(15, row9.attribute5);
}
...
globalMap.put("HUB_TABLE", "hub_" + context.getTABLE1());
globalMap.put("SAT_TABLE", "sat_" + context.getTABLE2());
 ...
 */
    ...
    public static void main(String[] args){
        final SAT_PRODUCT_PROVIDER SAT_PRODUCT_PROVIDERClass = new SAT_PRODUCT_PROVIDER();

        int exitCode = SAT_PRODUCT_PROVIDERClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAT_PRODUCT_PROVIDER.class.getClassLoader().getResourceAsStream("deepsea/sat_product_provider_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAT_PRODUCT_PROVIDER.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAT_PRODUCT_PROVIDER");
        }
...
/************************************************************************************************
 *     231653 characters generated by Talend Open Studio for Big Data 
 *     on the July 18, 2019 6:15:53 PM SGT
 ************************************************************************************************/