...
package deepsea.link_master_with_multiple_without_hub_0_1;
...
/**
 * Job: LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB Purpose: Update Master LINK with possible multiple values and without hub<br>
 * Description: Update Master LINK with possible multiple values and without hub. Multiple values of the business key are normalized. They should be ";" separeted within the column. <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(BUSINESS_KEY2 != null){
				
					this.setProperty("BUSINESS_KEY2", BUSINESS_KEY2.toString());
...
public String BUSINESS_KEY2;
public String getBUSINESS_KEY2(){
	return this.BUSINESS_KEY2;
}
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_lQYGUE7oEemDV8k2NEwUcw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row14Struct implements routines.system.IPersistableRow<row14Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB = new byte[0];
    static byte[] commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB.length == 0) {
   					commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = (String) globalMap.get("LINK_TABLES");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + (String) globalMap.get("LINK_TABLES");
}
...
int count_tDBOutput_1=0;
	    String delete_tDBOutput_1 = "DELETE FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"hash\" = ?";
	...
	currentComponent="tFlowMeter_22";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("ou1" + iterateId, 0, 0);
 ...
 */
	...
	currentComponent="tDBInput_4";
        ...
        new BytesLimit65535_tDBInput_4().limitLog4jByte();
        	...
        	row13.hash = routines.system.JDBCUtil.getString(rs_tDBInput_4, 1, false);
		                    }
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
								  ...
								  if(!tHash_Lookup_row16.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row16 != null && tHash_Lookup_row16.getCount(row16HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row16' and it contains more one result from keys :  row16.hash = '" + row16HashKey.hash + "'");
								} // G 071
...
// # Output reject table : 'ou1'
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
ou1_tmp.hash = row13.hash;
ou1 = ou1_tmp;
...
if(ou1 != null) { 
	...
	currentComponent="tFlowMeter_22";
			...
			//ou1
				...
				if(execStat){
					runStat.updateStatOnConnection("ou1"+iterateId,1, 1);
				} 
...
} else {pstmt_tDBOutput_1.setString(1, row17.hash);
}
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("Number of files deleted", new Integer(count_tFlowMeter_22), "null", "", "tFlowMeter_22");

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("ou1"+iterateId,2, 0); 
			 	}
			}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"source\",\"hub_id1\",\"hub_id2\",\"hash\") VALUES (?,?,?,?)";
	...
	currentComponent="tNormalize_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("copyOfrow4" + iterateId, 0, 0);
...
copyOfrow4_tmp.id = row9.id ;
copyOfrow4_tmp.source = row9.source ;
copyOfrow4_tmp.hash = row9.hash ;
copyOfrow4_tmp.businessKey1 = TalendString.talendTrim(row9.businessKey1,';',0) ;
copyOfrow4_tmp.businessKey2 = row9.businessKey2 ;
...
if(copyOfrow4 != null) { 
	...
	currentComponent="tNormalize_1";
			...
			//copyOfrow4
				...
				if(execStat){
					runStat.updateStatOnConnection("copyOfrow4"+iterateId,1, 1);
				} 
            ...
            if(copyOfrow4.businessKey1 != null) {
				if("".equals(copyOfrow4.businessKey1)){
		        	normalizeRecord_tNormalize_1[0] = "";
		        }else{
	                
	                		normalizeRecord_tNormalize_1 = copyOfrow4.businessKey1.split(";",-1);
            	...
            	for(int i_tNormalize_1 = 0 ; i_tNormalize_1 < lastNoEmptyIndex_tNormalize_1 ; i_tNormalize_1++) {
	                ...
	                nb_line_tNormalize_1++;               
	                                	...
	                                	tmp_tNormalize_1 = copyOfrow4.id == null ? null : String.valueOf(copyOfrow4.id);
	                                
		                            if(tmp_tNormalize_1 != null){
		                                currentRecord_tNormalize_1.append(tmp_tNormalize_1 + tmp_tNormalize_1.length());
		                            }
	                            
	                                	tmp_tNormalize_1 = copyOfrow4.source == null ? null : String.valueOf(copyOfrow4.source);
	                                
		                            if(tmp_tNormalize_1 != null){
		                                currentRecord_tNormalize_1.append(tmp_tNormalize_1 + tmp_tNormalize_1.length());
		                            }
	                            
	                                	tmp_tNormalize_1 = copyOfrow4.hash == null ? null : String.valueOf(copyOfrow4.hash);
		                            ...
		                            if(normalizeRecord_tNormalize_1[i_tNormalize_1] != null) {
	                                	...
	                                	tmp_tNormalize_1 = copyOfrow4.businessKey2 == null ? null : String.valueOf(copyOfrow4.businessKey2);
		                    ...
		                    if(!recordSet_tNormalize_1.contains(currentRecord_tNormalize_1.toString())) {
	                        	...
	                        	row4.id = copyOfrow4.id;
	                        
	                        	row4.source = copyOfrow4.source;
	                        
	                        	row4.hash = copyOfrow4.hash;
	                        
	                        	row4.businessKey1 = normalizeRecord_tNormalize_1[i_tNormalize_1];
		                    
	                        	row4.businessKey2 = copyOfrow4.businessKey2;
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
                        		    		...
                        		    		row3HashKey.businessKey = row4.businessKey1 ;
...
// # Output table : 'row10'
row10_tmp.id = row4.id ;
row10_tmp.source = row4.source;
row10_tmp.hubId1 = row3.id ;
row10_tmp.businessKey2 = row4.businessKey2;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_4 ) {
exception1_tmp.id = row4.id ;
exception1_tmp.oldValue = row4.businessKey1 ;
...
} else {pstmt_tDBOutput_2.setString(4, row12.hash);
}
...
if(exception2 != null) { 
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = context.getBUSINESS_KEY2();
		if(obj_tRunJob_2!=null) {
 ...
 */
    ...
    globalMap.put("tNormalize_1_NB_LINE", nb_line_tNormalize_1);
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("copyOfrow4"+iterateId,2, 0); 
			 	}
			}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
        ...
        new BytesLimit65535_tAdvancedHash_row3().limitLog4jByte();
			   		...
			   		// linked node: tMap_4 - inputs:(row4,row3) outputs:(row10,exception1)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row16";
        ...
        new BytesLimit65535_tAdvancedHash_row16().limitLog4jByte();
			   		...
			   		// source node:tMongoDBInput_4 - inputs:(after_tDBInput_4) outputs:(row16,row16) | target node:tAdvancedHash_row16 - inputs:(row16) outputs:()
			   		// linked node: tMap_5 - inputs:(row13,row16) outputs:(ou1)
	...
	int nb_line_tMongoDBInput_4 = 0;
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_4=null;
				...
				db_tMongoDBInput_4 = (com.mongodb.client.MongoDatabase) globalMap.get("db_tMongoDBConnection_1");
					...
					com.mongodb.client.MongoCollection<org.bson.Document> coll_tMongoDBInput_4 = db_tMongoDBInput_4.getCollection("master.files");
				...
				try{
					...
					for (com.mongodb.DBObject index: coll_tMongoDBInput_4.listIndexes(com.mongodb.DBObject.class)) {
	                    ...
	                    for (String key: ((com.mongodb.DBObject)index.get("key")).keySet()) {
	                        ...
	                        // - is followed at some point by a colon
	                        // - there is no comma between the the DBcolumnName and the colon
	                        if  (("{'country.$id': ObjectId('" + globalMap.get("COUNTRY_ID").toString() + "'), 'metadata.type' : '" + context.getTYPE() + "'}, {_id: 1}").matches(".*" + key + "[^,]*:.*")) {
	                            // We have an index, do not print error message
	                            needIndexWarning = false;
	                        } else {
	                            // This index is not in the query, add it into the indexList
					...
					org.bson.Document myQuery_tMongoDBInput_4 = org.bson.Document.parse("{'country.$id': ObjectId('" + globalMap.get("COUNTRY_ID").toString() + "'), 'metadata.type' : '" + context.getTYPE() + "'}, {_id: 1}");
				...
				pathMap_tMongoDBInput_4.put("hash","");
				...
				Object valueObj_tMongoDBInput_4=null;
                    valueObj_tMongoDBInput_4=dbObjectInputUtil_tMongoDBInput_4.getValue(pathMap_tMongoDBInput_4.get("hash"),"hash",o_tMongoDBInput_4);
				if(valueObj_tMongoDBInput_4!=null && valueObj_tMongoDBInput_4.toString().length() > 0) {
					row16.hash = valueObj_tMongoDBInput_4.toString();
				}else{
					row16.hash = null;
				}
 ...
 */
    ...
    public static void main(String[] args){
        final LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUBClass = new LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB();

        int exitCode = LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUBClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB.class.getClassLoader().getResourceAsStream("deepsea/link_master_with_multiple_without_hub_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
            ...
            if(!context_param.isEmpty()) {
                ...
                context.BUSINESS_KEY1=(String) context.getProperty("BUSINESS_KEY1");
				    context.setContextType("BUSINESS_KEY2", "id_String");
				
                context.BUSINESS_KEY2=(String) context.getProperty("BUSINESS_KEY2");
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("WEBJOB_NAME")) {
            ...
            }if (parentContextMap.containsKey("BUSINESS_KEY2")) {
                context.BUSINESS_KEY2 = (String) parentContextMap.get("BUSINESS_KEY2");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LINK_MASTER_WITH_MULTIPLE_WITHOUT_HUB");
        }
...
/************************************************************************************************
 *     329795 characters generated by Talend Open Studio for Big Data 
 *     on the September 1, 2019 7:26:29 PM CST
 ************************************************************************************************/