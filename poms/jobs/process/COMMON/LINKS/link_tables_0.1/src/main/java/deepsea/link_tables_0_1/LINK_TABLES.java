...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "WARN","",row16.Body,"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_2", 4, row16.Body, 42);
	tLogCatcher_1Process(globalMap);
	globalMap.put("tWarn_2_WARN_MESSAGES", row16.Body); 
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","",row13.Body,"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 4, row13.Body, 42);
	tLogCatcher_1Process(globalMap);
	globalMap.put("tWarn_1_WARN_MESSAGES", row13.Body); 
...
/************************************************************************************************
 *     294789 characters generated by Talend Open Studio for Big Data 
 *     on the 4 October, 2018 12:33:14 PM SGT
 ************************************************************************************************/