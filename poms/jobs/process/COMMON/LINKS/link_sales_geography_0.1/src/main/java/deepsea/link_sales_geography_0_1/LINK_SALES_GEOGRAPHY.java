...
package deepsea.link_sales_geography_0_1;
...
/**
 * Job: LINK_SALES_GEOGRAPHY Purpose: Link Masters<br>
 * Description: Link Masters <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class LINK_SALES_GEOGRAPHY implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "LINK_SALES_GEOGRAPHY";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_ZcvswM_fEeib9oVpaXTd6w", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LINK_SALES_GEOGRAPHY.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LINK_SALES_GEOGRAPHY.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
                        		    		...
                        		    		row3HashKey.businessKey = row5.businessKey1 .substring(0, 2);
 ...
 */
    ...
    public static void main(String[] args){
        final LINK_SALES_GEOGRAPHY LINK_SALES_GEOGRAPHYClass = new LINK_SALES_GEOGRAPHY();

        int exitCode = LINK_SALES_GEOGRAPHYClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LINK_SALES_GEOGRAPHY.class.getClassLoader().getResourceAsStream("deepsea/link_sales_geography_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LINK_SALES_GEOGRAPHY.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LINK_SALES_GEOGRAPHY");
        }
...
/************************************************************************************************
 *     267195 characters generated by Talend Open Studio for Big Data 
