...
package deepsea.link_master_with_multiple_0_1;
...
/**
 * Job: LINK_MASTER_WITH_MULTIPLE Purpose: Update Master LINK with possible multiple values<br>
 ...
 * @status 
 */
public class LINK_MASTER_WITH_MULTIPLE implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "LINK_MASTER_WITH_MULTIPLE";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("__nEhIBZcEemh-7SwNZgZnQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LINK_MASTER_WITH_MULTIPLE.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LINK_MASTER_WITH_MULTIPLE.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row12Struct implements routines.system.IPersistableRow<row12Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_LINK_MASTER_WITH_MULTIPLE = new byte[0];
    static byte[] commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE.length == 0) {
   					commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_LINK_MASTER_WITH_MULTIPLE, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_LINK_MASTER_WITH_MULTIPLE) {
 ...
 */
    ...
    public static void main(String[] args){
        final LINK_MASTER_WITH_MULTIPLE LINK_MASTER_WITH_MULTIPLEClass = new LINK_MASTER_WITH_MULTIPLE();

        int exitCode = LINK_MASTER_WITH_MULTIPLEClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LINK_MASTER_WITH_MULTIPLE.class.getClassLoader().getResourceAsStream("deepsea/link_master_with_multiple_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LINK_MASTER_WITH_MULTIPLE.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LINK_MASTER_WITH_MULTIPLE");
        }
...
/************************************************************************************************
 *     285530 characters generated by Talend Open Studio for Big Data 
 *     on the 4 February, 2019 11:00:29 AM SGT
 ************************************************************************************************/