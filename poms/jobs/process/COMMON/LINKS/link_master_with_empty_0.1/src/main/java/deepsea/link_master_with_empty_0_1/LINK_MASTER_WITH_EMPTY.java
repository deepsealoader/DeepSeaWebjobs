...
package deepsea.link_master_with_empty_0_1;
...
/**
 * Job: LINK_MASTER_WITH_EMPTY Purpose: Update Master LINK with possible empty values<br>
 * Description: Update Master LINK with possible empty values. Empty values are just ignored. <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class LINK_MASTER_WITH_EMPTY implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "LINK_MASTER_WITH_EMPTY";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_RrhBMBZhEemh-7SwNZgZnQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LINK_MASTER_WITH_EMPTY.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LINK_MASTER_WITH_EMPTY.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row12Struct implements routines.system.IPersistableRow<row12Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_LINK_MASTER_WITH_EMPTY = new byte[0];
    static byte[] commonByteArray_DEEPSEA_LINK_MASTER_WITH_EMPTY = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_LINK_MASTER_WITH_EMPTY.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_LINK_MASTER_WITH_EMPTY.length == 0) {
   					commonByteArray_DEEPSEA_LINK_MASTER_WITH_EMPTY = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_LINK_MASTER_WITH_EMPTY = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_LINK_MASTER_WITH_EMPTY, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_LINK_MASTER_WITH_EMPTY, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_LINK_MASTER_WITH_EMPTY) {
 ...
 */
    ...
    public static void main(String[] args){
        final LINK_MASTER_WITH_EMPTY LINK_MASTER_WITH_EMPTYClass = new LINK_MASTER_WITH_EMPTY();

        int exitCode = LINK_MASTER_WITH_EMPTYClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LINK_MASTER_WITH_EMPTY.class.getClassLoader().getResourceAsStream("deepsea/link_master_with_empty_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LINK_MASTER_WITH_EMPTY.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LINK_MASTER_WITH_EMPTY");
        }
...
/************************************************************************************************
 *     266508 characters generated by Talend Open Studio for Big Data 
 *     on the 15 February, 2019 6:48:47 AM CST
 ************************************************************************************************/