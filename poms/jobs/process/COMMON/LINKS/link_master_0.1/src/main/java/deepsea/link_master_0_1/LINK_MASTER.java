...
package deepsea.link_master_0_1;
 ...
 * @status 
 */
public class LINK_MASTER implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "LINK_MASTER";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LINK_MASTER.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final LINK_MASTER LINK_MASTERClass = new LINK_MASTER();

        int exitCode = LINK_MASTERClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LINK_MASTER.class.getClassLoader().getResourceAsStream("deepsea/link_master_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LINK_MASTER.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LINK_MASTER");
        }
...
/************************************************************************************************
 *     263138 characters generated by Talend Open Studio for Big Data 
 *     on the 4 December, 2018 11:39:56 AM AEDT
 ************************************************************************************************/