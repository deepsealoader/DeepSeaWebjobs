...
package deepsea.sal_master_0_1;
 ...
 * @status 
 */
public class SAL_MASTER implements TalendJob {
	...
	private final String jobName = "SAL_MASTER";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SAL_MASTER.this, new Object[] { e,
	...
	public void tFlowMeter_14_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap)
			throws TalendException {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_SAL_MASTER.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_SAL_MASTER.length == 0) {
				...
				strReturn = new String(commonByteArray_DEEPSEA_SAL_MASTER, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
				...
				try {
					for (LogCatcherUtils.LogCatcherMessage lcm : tLogCatcher_1
						...
						if (row4.pid != null) { //
							...
							strBuffer_tLogRow_2
									.append(String.valueOf(row4.pid));
						...
						if (row4.job != null) { //
							...
							strBuffer_tLogRow_2
									.append(String.valueOf(row4.job));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_2 == null
					...
					tableName_tDBOutput_2 = (String) globalMap.get("SAL_TABLE");
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\""
							+ (String) globalMap.get("SAL_TABLE");
				}
				...
				while (cursor_tMongoDBInput_1.hasNext()) {
					...
					row9.id = row1.id;
					row9.businessKey1 = utility_tExtractFields_1.UnPivot(
							doc_tExtractFields_1, "tag", "value",
							context.getBUSINESS_KEY1());
					row9.businessKey2 = utility_tExtractFields_1.UnPivot(
							doc_tExtractFields_1, "tag", "value",
							context.getBUSINESS_KEY2());
					row9.hash = row1.hash;
						...
						if (row7 != null) {
							...
							if (row10 != null) {
								...
								if (tHash_Lookup_row2 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.businessKey = '"
									// + row2HashKey.businessKey + "'");
								} // G 071
								...
								if (exception2 != null) {
									...
									parentContextMap_tRunJob_1.put("SOURCE1",
											context.SOURCE1);
									paraList_tRunJob_1.add("--context_type "
											+ "SOURCE1" + "=" + "id_String");

									parentContextMap_tRunJob_1.put("SOURCE2",
											context.SOURCE2);
									paraList_tRunJob_1.add("--context_type "
											+ "SOURCE2" + "=" + "id_String");
									...
									parentContextMap_tRunJob_1.put(
											"FIELD_VALUE", obj_tRunJob_1);

									obj_tRunJob_1 = "business key not found in source "
											+ context.getSOURCE2();
									if (obj_tRunJob_1 != null) {
										paraList_tRunJob_1
							...
							if (exception1 != null) {
								...
								parentContextMap_tRunJob_2.put("SHEET_NAME",
										context.SHEET_NAME);
								paraList_tRunJob_2.add("--context_type "
										+ "SHEET_NAME" + "=" + "id_String");

								parentContextMap_tRunJob_2.put("BUSINESS_KEY1",
										context.BUSINESS_KEY1);
								paraList_tRunJob_2.add("--context_type "
										+ "BUSINESS_KEY1" + "=" + "id_String");

								parentContextMap_tRunJob_2.put("BUSINESS_KEY2",
										context.BUSINESS_KEY2);
								paraList_tRunJob_2.add("--context_type "
										+ "BUSINESS_KEY2" + "=" + "id_String");
								...
								parentContextMap_tRunJob_2.put("SOURCE1",
										context.SOURCE1);
								paraList_tRunJob_2.add("--context_type "
										+ "SOURCE1" + "=" + "id_String");

								parentContextMap_tRunJob_2.put("SOURCE2",
										context.SOURCE2);
								paraList_tRunJob_2.add("--context_type "
										+ "SOURCE2" + "=" + "id_String");
								...
								parentContextMap_tRunJob_2.put("COUNTRY_ID",
										obj_tRunJob_2);
								...
								parentContextMap_tRunJob_2.put("FIELD_NAME",
										obj_tRunJob_2);
								...
								parentContextMap_tRunJob_2.put("FIELD_VALUE",
										obj_tRunJob_2);

								obj_tRunJob_2 = "business key not found in source "
										+ context.getSOURCE1();
								if (obj_tRunJob_2 != null) {
									paraList_tRunJob_2
											.add("--context_param REASON="
				...
				tFlowMeterCatcher_1.addMessage("Number of records integrated",
						new Integer(count_tFlowMeter_14), "null", "",
						"tFlowMeter_14");
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(row2) outputs:()
				// linked node: tMap_2 - inputs:(row10,row2)
				// outputs:(row11,exception2)
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row2.businessKey = routines.system.JDBCUtil
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String dbquery_tDBInput_2 = "SELECT DISTINCT\n	hash\nfrom\n	"
						...
						+ globalMap.get("SAL_TABLE")
						+ " as b on a.id = b.hub_id2\nWHERE\n	a.source = '"
						+ context.getSOURCE2() + "'";
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_3 - inputs:(after_tMongoDBInput_1)
				// outputs:(row3,row3) | target node:tAdvancedHash_row3 -
				// inputs:(row3) outputs:()
				// linked node: tMap_4 - inputs:(row5,row3)
				// outputs:(row10,exception1)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				while (cursor_tMongoDBInput_2.hasNext()) {
					...
					globalMap.put(
							"SAL_TABLE",
							TalendString.unionString("_", "sal",
									context.getTABLE()));
					globalMap.put(
							"HUB_TABLE",
							TalendString.unionString("_", "hub",
									context.getTABLE()));
	...
	public static void main(String[] args) {
		final SAL_MASTER SAL_MASTERClass = new SAL_MASTER();

		int exitCode = SAL_MASTERClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SAL_MASTER.class.getClassLoader()
					.getResourceAsStream(
							"deepsea/sal_master_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = SAL_MASTER.class
						.getClassLoader()
						.getResourceAsStream(
			...
			context.BUSINESS_KEY1 = (String) context
					.getProperty("BUSINESS_KEY1");
			context.setContextType("BUSINESS_KEY2", "id_String");

			context.BUSINESS_KEY2 = (String) context
					.getProperty("BUSINESS_KEY2");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("BUSINESS_KEY1")) {
				context.BUSINESS_KEY1 = (String) parentContextMap
						.get("BUSINESS_KEY1");
			}
			if (parentContextMap.containsKey("BUSINESS_KEY2")) {
				context.BUSINESS_KEY2 = (String) parentContextMap
						.get("BUSINESS_KEY2");
			}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : SAL_MASTER");
		}
...
/************************************************************************************************
 * 268274 characters generated by Talend Open Studio for Big Data on the
 * September 1, 2019 10:02:41 PM CST
 ************************************************************************************************/
