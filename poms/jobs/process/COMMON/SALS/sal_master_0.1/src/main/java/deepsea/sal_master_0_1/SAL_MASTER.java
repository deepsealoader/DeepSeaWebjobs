		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAL_MASTER.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAL_MASTER.class.getClassLoader().getResourceAsStream("deepsea/sal_master_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAL_MASTER.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAL_MASTER");
        }
...
/************************************************************************************************
 *     293902 characters generated by Talend Open Studio for Big Data 
