...
package deepsea.sal_master_with_empty_0_1;
...
/**
 * Job: SAL_MASTER_WITH_EMPTY Purpose: Update Master SAL<br>
 ...
 * @status 
 */
public class SAL_MASTER_WITH_EMPTY implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "SAL_MASTER_WITH_EMPTY";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_-WiGQIKMEemoypS3_9b89w", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SAL_MASTER_WITH_EMPTY.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAL_MASTER_WITH_EMPTY.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row12Struct implements routines.system.IPersistableRow<row12Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_SAL_MASTER_WITH_EMPTY = new byte[0];
    static byte[] commonByteArray_DEEPSEA_SAL_MASTER_WITH_EMPTY = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_SAL_MASTER_WITH_EMPTY.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_SAL_MASTER_WITH_EMPTY.length == 0) {
   					commonByteArray_DEEPSEA_SAL_MASTER_WITH_EMPTY = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_SAL_MASTER_WITH_EMPTY = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_SAL_MASTER_WITH_EMPTY, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_SAL_MASTER_WITH_EMPTY, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAL_MASTER_WITH_EMPTY) {
 ...
 */
	...
	tFlowMeterCatcher_1.addMessage("Number of records read", new Integer(count_tFlowMeter_13), "null", "", "tFlowMeter_13");
 ...
 */
    ...
    public static void main(String[] args){
        final SAL_MASTER_WITH_EMPTY SAL_MASTER_WITH_EMPTYClass = new SAL_MASTER_WITH_EMPTY();

        int exitCode = SAL_MASTER_WITH_EMPTYClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAL_MASTER_WITH_EMPTY.class.getClassLoader().getResourceAsStream("deepsea/sal_master_with_empty_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAL_MASTER_WITH_EMPTY.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAL_MASTER_WITH_EMPTY");
        }
...
/************************************************************************************************
 *     270459 characters generated by Talend Open Studio for Big Data 
 *     on the September 1, 2019 8:06:03 PM CST
 ************************************************************************************************/