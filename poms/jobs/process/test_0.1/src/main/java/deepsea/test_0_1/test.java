		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.net.URL url_tHttpRequest_1 = new java.net.URL(
						"http://localhost:8080/09_GeographyUser");
				...
				urlConn_tHttpRequest_1.setRequestProperty("Accept", "text/csv");
					...
					if (java.net.HttpURLConnection.HTTP_OK == responseCode_tHttpRequest_1) {
						...
						java.io.OutputStream bosContent_tHttpRequest_1 = new java.io.BufferedOutputStream(
								new java.io.FileOutputStream(
										"C:/Users/RRU_CN1/Desktop/test.csv"));
...
/************************************************************************************************
 * 34337 characters generated by Talend Open Studio for Big Data on the 2
 * December, 2018 3:28:38 PM SGT
 ************************************************************************************************/
