...
package deepsea.link_zuellig_product_sales_0_1;
...
/**
 * Job: LINK_ZUELLIG_PRODUCT_SALES Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class LINK_ZUELLIG_PRODUCT_SALES implements TalendJob {
	...
	private final String jobName = "LINK_ZUELLIG_PRODUCT_SALES";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					LINK_ZUELLIG_PRODUCT_SALES.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(LINK_ZUELLIG_PRODUCT_SALES.this,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_LINK_ZUELLIG_PRODUCT_SALES = new byte[0];
		static byte[] commonByteArray_DEEPSEA_LINK_ZUELLIG_PRODUCT_SALES = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_LINK_ZUELLIG_PRODUCT_SALES.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_LINK_ZUELLIG_PRODUCT_SALES.length == 0) {
						commonByteArray_DEEPSEA_LINK_ZUELLIG_PRODUCT_SALES = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_LINK_ZUELLIG_PRODUCT_SALES = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_DEEPSEA_LINK_ZUELLIG_PRODUCT_SALES, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_LINK_ZUELLIG_PRODUCT_SALES) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						...
						+ "] ([Source],[LoadDate],[HUB_ID1],[HUB_ID2]) VALUES (?,?,?,?)";
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							row1.InvoiceLineNumber = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
						...
						if (row1 != null) {
							...
							if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
								...
								row5HashKey.BK3_SAPCode = row1.ProductCode
										.equals("21085273") ? "21085269"
										: (row1.ProductCode.equals("21085272") ? "21085263"
												: row1.ProductCode);
							...
							if (tHash_Lookup_row5 != null
								...
								// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.BK3_SAPCode = '"
								// + row5HashKey.BK3_SAPCode + "'");
							} // G 071
							...
							{ // start of Var scope
								...
								if (!rejectedInnerJoin_tMap_2) {
									...
									row1.InvoiceDate != null
											&& !row1.InvoiceDate.equals("")

									) {
										row4_tmp.Source = "ZUELLIG";
										row4_tmp.LoadDate = new Date();
										row4_tmp.HUB_ID1 = row5.ID;
										row4_tmp.SalesID = TalendString
												.unionString("-",
														row1.InvoiceNumber,
														row1.InvoiceLineNumber);
										row4 = row4_tmp;
								...
								if (rejectedInnerJoin_tMap_2
										...
										row1.InvoiceDate != null && !row1.InvoiceDate
												.equals("")

										)) {
									exception2_tmp.InvoiceNumber = row1.InvoiceNumber;
									exception2_tmp.InvoiceLineNumber = row1.InvoiceLineNumber;
									exception2_tmp.InvoiceDate = row1.InvoiceDate;
									exception2_tmp.ProductCode = row1.ProductCode;
									exception2_tmp.Quantity = row1.Quantity;
							...
							if (row4 != null) {
								...
								if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
									...
									row3HashKey.BK3_SalesID = row4.SalesID;
								...
								if (row2 != null) {
									...
									pstmt_tDBOutput_1.setInt(3, row2.HUB_ID1);

									pstmt_tDBOutput_1.setInt(4, row2.HUB_ID2);
							...
							if (exception2 != null) {
								...
								if (exception2.InvoiceNumber != null) { //

									strBuffer_tLogRow_1.append(String
											.valueOf(exception2.InvoiceNumber));

								} //

								strBuffer_tLogRow_1.append("|");

								if (exception2.InvoiceLineNumber != null) { //

									strBuffer_tLogRow_1
											.append(String
													.valueOf(exception2.InvoiceLineNumber));

								} //

								strBuffer_tLogRow_1.append("|");

								if (exception2.InvoiceDate != null) { //

									strBuffer_tLogRow_1.append(String
											.valueOf(exception2.InvoiceDate));

								} //

								strBuffer_tLogRow_1.append("|");

								if (exception2.ProductCode != null) { //

									strBuffer_tLogRow_1.append(String
											.valueOf(exception2.ProductCode));

								} //

								strBuffer_tLogRow_1.append("|");

								if (exception2.Quantity != null) { //

									strBuffer_tLogRow_1.append(String
											.valueOf(exception2.Quantity));
	...
	public static class row5Struct implements
		...
		public String BK3_SAPCode;

		public String getBK3_SAPCode() {
			return this.BK3_SAPCode;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.BK3_SAPCode == null) ? 0 : this.BK3_SAPCode
								.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.BK3_SAPCode == null) {
				if (other.BK3_SAPCode != null)
					return false;

			} else if (!this.BK3_SAPCode.equals(other.BK3_SAPCode))
		...
		public void copyDataTo(row5Struct other) {
			...
			other.BK3_SAPCode = this.BK3_SAPCode;
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_LINK_ZUELLIG_PRODUCT_SALES) {
				...
				try {
					...
					this.BK3_SAPCode = readString(dis);
		...
		public void writeKeysData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.BK3_SAPCode, dos);
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.BK1_ShortName = readString(dis, ois);

				this.BK2_BoxQty = readInteger(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.BK1_ShortName, dos, oos);

				writeInteger(this.BK2_BoxQty, dos, oos);
		...
		public String toString() {
			...
			sb.append(",BK3_SAPCode=" + BK3_SAPCode);
			sb.append("]");
		...
		public int compareTo(row5Struct other) {
			...
			returnValue = checkNullsAndCompare(this.BK3_SAPCode,
					other.BK3_SAPCode);
			if (returnValue != 0) {
				return returnValue;
			}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3
										.contains(rsmd_tDBInput_3
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row5.BK3_SAPCode = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row5.BK3_SAPCode = tmpContent_tDBInput_3;
								}
							} else {
								row5.BK3_SAPCode = null;
							}
						...
						row5_HashRow.BK3_SAPCode = row5.BK3_SAPCode;
	...
	public static void main(String[] args) {
		final LINK_ZUELLIG_PRODUCT_SALES LINK_ZUELLIG_PRODUCT_SALESClass = new LINK_ZUELLIG_PRODUCT_SALES();

		int exitCode = LINK_ZUELLIG_PRODUCT_SALESClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LINK_ZUELLIG_PRODUCT_SALES.class
					.getClassLoader().getResourceAsStream(
							"deepsea/link_zuellig_product_sales_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = LINK_ZUELLIG_PRODUCT_SALES.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : LINK_ZUELLIG_PRODUCT_SALES");
		}
...
/************************************************************************************************
 * 157102 characters generated by Talend Open Studio for Big Data on the 15
 * November, 2018 4:16:40 PM ICT
 ************************************************************************************************/
