...
package deepsea.link_stms_customer_sales_0_1;
...
/**
 * Job: LINK_STMS_CUSTOMER_SALES Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class LINK_STMS_CUSTOMER_SALES implements TalendJob {
	...
	private final String jobName = "LINK_STMS_CUSTOMER_SALES";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					LINK_STMS_CUSTOMER_SALES.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(LINK_STMS_CUSTOMER_SALES.this,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_LINK_STMS_CUSTOMER_SALES = new byte[0];
		static byte[] commonByteArray_DEEPSEA_LINK_STMS_CUSTOMER_SALES = new byte[0];
		...
		public int getHUB_ID1() {
			return this.HUB_ID1;
		}

		public int HUB_ID2;

		public int getHUB_ID2() {
			return this.HUB_ID2;
		}
		...
		public void copyDataTo(row2Struct other) {
			...
			other.LoadDate = this.LoadDate;
			other.HUB_ID1 = this.HUB_ID1;
			other.HUB_ID2 = this.HUB_ID2;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_LINK_STMS_CUSTOMER_SALES.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_LINK_STMS_CUSTOMER_SALES.length == 0) {
						commonByteArray_DEEPSEA_LINK_STMS_CUSTOMER_SALES = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_LINK_STMS_CUSTOMER_SALES = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_LINK_STMS_CUSTOMER_SALES,
						0, length);
				strReturn = new String(
						commonByteArray_DEEPSEA_LINK_STMS_CUSTOMER_SALES, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_LINK_STMS_CUSTOMER_SALES) {
				...
				try {
					...
					this.HUB_ID1 = dis.readInt();

					this.HUB_ID2 = dis.readInt();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeInt(this.HUB_ID1);

				// int

				dos.writeInt(this.HUB_ID2);
		...
		public String toString() {
			...
			sb.append(",HUB_ID1=" + String.valueOf(HUB_ID1));
			sb.append(",HUB_ID2=" + String.valueOf(HUB_ID2));
			sb.append("]");
	...
	public static class exception2Struct implements
			routines.system.IPersistableRow<exception2Struct> {
		final static byte[] commonByteArrayLock_DEEPSEA_LINK_STMS_CUSTOMER_SALES = new byte[0];
		static byte[] commonByteArray_DEEPSEA_LINK_STMS_CUSTOMER_SALES = new byte[0];
		...
		public String BK_OLD;

		public String getBK_OLD() {
			return this.BK_OLD;
		}

		public String BK_NEW;

		public String getBK_NEW() {
			return this.BK_NEW;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_LINK_STMS_CUSTOMER_SALES) {
				...
				try {
					...
					this.BK_OLD = readString(dis);

					this.BK_NEW = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.BK_OLD, dos);

				// String

				writeString(this.BK_NEW, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("SalesID=" + String.valueOf(SalesID));
			sb.append(",BK_OLD=" + BK_OLD);
			sb.append(",BK_NEW=" + BK_NEW);
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "LINK_CUSTOMER_SALES";
				} else {
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						+ tableName_tDBOutput_1
						+ "] ([ID],[Source],[LoadDate],[HUB_ID1],[HUB_ID2]) VALUES (?,?,?,?,?)";
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement(insert_tDBOutput_1);

				boolean isShareIdentity_tDBOutput_1 = globalMap
						.get("shareIdentitySetting_tDBConnection_2") != null
						&& (Boolean) globalMap
								.get("shareIdentitySetting_tDBConnection_2") == true;
				java.sql.Statement stmt_tDBOutput_1 = conn_tDBOutput_1
						.createStatement();
				if (!isShareIdentity_tDBOutput_1) {
					stmt_tDBOutput_1.execute("SET IDENTITY_INSERT ["
							+ tableName_tDBOutput_1 + "] ON");
				}
				...
				String dbquery_tDBInput_1 = "SELECT\n	dbo.TSALLING.SalesID,\n	dbo.TMAPCUSTOMER.DistributorCustomerID AS BK_OLD,\n	dbo.TCUSTOMER.Code_Servier AS BK_N"
						+ "EW\nFROM\n	dbo.TSALLING\n		INNER JOIN dbo.TCUSTOMER ON dbo.TCUSTOMER.CustomerID=dbo.TSALLING.CustomerID\n			LEFT JOIN dbo"
						+ ".TMAPCUSTOMER ON dbo.TCUSTOMER.CustomerID=dbo.TMAPCUSTOMER.CustomerID\nWHERE\n	dbo.TSALLING.ProductID <> 0 AND dbo.TSALL"
						+ "ING.InvoiceDate IS NOT NULL AND dbo.TSALLING.DistributorID=1\nAND\n	(dbo.TMAPCUSTOMER.DistributorCustomerID <> '' OR dbo"
						+ ".TMAPCUSTOMER.DistributorCustomerID IS NOT  NULL)\nAND\n	(dbo.TCUSTOMER.Code_Servier <> '' OR dbo.TCUSTOMER.Code_Servier"
						+ " IS NOT  NULL)\nAND\n	dbo.TMAPCUSTOMER.DistributorID = 1";
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (rs_tDBInput_1.getObject(1) != null) {
								row1.SalesID = rs_tDBInput_1.getLong(1);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
									...
									row1.BK_OLD = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.BK_OLD = tmpContent_tDBInput_1;
								}
							} else {
								row1.BK_OLD = null;
							}
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
										.contains(rsmd_tDBInput_1
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.BK_NEW = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.BK_NEW = tmpContent_tDBInput_1;
								}
							} else {
								row1.BK_NEW = null;
							}
						...
						if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
							...
							row5HashKey.BK1_Old = row1.BK_OLD;

							row5HashKey.BK2_New = row1.BK_NEW;
						...
						if (tHash_Lookup_row5 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.BK1_Old = '"
							// + row5HashKey.BK1_Old + "', row5.BK2_New = '" +
							// row5HashKey.BK2_New + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							if (!rejectedInnerJoin_tMap_2) {
								...
								// # Output table : 'row4'
								row4_tmp.Source = "STMS";
								row4_tmp.LoadDate = new Date();
								row4_tmp.HUB_ID1 = row5.ID;
								row4_tmp.SalesID = row1.SalesID;
								row4 = row4_tmp;
							...
							// # Filter conditions
							if (rejectedInnerJoin_tMap_2) {
								exception2_tmp.SalesID = row1.SalesID;
								exception2_tmp.BK_OLD = row1.BK_OLD;
								exception2_tmp.BK_NEW = row1.BK_NEW;
						...
						if (row4 != null) {
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								row3HashKey.BK3_SalesID = String
										.valueOf(row4.SalesID);
							...
							if (tHash_Lookup_row3 != null
								...
								// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.BK3_SalesID = '"
								// + row3HashKey.BK3_SalesID + "'");
							} // G 071
							...
							{ // start of Var scope
								...
								if (!rejectedInnerJoin_tMap_1) {
									...
									// # Output table : 'row2'
									row2_tmp.ID = Numeric.sequence(
											"LINK_PRODUCT_SALES", 1, 1);
									row2_tmp.Source = row4.Source;
									row2_tmp.LoadDate = row4.LoadDate;
									row2_tmp.HUB_ID1 = row4.HUB_ID1;
									row2_tmp.HUB_ID2 = row3.ID;
									row2 = row2_tmp;
								} // closing inner join bracket (1)
									// ###### START REJECTS #####
								...
								// # Filter conditions
								if (rejectedInnerJoin_tMap_1) {
									exception1_tmp.Source = row4.Source;
									exception1_tmp.LoadDate = row4.LoadDate;
									exception1_tmp.HUB_ID1 = row4.HUB_ID1;
									exception1_tmp.SalesID = row4.SalesID;
							...
							if (row2 != null) {
								...
								if (row2.Source == null) {
									...
									pstmt_tDBOutput_1.setString(2, row2.Source);
								}

								if (row2.LoadDate != null) {
									pstmt_tDBOutput_1.setTimestamp(3,
											new java.sql.Timestamp(
													row2.LoadDate.getTime()));
								} else {
									pstmt_tDBOutput_1.setNull(3,
											java.sql.Types.DATE);
								}

								pstmt_tDBOutput_1.setInt(4, row2.HUB_ID1);

								pstmt_tDBOutput_1.setInt(5, row2.HUB_ID2);
							...
							if (exception1 != null) {
								...
								if (exception1.Source != null) { //

									strBuffer_tLogRow_2.append(String
											.valueOf(exception1.Source));

								} //

								strBuffer_tLogRow_2.append("|");

								if (exception1.LoadDate != null) { //

									strBuffer_tLogRow_2.append(FormatterUtils
											.format_Date(exception1.LoadDate,
													"dd-MM-yyyy"));
								...
								strBuffer_tLogRow_2.append(String
										.valueOf(exception1.HUB_ID1));

								strBuffer_tLogRow_2.append("|");

								strBuffer_tLogRow_2.append(String
										.valueOf(exception1.SalesID));
						...
						if (exception2 != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection("exception2"
										+ iterateId, 1, 1);
							}
							...
							strBuffer_tLogRow_1.append(String
									.valueOf(exception2.SalesID));

							strBuffer_tLogRow_1.append("|");

							if (exception2.BK_OLD != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception2.BK_OLD));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception2.BK_NEW != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception2.BK_NEW));
				...
				if (isShareIdentity_tDBOutput_1) {
					String setIdentityInsertONSQL_tDBOutput_1 = "SET IDENTITY_INSERT ["
							+ tableName_tDBOutput_1 + "] ON";

					stmt_tDBOutput_1
							.execute(setIdentityInsertONSQL_tDBOutput_1);
				...
				String setIdentityInsertOFFSQL_tDBOutput_1 = "SET IDENTITY_INSERT ["
						+ tableName_tDBOutput_1 + "] OFF";
	...
	public static class row3Struct implements
		...
		public String BK1_InvoiceNumber;

		public String getBK1_InvoiceNumber() {
			return this.BK1_InvoiceNumber;
		}

		public java.util.Date BK2_InvoiceDate;

		public java.util.Date getBK2_InvoiceDate() {
			return this.BK2_InvoiceDate;
		}

		public String BK3_SalesID;

		public String getBK3_SalesID() {
			return this.BK3_SalesID;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.BK3_SalesID == null) ? 0 : this.BK3_SalesID
								.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.BK3_SalesID == null) {
				if (other.BK3_SalesID != null)
					return false;

			} else if (!this.BK3_SalesID.equals(other.BK3_SalesID))
		...
		public void copyDataTo(row3Struct other) {
			...
			other.ID = this.ID;
			other.BK1_InvoiceNumber = this.BK1_InvoiceNumber;
			other.BK2_InvoiceDate = this.BK2_InvoiceDate;
			other.BK3_SalesID = this.BK3_SalesID;
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_LINK_STMS_CUSTOMER_SALES) {
				...
				try {
					...
					this.BK3_SalesID = readString(dis);
		...
		public void writeKeysData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.BK3_SalesID, dos);
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.BK1_InvoiceNumber = readString(dis, ois);

				this.BK2_InvoiceDate = readDate(dis, ois);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.BK1_InvoiceNumber, dos, oos);

				writeDate(this.BK2_InvoiceDate, dos, oos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("ID=" + String.valueOf(ID));
			sb.append(",BK1_InvoiceNumber=" + BK1_InvoiceNumber);
			sb.append(",BK2_InvoiceDate=" + String.valueOf(BK2_InvoiceDate));
			sb.append(",BK3_SalesID=" + BK3_SalesID);
			sb.append("]");
		...
		public int compareTo(row3Struct other) {
			...
			returnValue = checkNullsAndCompare(this.BK3_SalesID,
					other.BK3_SalesID);
			if (returnValue != 0) {
				return returnValue;
			}
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row3.BK1_InvoiceNumber = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row3.BK1_InvoiceNumber = tmpContent_tDBInput_2;
								}
							} else {
								row3.BK1_InvoiceNumber = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							row3.BK2_InvoiceDate = null;
						} else {

							row3.BK2_InvoiceDate = mssqlGTU_tDBInput_2.getDate(
									rsmd_tDBInput_2, rs_tDBInput_2, 3);

						}
						if (colQtyInRs_tDBInput_2 < 4) {
							row3.BK3_SalesID = null;
						} else {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row3.BK3_SalesID = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row3.BK3_SalesID = tmpContent_tDBInput_2;
								}
							} else {
								row3.BK3_SalesID = null;
							}
						...
						row3_HashRow.BK1_InvoiceNumber = row3.BK1_InvoiceNumber;

						row3_HashRow.BK2_InvoiceDate = row3.BK2_InvoiceDate;

						row3_HashRow.BK3_SalesID = row3.BK3_SalesID;
	...
	public static class row5Struct implements
		...
		public String BK1_Old;

		public String getBK1_Old() {
			return this.BK1_Old;
		}

		public String BK2_New;

		public String getBK2_New() {
			return this.BK2_New;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.BK1_Old == null) ? 0 : this.BK1_Old.hashCode());

				result = prime
						* result
						+ ((this.BK2_New == null) ? 0 : this.BK2_New.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.BK1_Old == null) {
				if (other.BK1_Old != null)
					return false;

			} else if (!this.BK1_Old.equals(other.BK1_Old))

				return false;

			if (this.BK2_New == null) {
				if (other.BK2_New != null)
					return false;

			} else if (!this.BK2_New.equals(other.BK2_New))
		...
		public void copyDataTo(row5Struct other) {
			...
			other.ID = this.ID;
			other.BK1_Old = this.BK1_Old;
			other.BK2_New = this.BK2_New;
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_LINK_STMS_CUSTOMER_SALES) {
				...
				try {
					...
					this.BK1_Old = readString(dis);

					this.BK2_New = readString(dis);
		...
		public void writeKeysData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.BK1_Old, dos);

				// String

				writeString(this.BK2_New, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("ID=" + String.valueOf(ID));
			sb.append(",BK1_Old=" + BK1_Old);
			sb.append(",BK2_New=" + BK2_New);
			sb.append("]");
		...
		public int compareTo(row5Struct other) {
			...
			returnValue = checkNullsAndCompare(this.BK1_Old, other.BK1_Old);
			if (returnValue != 0) {
				return returnValue;
			}

			returnValue = checkNullsAndCompare(this.BK2_New, other.BK2_New);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(row5) outputs:()
				// linked node: tMap_2 - inputs:(row1,row5)
				// outputs:(row4,exception2)
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3
										.contains(rsmd_tDBInput_3
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row5.BK1_Old = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row5.BK1_Old = tmpContent_tDBInput_3;
								}
							} else {
								row5.BK1_Old = null;
							}
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3
										.contains(rsmd_tDBInput_3
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row5.BK2_New = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row5.BK2_New = tmpContent_tDBInput_3;
								}
							} else {
								row5.BK2_New = null;
							}
						...
						row5_HashRow.BK1_Old = row5.BK1_Old;

						row5_HashRow.BK2_New = row5.BK2_New;
	...
	public void tDBConnection_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_2 = "jdbc:sqlserver://"
						+ "vn1db03\\sql2008";
				String port_tDBConnection_2 = "1768";
				String dbname_tDBConnection_2 = "ISVN_MDR";
				if (!"".equals(port_tDBConnection_2)) {
					url_tDBConnection_2 += ":" + "1768";
				}
				if (!"".equals(dbname_tDBConnection_2)) {

					url_tDBConnection_2 += ";databaseName=" + "ISVN_MDR";
				}
				...
				globalMap.put("db_tDBConnection_2", "ISVN_MDR");
	...
	public static void main(String[] args) {
		final LINK_STMS_CUSTOMER_SALES LINK_STMS_CUSTOMER_SALESClass = new LINK_STMS_CUSTOMER_SALES();

		int exitCode = LINK_STMS_CUSTOMER_SALESClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LINK_STMS_CUSTOMER_SALES.class
					.getClassLoader().getResourceAsStream(
							"deepsea/link_stms_customer_sales_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = LINK_STMS_CUSTOMER_SALES.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : LINK_STMS_CUSTOMER_SALES");
		}
...
/************************************************************************************************
 * 153513 characters generated by Talend Open Studio for Big Data on the 15
 * November, 2018 4:11:58 PM ICT
 ************************************************************************************************/
