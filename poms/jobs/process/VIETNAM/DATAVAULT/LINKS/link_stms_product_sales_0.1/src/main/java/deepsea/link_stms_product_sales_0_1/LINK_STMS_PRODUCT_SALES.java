...
package deepsea.link_stms_product_sales_0_1;
...
/**
 * Job: LINK_STMS_PRODUCT_SALES Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class LINK_STMS_PRODUCT_SALES implements TalendJob {
	...
	private final String jobName = "LINK_STMS_PRODUCT_SALES";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					LINK_STMS_PRODUCT_SALES.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(LINK_STMS_PRODUCT_SALES.this,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_LINK_STMS_PRODUCT_SALES = new byte[0];
		static byte[] commonByteArray_DEEPSEA_LINK_STMS_PRODUCT_SALES = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_LINK_STMS_PRODUCT_SALES.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_LINK_STMS_PRODUCT_SALES.length == 0) {
						commonByteArray_DEEPSEA_LINK_STMS_PRODUCT_SALES = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_LINK_STMS_PRODUCT_SALES = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_LINK_STMS_PRODUCT_SALES,
						0, length);
				strReturn = new String(
						commonByteArray_DEEPSEA_LINK_STMS_PRODUCT_SALES, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_LINK_STMS_PRODUCT_SALES) {
	...
	public static class exception2Struct implements
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_LINK_STMS_PRODUCT_SALES) {
				...
				try {
					...
					this.Shortcut = readString(dis);

					this.BoxQty = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.Shortcut, dos);

				// Integer

				writeInteger(this.BoxQty, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("SalesID=" + String.valueOf(SalesID));
			sb.append(",Shortcut=" + Shortcut);
			sb.append(",BoxQty=" + String.valueOf(BoxQty));
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "LINK_PRODUCT_SALES";
				} else {
				...
				String dbquery_tDBInput_1 = "SELECT\n	dbo.TSALLING.SalesID,\n	dbo.TPRODUCT.Shortcut,\n	dbo.TPRODUCT.BoxQty\nFROM\n	dbo.TSALLING\n		INNER JOIN dbo.TPR"
						+ "ODUCT ON dbo.TPRODUCT.ProductID=dbo.TSALLING.ProductID\nWHERE\n	dbo.TSALLING.ProductID <> 0 AND dbo.TSALLING.InvoiceDate"
						+ " IS NOT NULL AND dbo.TSALLING.DistributorID=1";
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
									...
									row1.Shortcut = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.Shortcut = tmpContent_tDBInput_1;
								}
							} else {
								row1.Shortcut = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							if (rs_tDBInput_1.getObject(3) != null) {
								row1.BoxQty = rs_tDBInput_1.getInt(3);
							} else {
								row1.BoxQty = null;
							}
						}
						...
						if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
							...
							row5HashKey.BK1_ShortName = row1.Shortcut;

							row5HashKey.BK2_BoxQty = row1.BoxQty;
						...
						if (tHash_Lookup_row5 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.BK1_ShortName = '"
							// + row5HashKey.BK1_ShortName +
							// "', row5.BK2_BoxQty = '" + row5HashKey.BK2_BoxQty
							// + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							if (rejectedInnerJoin_tMap_2) {
								...
								exception2_tmp.Shortcut = row1.Shortcut;
								exception2_tmp.BoxQty = row1.BoxQty;
						...
						if (exception2 != null) {
							...
							if (exception2.Shortcut != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception2.Shortcut));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception2.BoxQty != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception2.BoxQty));
	...
	public static class row5Struct implements
		...
		public String BK1_ShortName;

		public String getBK1_ShortName() {
			return this.BK1_ShortName;
		}

		public Integer BK2_BoxQty;

		public Integer getBK2_BoxQty() {
			return this.BK2_BoxQty;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.BK1_ShortName == null) ? 0
								: this.BK1_ShortName.hashCode());

				result = prime
						* result
						+ ((this.BK2_BoxQty == null) ? 0 : this.BK2_BoxQty
								.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.BK1_ShortName == null) {
				if (other.BK1_ShortName != null)
					return false;

			} else if (!this.BK1_ShortName.equals(other.BK1_ShortName))

				return false;

			if (this.BK2_BoxQty == null) {
				if (other.BK2_BoxQty != null)
					return false;

			} else if (!this.BK2_BoxQty.equals(other.BK2_BoxQty))
		...
		public void copyDataTo(row5Struct other) {
			...
			other.ID = this.ID;
			other.BK1_ShortName = this.BK1_ShortName;
			other.BK2_BoxQty = this.BK2_BoxQty;
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_LINK_STMS_PRODUCT_SALES) {
				...
				try {
					...
					this.BK1_ShortName = readString(dis);

					this.BK2_BoxQty = readInteger(dis);
		...
		public void writeKeysData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.BK1_ShortName, dos);

				// Integer

				writeInteger(this.BK2_BoxQty, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("ID=" + String.valueOf(ID));
			sb.append(",BK1_ShortName=" + BK1_ShortName);
			sb.append(",BK2_BoxQty=" + String.valueOf(BK2_BoxQty));
			sb.append("]");
		...
		public int compareTo(row5Struct other) {
			...
			returnValue = checkNullsAndCompare(this.BK1_ShortName,
					other.BK1_ShortName);
			if (returnValue != 0) {
				return returnValue;
			}

			returnValue = checkNullsAndCompare(this.BK2_BoxQty,
					other.BK2_BoxQty);
			if (returnValue != 0) {
				return returnValue;
			}
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3
										.contains(rsmd_tDBInput_3
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row5.BK1_ShortName = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row5.BK1_ShortName = tmpContent_tDBInput_3;
								}
							} else {
								row5.BK1_ShortName = null;
							}
						...
						if (colQtyInRs_tDBInput_3 < 3) {
							row5.BK2_BoxQty = null;
						} else {

							if (rs_tDBInput_3.getObject(3) != null) {
								row5.BK2_BoxQty = rs_tDBInput_3.getInt(3);
							} else {
								row5.BK2_BoxQty = null;
							}
						}
						...
						row5_HashRow.BK1_ShortName = row5.BK1_ShortName;

						row5_HashRow.BK2_BoxQty = row5.BK2_BoxQty;
	...
	public static void main(String[] args) {
		final LINK_STMS_PRODUCT_SALES LINK_STMS_PRODUCT_SALESClass = new LINK_STMS_PRODUCT_SALES();

		int exitCode = LINK_STMS_PRODUCT_SALESClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LINK_STMS_PRODUCT_SALES.class
					.getClassLoader().getResourceAsStream(
							"deepsea/link_stms_product_sales_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = LINK_STMS_PRODUCT_SALES.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : LINK_STMS_PRODUCT_SALES");
		}
...
/************************************************************************************************
 * 154804 characters generated by Talend Open Studio for Big Data on the 15
 * November, 2018 4:14:20 PM ICT
 ************************************************************************************************/
