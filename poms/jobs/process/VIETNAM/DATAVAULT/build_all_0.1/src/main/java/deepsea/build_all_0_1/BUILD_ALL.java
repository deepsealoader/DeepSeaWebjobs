...
/**
 * Job: BUILD_ALL Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class BUILD_ALL implements TalendJob {
	...
	private final String jobName = "BUILD_ALL";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(BUILD_ALL.this, new Object[] { e,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.hub_stms_customer_0_1.HUB_STMS_CUSTOMER childJob_tRunJob_1 = new deepsea.hub_stms_customer_0_1.HUB_STMS_CUSTOMER();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.sat_stms_customer_0_1.SAT_STMS_CUSTOMER childJob_tRunJob_3 = new deepsea.sat_stms_customer_0_1.SAT_STMS_CUSTOMER();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.hub_stms_product_0_1.HUB_STMS_PRODUCT childJob_tRunJob_2 = new deepsea.hub_stms_product_0_1.HUB_STMS_PRODUCT();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.sat_stms_product_0_1.SAT_STMS_PRODUCT childJob_tRunJob_4 = new deepsea.sat_stms_product_0_1.SAT_STMS_PRODUCT();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.hub_stms_sales_0_1.HUB_STMS_SALES childJob_tRunJob_5 = new deepsea.hub_stms_sales_0_1.HUB_STMS_SALES();
				// pass DataSources
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tRunJob_5:OnSubjobOk1",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tRunJob_5:OnSubjobOk2",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.sat_stms_sales_0_1.SAT_STMS_SALES childJob_tRunJob_6 = new deepsea.sat_stms_sales_0_1.SAT_STMS_SALES();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.link_stms_customer_sales_0_1.LINK_STMS_CUSTOMER_SALES childJob_tRunJob_7 = new deepsea.link_stms_customer_sales_0_1.LINK_STMS_CUSTOMER_SALES();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.link_stms_product_sales_0_1.LINK_STMS_PRODUCT_SALES childJob_tRunJob_8 = new deepsea.link_stms_product_sales_0_1.LINK_STMS_PRODUCT_SALES();
				// pass DataSources
	...
	public void tRunJob_9Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.hub_zuelig_sales_0_1.HUB_ZUELIG_SALES childJob_tRunJob_9 = new deepsea.hub_zuelig_sales_0_1.HUB_ZUELIG_SALES();
				// pass DataSources
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.sat_zuelig_sales_0_1.SAT_ZUELIG_SALES childJob_tRunJob_10 = new deepsea.sat_zuelig_sales_0_1.SAT_ZUELIG_SALES();
				// pass DataSources
	...
	public void tRunJob_11Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.link_zuelig_product_sales_0_1.LINK_ZUELIG_PRODUCT_SALES childJob_tRunJob_11 = new deepsea.link_zuelig_product_sales_0_1.LINK_ZUELIG_PRODUCT_SALES();
				// pass DataSources
	...
	public static void main(String[] args) {
		final BUILD_ALL BUILD_ALLClass = new BUILD_ALL();

		int exitCode = BUILD_ALLClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUILD_ALL.class.getClassLoader()
					.getResourceAsStream(
							"deepsea/build_all_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = BUILD_ALL.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : BUILD_ALL");
		}
...
/************************************************************************************************
 * 98186 characters generated by Talend Open Studio for Big Data on the 15
 * November, 2018 4:00:51 PM ICT
 ************************************************************************************************/
