...
package deepsea.hub_stms_sales_0_1;
...
/**
 * Job: HUB_STMS_SALES Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HUB_STMS_SALES implements TalendJob {
	...
	private final String jobName = "HUB_STMS_SALES";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					HUB_STMS_SALES.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(HUB_STMS_SALES.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_HUB_STMS_SALES = new byte[0];
		static byte[] commonByteArray_DEEPSEA_HUB_STMS_SALES = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_HUB_STMS_SALES.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_HUB_STMS_SALES.length == 0) {
						commonByteArray_DEEPSEA_HUB_STMS_SALES = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_HUB_STMS_SALES = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_HUB_STMS_SALES, 0, length);
				strReturn = new String(commonByteArray_DEEPSEA_HUB_STMS_SALES,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_HUB_STMS_SALES) {
				...
				try {
					...
					this.BK1_InvoiceNumber = readString(dis);

					this.BK2_InvoiceDate = readDate(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.BK1_InvoiceNumber, dos);

				// java.util.Date

				writeDate(this.BK2_InvoiceDate, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "HUB_SALES";
				} else {
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						+ tableName_tDBOutput_1
						+ "] ([ID],[Source],[LoadDate],[BK1_InvoiceNumber],[BK2_InvoiceDate],[BK3_SalesID]) VALUES (?,?,?,?,?,?)";
				...
				String dbquery_tDBInput_1 = "SELECT\n	InvoiceNumber,\n	InvoiceDate,\n	SalesID\nFROM\n	dbo.TSalling\nWHERE\n	ProductID <> 0 AND InvoiceDate IS NOT NUL"
						+ "L AND dbo.TSalling.DistributorID=1";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						row4 = null;
						row3 = null;
						if (row1.InvoiceNumber == null) {
							finder_tUniqRow_1.InvoiceNumber = null;
						} else {
							finder_tUniqRow_1.InvoiceNumber = row1.InvoiceNumber
									.toLowerCase();
						}
						finder_tUniqRow_1.InvoiceDate = row1.InvoiceDate;
						finder_tUniqRow_1.SalesID = row1.SalesID;
						finder_tUniqRow_1.hashCodeDirty = true;
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

							if (row1.InvoiceNumber == null) {
								new_tUniqRow_1.InvoiceNumber = null;
							} else {
								new_tUniqRow_1.InvoiceNumber = row1.InvoiceNumber
										.toLowerCase();
							}
							new_tUniqRow_1.InvoiceDate = row1.InvoiceDate;
							new_tUniqRow_1.SalesID = row1.SalesID;
							...
							row3.InvoiceNumber = row1.InvoiceNumber;
							row3.InvoiceDate = row1.InvoiceDate;
							row3.SalesID = row1.SalesID;
							...
							row4.InvoiceNumber = row1.InvoiceNumber;
							row4.InvoiceDate = row1.InvoiceDate;
							row4.SalesID = row1.SalesID;
						...
						if (row3 != null) {
							...
							{ // start of Var scope
								...
								// # Output table : 'row2'
								row2_tmp.ID = Numeric.sequence("HUB_SALES", 1,
										1);
								row2_tmp.Source = "STMS";
								row2_tmp.LoadDate = new Date();
								row2_tmp.BK1_InvoiceNumber = row3.InvoiceNumber;
								row2_tmp.BK2_InvoiceDate = row3.InvoiceDate;
								row2_tmp.BK3_SalesID = String
										.valueOf(row3.SalesID);
								row2 = row2_tmp;
								// ###############################
							...
							if (row2 != null) {
								...
								if (row2.BK1_InvoiceNumber == null) {
									pstmt_tDBOutput_1.setNull(4,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4,
											row2.BK1_InvoiceNumber);
								}

								if (row2.BK2_InvoiceDate != null) {
									pstmt_tDBOutput_1.setTimestamp(
											5,
											new java.sql.Timestamp(
													row2.BK2_InvoiceDate
															.getTime()));
								} else {
	...
	public static void main(String[] args) {
		final HUB_STMS_SALES HUB_STMS_SALESClass = new HUB_STMS_SALES();

		int exitCode = HUB_STMS_SALESClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HUB_STMS_SALES.class
					.getClassLoader().getResourceAsStream(
							"deepsea/hub_stms_sales_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = HUB_STMS_SALES.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : HUB_STMS_SALES");
		}
...
/************************************************************************************************
 * 101728 characters generated by Talend Open Studio for Big Data on the 15
 * November, 2018 4:02:31 PM ICT
 ************************************************************************************************/
