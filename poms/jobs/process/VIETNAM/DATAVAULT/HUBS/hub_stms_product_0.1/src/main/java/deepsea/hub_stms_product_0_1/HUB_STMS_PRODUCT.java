...
package deepsea.hub_stms_product_0_1;
...
/**
 * Job: HUB_STMS_PRODUCT Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HUB_STMS_PRODUCT implements TalendJob {
	...
	private final String jobName = "HUB_STMS_PRODUCT";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					HUB_STMS_PRODUCT.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(HUB_STMS_PRODUCT.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_HUB_STMS_PRODUCT = new byte[0];
		static byte[] commonByteArray_DEEPSEA_HUB_STMS_PRODUCT = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_HUB_STMS_PRODUCT.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_HUB_STMS_PRODUCT.length == 0) {
						commonByteArray_DEEPSEA_HUB_STMS_PRODUCT = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_HUB_STMS_PRODUCT = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_HUB_STMS_PRODUCT, 0,
						length);
				strReturn = new String(
						commonByteArray_DEEPSEA_HUB_STMS_PRODUCT, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_HUB_STMS_PRODUCT) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "HUB_PRODUCT";
				} else {
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						+ tableName_tDBOutput_1
						+ "] ([ID],[Source],[LoadDate],[BK1_ShortName],[BK2_BoxQty],[BK3_SAPCode]) VALUES (?,?,?,?,?,?)";
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime
									* result
									+ ((this.Shortcut == null) ? 0
											: this.Shortcut.hashCode());

							result = prime
									* result
									+ ((this.BoxQty == null) ? 0 : this.BoxQty
											.hashCode());

							result = prime
									* result
									+ ((this.SAP_Code == null) ? 0
											: this.SAP_Code.hashCode());
					...
					public boolean equals(Object obj) {
						...
						if (this.BoxQty == null) {
							if (other.BoxQty != null)
								return false;

						} else if (!this.BoxQty.equals(other.BoxQty))

							return false;

						if (this.SAP_Code == null) {
							if (other.SAP_Code != null)
								return false;

						} else if (!this.SAP_Code.equals(other.SAP_Code))
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						row4 = null;
						row3 = null;
						if (row1.Shortcut == null) {
							finder_tUniqRow_1.Shortcut = null;
						} else {
							finder_tUniqRow_1.Shortcut = row1.Shortcut
									.toLowerCase();
						}
						finder_tUniqRow_1.BoxQty = row1.BoxQty;
						if (row1.SAP_Code == null) {
							finder_tUniqRow_1.SAP_Code = null;
						} else {
							finder_tUniqRow_1.SAP_Code = row1.SAP_Code
									.toLowerCase();
						}
						...
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							...
							if (row1.Shortcut == null) {
								new_tUniqRow_1.Shortcut = null;
							} else {
								new_tUniqRow_1.Shortcut = row1.Shortcut
										.toLowerCase();
							}
							new_tUniqRow_1.BoxQty = row1.BoxQty;
							if (row1.SAP_Code == null) {
								new_tUniqRow_1.SAP_Code = null;
							} else {
								new_tUniqRow_1.SAP_Code = row1.SAP_Code
										.toLowerCase();
							}
							...
							row3.Shortcut = row1.Shortcut;
							row3.BoxQty = row1.BoxQty;
							row3.SAP_Code = row1.SAP_Code;
							...
							row4.Shortcut = row1.Shortcut;
							row4.BoxQty = row1.BoxQty;
							row4.SAP_Code = row1.SAP_Code;
						...
						if (row3 != null) {
							...
							{ // start of Var scope
								...
								// # Output table : 'row2'
								row2_tmp.ID = Numeric.sequence("HUB_PRODUCT",
										1, 1);
								row2_tmp.Source = "STMS";
								row2_tmp.LoadDate = new Date();
								row2_tmp.BK1_ShortName = row3.Shortcut;
								row2_tmp.BK2_BoxQty = row3.BoxQty;
								row2_tmp.BK3_SAPCode = row3.SAP_Code;
								row2 = row2_tmp;
								// ###############################
							...
							if (row2 != null) {
								...
								if (row2.BK2_BoxQty == null) {
									pstmt_tDBOutput_1.setNull(5,
											java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1
											.setInt(5, row2.BK2_BoxQty);
								}

								if (row2.BK3_SAPCode == null) {
						...
						if (row4 != null) {
							...
							if (row4.Shortcut != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(row4.Shortcut));
							...
							if (row4.SAP_Code != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(row4.SAP_Code));
	...
	public static void main(String[] args) {
		final HUB_STMS_PRODUCT HUB_STMS_PRODUCTClass = new HUB_STMS_PRODUCT();

		int exitCode = HUB_STMS_PRODUCTClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HUB_STMS_PRODUCT.class
					.getClassLoader().getResourceAsStream(
							"deepsea/hub_stms_product_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = HUB_STMS_PRODUCT.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : HUB_STMS_PRODUCT");
		}
...
/************************************************************************************************
 * 101197 characters generated by Talend Open Studio for Big Data on the 15
 * November, 2018 4:02:18 PM ICT
 ************************************************************************************************/
