...
package deepsea.hub_stms_customer_0_1;
...
/**
 * Job: HUB_STMS_CUSTOMER Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HUB_STMS_CUSTOMER implements TalendJob {
	...
	private final String jobName = "HUB_STMS_CUSTOMER";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					HUB_STMS_CUSTOMER.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(HUB_STMS_CUSTOMER.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_HUB_STMS_CUSTOMER = new byte[0];
		static byte[] commonByteArray_DEEPSEA_HUB_STMS_CUSTOMER = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_HUB_STMS_CUSTOMER.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_HUB_STMS_CUSTOMER.length == 0) {
						commonByteArray_DEEPSEA_HUB_STMS_CUSTOMER = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_HUB_STMS_CUSTOMER = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_HUB_STMS_CUSTOMER, 0,
						length);
				strReturn = new String(
						commonByteArray_DEEPSEA_HUB_STMS_CUSTOMER, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_HUB_STMS_CUSTOMER) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "HUB_CUSTOMER";
				} else {
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						+ tableName_tDBOutput_1
						+ "] ([ID],[Source],[LoadDate],[BK1_Old],[BK2_New]) VALUES (?,?,?,?,?)";
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime
									* result
									+ ((this.BK_OLD == null) ? 0 : this.BK_OLD
											.hashCode());

							result = prime
									* result
									+ ((this.BK_NEW == null) ? 0 : this.BK_NEW
											.hashCode());
					...
					public boolean equals(Object obj) {
						...
						if (this.BK_OLD == null) {
							if (other.BK_OLD != null)
								return false;

						} else if (!this.BK_OLD.equals(other.BK_OLD))

							return false;

						if (this.BK_NEW == null) {
							if (other.BK_NEW != null)
								return false;

						} else if (!this.BK_NEW.equals(other.BK_NEW))
				...
				String dbquery_tDBInput_1 = "SELECT DISTINCT\n	DistributorCustomerID AS BK_OLD,\n	Code_Servier AS BK_NEW\nFROM\n	dbo.TCUSTOMER\n		LEFT JOIN dbo.TMAPC"
						+ "USTOMER ON dbo.TCUSTOMER.CustomerID=dbo.TMAPCUSTOMER.CustomerID\nWHERE\n	(DistributorCustomerID <> '' OR DistributorCust"
						+ "omerID IS NOT  NULL)\nAND\n	(Code_Servier <> '' OR Code_Servier IS NOT  NULL)\nAND\n	DistributorID = 1";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						row3 = null;
						if (row1.BK_OLD == null) {
							finder_tUniqRow_1.BK_OLD = null;
						} else {
							finder_tUniqRow_1.BK_OLD = row1.BK_OLD
									.toLowerCase();
						}
						if (row1.BK_NEW == null) {
							finder_tUniqRow_1.BK_NEW = null;
						} else {
							finder_tUniqRow_1.BK_NEW = row1.BK_NEW
									.toLowerCase();
						}
						...
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							...
							if (row1.BK_OLD == null) {
								new_tUniqRow_1.BK_OLD = null;
							} else {
								new_tUniqRow_1.BK_OLD = row1.BK_OLD
										.toLowerCase();
							}
							if (row1.BK_NEW == null) {
								new_tUniqRow_1.BK_NEW = null;
							} else {
								new_tUniqRow_1.BK_NEW = row1.BK_NEW
										.toLowerCase();
							}
							...
							row3.BK_OLD = row1.BK_OLD;
							row3.BK_NEW = row1.BK_NEW;
							...
							row4.BK_OLD = row1.BK_OLD;
							row4.BK_NEW = row1.BK_NEW;
						...
						if (row3 != null) {
							...
							{ // start of Var scope
								...
								// # Output table : 'row2'
								row2_tmp.ID = Numeric.sequence("HUB_CUSTOMER",
										1, 1);
								row2_tmp.Source = "STMS";
								row2_tmp.LoadDate = new Date();
								row2_tmp.BK1_Old = row3.BK_OLD;
								row2_tmp.BK2_New = row3.BK_NEW;
								row2 = row2_tmp;
								// ###############################
							...
							if (row2 != null) {
								...
								if (row2.BK1_Old == null) {
									pstmt_tDBOutput_1.setNull(4,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1
											.setString(4, row2.BK1_Old);
								}

								if (row2.BK2_New == null) {
									pstmt_tDBOutput_1.setNull(5,
											java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1
											.setString(5, row2.BK2_New);
								}
	...
	public static void main(String[] args) {
		final HUB_STMS_CUSTOMER HUB_STMS_CUSTOMERClass = new HUB_STMS_CUSTOMER();

		int exitCode = HUB_STMS_CUSTOMERClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = HUB_STMS_CUSTOMER.class
					.getClassLoader().getResourceAsStream(
							"deepsea/hub_stms_customer_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = HUB_STMS_CUSTOMER.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : HUB_STMS_CUSTOMER");
		}
...
/************************************************************************************************
 * 97277 characters generated by Talend Open Studio for Big Data on the 15
 * November, 2018 4:02:04 PM ICT
 ************************************************************************************************/
