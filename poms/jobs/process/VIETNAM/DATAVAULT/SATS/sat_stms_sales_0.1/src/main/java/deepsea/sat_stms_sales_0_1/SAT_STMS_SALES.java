...
package deepsea.sat_stms_sales_0_1;
...
/**
 * Job: SAT_STMS_SALES Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAT_STMS_SALES implements TalendJob {
	...
	private final String jobName = "SAT_STMS_SALES";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SAT_STMS_SALES.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SAT_STMS_SALES.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_SAT_STMS_SALES = new byte[0];
		static byte[] commonByteArray_DEEPSEA_SAT_STMS_SALES = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_SAT_STMS_SALES.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_SAT_STMS_SALES.length == 0) {
						commonByteArray_DEEPSEA_SAT_STMS_SALES = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_SAT_STMS_SALES = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_SAT_STMS_SALES, 0, length);
				strReturn = new String(commonByteArray_DEEPSEA_SAT_STMS_SALES,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_SAT_STMS_SALES) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "SAT_STMS_SALES";
				} else {
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						+ tableName_tDBOutput_1
						+ "] ([ID],[HUB_ID],[Source],[LoadDate],[Quantity],[Price]) VALUES (?,?,?,?,?,?)";
				...
				String dbquery_tDBInput_1 = "SELECT\n	InvoiceNumber,\n	InvoiceDate,\n	SalesID,\n	Quantity,\n	Price\nFROM\n	dbo.TSalling\nWHERE\n	ProductID <> 0 AND I"
						+ "nvoiceDate IS NOT NULL AND dbo.TSalling.DistributorID=1";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row1.InvoiceDate = mssqlGTU_tDBInput_1.getDate(
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							if (rs_tDBInput_1.getObject(3) != null) {
								row1.SalesID = rs_tDBInput_1.getLong(3);
							} else {
						...
						if (colQtyInRs_tDBInput_1 < 5) {
							...
							if (rs_tDBInput_1.getObject(5) != null) {
								row1.Price = rs_tDBInput_1.getBigDecimal(5);
							} else {
								row1.Price = null;
							}
						}
						...
						{ // start of Var scope
							...
							// # Filter conditions
							if (rejectedInnerJoin_tMap_1) {
								exception1_tmp.InvoiceNumber = row1.InvoiceNumber;
								exception1_tmp.InvoiceDate = row1.InvoiceDate;
								exception1_tmp.SalesID = row1.SalesID;
								exception1_tmp.Quantity = row1.Quantity;
								exception1_tmp.Price = row1.Price;
						...
						if (row2 != null) {
							...
							if (row2.Quantity == null) {
								...
								pstmt_tDBOutput_1.setInt(5, row2.Quantity);
							}

							pstmt_tDBOutput_1.setBigDecimal(6, row2.Price);
						...
						if (exception1 != null) {
							...
							if (exception1.InvoiceNumber != null) { //

								strBuffer_tLogRow_2.append(String
										.valueOf(exception1.InvoiceNumber));

							} //

							strBuffer_tLogRow_2.append("|");

							if (exception1.InvoiceDate != null) { //

								strBuffer_tLogRow_2.append(FormatterUtils
										.format_Date(exception1.InvoiceDate,
												"yyyy-MM-dd"));
							...
							if (exception1.Quantity != null) { //

								strBuffer_tLogRow_2.append(String
										.valueOf(exception1.Quantity));

							} //

							strBuffer_tLogRow_2.append("|");

							if (exception1.Price != null) { //

								strBuffer_tLogRow_2.append(exception1.Price
										.setScale(4,
	...
	public static void main(String[] args) {
		final SAT_STMS_SALES SAT_STMS_SALESClass = new SAT_STMS_SALES();

		int exitCode = SAT_STMS_SALESClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SAT_STMS_SALES.class
					.getClassLoader().getResourceAsStream(
							"deepsea/sat_stms_sales_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = SAT_STMS_SALES.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : SAT_STMS_SALES");
		}
...
/************************************************************************************************
 * 121828 characters generated by Talend Open Studio for Big Data on the 15
 * November, 2018 4:18:25 PM ICT
 ************************************************************************************************/
