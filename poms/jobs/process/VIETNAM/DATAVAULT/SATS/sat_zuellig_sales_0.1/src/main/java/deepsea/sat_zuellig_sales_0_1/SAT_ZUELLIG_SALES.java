...
package deepsea.sat_zuellig_sales_0_1;
...
/**
 * Job: SAT_ZUELLIG_SALES Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAT_ZUELLIG_SALES implements TalendJob {
	...
	private final String jobName = "SAT_ZUELLIG_SALES";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SAT_ZUELLIG_SALES.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SAT_ZUELLIG_SALES.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_SAT_ZUELLIG_SALES = new byte[0];
		static byte[] commonByteArray_DEEPSEA_SAT_ZUELLIG_SALES = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_SAT_ZUELLIG_SALES.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_SAT_ZUELLIG_SALES.length == 0) {
						commonByteArray_DEEPSEA_SAT_ZUELLIG_SALES = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_SAT_ZUELLIG_SALES = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_SAT_ZUELLIG_SALES, 0,
						length);
				strReturn = new String(
						commonByteArray_DEEPSEA_SAT_ZUELLIG_SALES, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_SAT_ZUELLIG_SALES) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "SAT_ZUELLIG_SALES";
				} else {
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						+ tableName_tDBOutput_1
						+ "] ([ID],[HUB_ID],[Source],[LoadDate],[Quantity]) VALUES (?,?,?,?,?)";
					...
					while (fid_tFileInputDelimited_1 != null
						...
						if (row1 != null) {
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								row3HashKey.BK3_SalesID = TalendString
										.unionString("-", row1.InvoiceNumber,
							...
							{ // start of Var scope
								...
								if (!rejectedInnerJoin_tMap_1) {
									...
									row1.InvoiceDate != null
										...
										row2_tmp.ID = Numeric.sequence(
												"SAT_ZUELIG_SALES", 1, 1);
										row2_tmp.HUB_ID = row3.ID;
										row2_tmp.Source = "ZUELLIG";
								...
								if (rejectedInnerJoin_tMap_1
									...
									exception1_tmp.InvoiceLineNumber = row1.InvoiceLineNumber;
									exception1_tmp.InvoiceDate = row1.InvoiceDate;
									exception1_tmp.ProductCode = row1.ProductCode;
							...
							if (exception1 != null) {
								...
								if (exception1.InvoiceLineNumber != null) { //

									strBuffer_tLogRow_1
											.append(String
													.valueOf(exception1.InvoiceLineNumber));
								...
								if (exception1.InvoiceDate != null) { //
									...
									strBuffer_tLogRow_1.append(String
											.valueOf(exception1.InvoiceDate));

								} //

								strBuffer_tLogRow_1.append("|");

								if (exception1.ProductCode != null) { //

									strBuffer_tLogRow_1.append(String
											.valueOf(exception1.ProductCode));
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
									...
									row3.BK1_InvoiceNumber = tmpContent_tDBInput_1;
								}
							} else {
								row3.BK1_InvoiceNumber = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row3.BK2_InvoiceDate = mssqlGTU_tDBInput_1.getDate(
									rsmd_tDBInput_1, rs_tDBInput_1, 3);
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
									...
									row3.BK3_SalesID = tmpContent_tDBInput_1;
								}
							} else {
								row3.BK3_SalesID = null;
							}
	...
	public static void main(String[] args) {
		final SAT_ZUELLIG_SALES SAT_ZUELLIG_SALESClass = new SAT_ZUELLIG_SALES();

		int exitCode = SAT_ZUELLIG_SALESClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SAT_ZUELLIG_SALES.class
					.getClassLoader().getResourceAsStream(
							"deepsea/sat_zuellig_sales_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = SAT_ZUELLIG_SALES.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : SAT_ZUELLIG_SALES");
		}
...
/************************************************************************************************
 * 121240 characters generated by Talend Open Studio for Big Data on the 15
 * November, 2018 4:21:03 PM ICT
 ************************************************************************************************/
