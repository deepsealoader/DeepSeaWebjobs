...
package deepsea.sat_stms_customer_0_1;
...
/**
 * Job: SAT_STMS_CUSTOMER Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAT_STMS_CUSTOMER implements TalendJob {
	...
	private final String jobName = "SAT_STMS_CUSTOMER";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SAT_STMS_CUSTOMER.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SAT_STMS_CUSTOMER.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_SAT_STMS_CUSTOMER = new byte[0];
		static byte[] commonByteArray_DEEPSEA_SAT_STMS_CUSTOMER = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_SAT_STMS_CUSTOMER.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_SAT_STMS_CUSTOMER.length == 0) {
						commonByteArray_DEEPSEA_SAT_STMS_CUSTOMER = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_SAT_STMS_CUSTOMER = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_SAT_STMS_CUSTOMER, 0,
						length);
				strReturn = new String(
						commonByteArray_DEEPSEA_SAT_STMS_CUSTOMER, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_SAT_STMS_CUSTOMER) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "SAT_STMS_CUSTOMER";
				} else {
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						+ tableName_tDBOutput_1
						+ "] ([ID],[HUB_ID],[Source],[LoadDate],[CustomerName],[ContactName],[Address]) VALUES (?,?,?,?,?,?,?)";
				...
				String dbquery_tDBInput_1 = "SELECT DISTINCT\n	DistributorCustomerID AS BK_OLD,\n	Code_Servier AS BK_NEW,\n	dbo.TCUSTOMER.CustomerName,\n	dbo.TCUSTO"
						+ "MER.ContactName,\n	dbo.TCUSTOMER.Address\nFROM\n	dbo.TCUSTOMER\n		LEFT JOIN dbo.TMAPCUSTOMER ON dbo.TCUSTOMER.CustomerID"
						+ "=dbo.TMAPCUSTOMER.CustomerID\nWHERE\n	(DistributorCustomerID <> '' OR DistributorCustomerID IS NOT  NULL)\nAND\n	(Code_S"
						+ "ervier <> '' OR Code_Servier IS NOT  NULL)\nAND\n	DistributorID = 1";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
										.contains(rsmd_tDBInput_1
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.CustomerName = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.CustomerName = tmpContent_tDBInput_1;
								}
							} else {
								row1.CustomerName = null;
							}
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
										.contains(rsmd_tDBInput_1
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.ContactName = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_1);
								} else {
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row3HashKey.BK1_Old = row1.BK_OLD;

							row3HashKey.BK2_New = row1.BK_NEW;
						...
						if (tHash_Lookup_row3 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.BK1_Old = '"
							// + row3HashKey.BK1_Old + "', row3.BK2_New = '" +
							// row3HashKey.BK2_New + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							// # Filter conditions
							if (rejectedInnerJoin_tMap_1) {
								exception1_tmp.BK_OLD = row1.BK_OLD;
								exception1_tmp.BK_NEW = row1.BK_NEW;
								exception1_tmp.CustomerName = row1.CustomerName;
								exception1_tmp.ContactName = row1.ContactName;
								exception1_tmp.Address = row1.Address;
						...
						if (row2 != null) {
							...
							if (row2.ContactName == null) {
								pstmt_tDBOutput_1.setNull(6,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1
										.setString(6, row2.ContactName);
							}
							...
							if (row2.Address == null) {
								...
								pstmt_tDBOutput_1.setString(7, row2.Address);
							}
						...
						if (exception1 != null) {
							...
							if (exception1.BK_OLD != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.BK_OLD));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception1.BK_NEW != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.BK_NEW));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception1.CustomerName != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.CustomerName));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception1.ContactName != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.ContactName));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception1.Address != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.Address));
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row3.BK1_Old = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row3.BK1_Old = tmpContent_tDBInput_2;
								}
							} else {
								row3.BK1_Old = null;
							}
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row3.BK2_New = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row3.BK2_New = tmpContent_tDBInput_2;
								}
							} else {
								row3.BK2_New = null;
							}
						...
						row3_HashRow.BK1_Old = row3.BK1_Old;

						row3_HashRow.BK2_New = row3.BK2_New;
	...
	public static void main(String[] args) {
		final SAT_STMS_CUSTOMER SAT_STMS_CUSTOMERClass = new SAT_STMS_CUSTOMER();

		int exitCode = SAT_STMS_CUSTOMERClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SAT_STMS_CUSTOMER.class
					.getClassLoader().getResourceAsStream(
							"deepsea/sat_stms_customer_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = SAT_STMS_CUSTOMER.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : SAT_STMS_CUSTOMER");
		}
...
/************************************************************************************************
 * 118739 characters generated by Talend Open Studio for Big Data on the 15
 * November, 2018 4:18:05 PM ICT
 ************************************************************************************************/
