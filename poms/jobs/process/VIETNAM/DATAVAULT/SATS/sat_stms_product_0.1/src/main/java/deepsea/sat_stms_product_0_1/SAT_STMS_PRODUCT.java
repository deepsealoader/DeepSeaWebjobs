...
package deepsea.sat_stms_product_0_1;
...
/**
 * Job: SAT_STMS_PRODUCT Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAT_STMS_PRODUCT implements TalendJob {
	...
	private final String jobName = "SAT_STMS_PRODUCT";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SAT_STMS_PRODUCT.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SAT_STMS_PRODUCT.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_SAT_STMS_PRODUCT = new byte[0];
		static byte[] commonByteArray_DEEPSEA_SAT_STMS_PRODUCT = new byte[0];
		...
		public void copyDataTo(row2Struct other) {
			...
			other.ID = this.ID;
			other.HUB_ID = this.HUB_ID;
			other.Source = this.Source;
			other.LoadDate = this.LoadDate;
			other.ProductName = this.ProductName;
			other.Dose = this.Dose;
			other.BoxQty = this.BoxQty;
			other.IsPromote = this.IsPromote;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_SAT_STMS_PRODUCT.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_SAT_STMS_PRODUCT.length == 0) {
						commonByteArray_DEEPSEA_SAT_STMS_PRODUCT = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_SAT_STMS_PRODUCT = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_SAT_STMS_PRODUCT, 0,
						length);
				strReturn = new String(
						commonByteArray_DEEPSEA_SAT_STMS_PRODUCT, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_SAT_STMS_PRODUCT) {
				...
				try {
					...
					if (length == -1) {
						...
						this.IsPromote = dis.readBoolean();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.IsPromote == null) {
					...
					dos.writeByte(0);
					dos.writeBoolean(this.IsPromote);
				}
	...
	public static class exception1Struct implements
		...
		public Integer BoxQty1;

		public Integer getBoxQty1() {
			return this.BoxQty1;
		}
		...
		public String toString() {
			...
			sb.append(",ProductName=" + ProductName);
			sb.append(",Dose=" + Dose);
			sb.append(",BoxQty1=" + String.valueOf(BoxQty1));
			sb.append(",IsPromote=" + String.valueOf(IsPromote));
			sb.append(",Status=" + String.valueOf(Status));
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "SAT_STMS_PRODUCT";
				} else {
				...
				String insert_tDBOutput_1 = "INSERT INTO ["
						+ tableName_tDBOutput_1
						+ "] ([ID],[HUB_ID],[Source],[LoadDate],[ProductName],[Dose],[BoxQty],[IsPromote],[Status]) VALUES (?,?,?,?,?,?,?,?,?)";
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (rs_tDBInput_1.getObject(2) != null) {
								row1.BoxQty = rs_tDBInput_1.getInt(2);
							} else {
								row1.BoxQty = null;
							}
						}
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
										.contains(rsmd_tDBInput_1
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.SAP_Code = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.SAP_Code = tmpContent_tDBInput_1;
								}
							} else {
								row1.SAP_Code = null;
							}
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
										.contains(rsmd_tDBInput_1
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.ProductName = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_1);
								} else {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1
										.contains(rsmd_tDBInput_1
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row1.Dose = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.Dose = tmpContent_tDBInput_1;
								}
							} else {
								row1.Dose = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							if (rs_tDBInput_1.getObject(6) != null) {
								row1.BoxQty1 = rs_tDBInput_1.getInt(6);
							} else {
								row1.BoxQty1 = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							if (rs_tDBInput_1.getObject(7) != null) {
								row1.IsPromote = rs_tDBInput_1.getBoolean(7);
							} else {
								row1.IsPromote = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							if (rs_tDBInput_1.getObject(8) != null) {
								row1.Status = rs_tDBInput_1.getInt(8);
							} else {
								row1.Status = null;
							}
						}
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row3HashKey.BK1_ShortName = row1.Shortcut;

							row3HashKey.BK2_BoxQty = row1.BoxQty;
						...
						if (tHash_Lookup_row3 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.BK1_ShortName = '"
							// + row3HashKey.BK1_ShortName +
							// "', row3.BK2_BoxQty = '" + row3HashKey.BK2_BoxQty
							// + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							if (!rejectedInnerJoin_tMap_1) {
								...
								// # Output table : 'row2'
								row2_tmp.ID = Numeric.sequence("SAT_PRODUCT",
										1, 1);
								row2_tmp.HUB_ID = row3.ID;
								row2_tmp.Source = "STMS";
								row2_tmp.LoadDate = new Date();
								row2_tmp.ProductName = row1.ProductName;
								row2_tmp.Dose = row1.Dose;
								row2_tmp.BoxQty = row1.BoxQty1;
								row2_tmp.IsPromote = row1.IsPromote;
								row2_tmp.Status = row1.Status;
								row2 = row2_tmp;
							...
							// # Filter conditions
							if (rejectedInnerJoin_tMap_1) {
								exception1_tmp.Shortcut = row1.Shortcut;
								exception1_tmp.BoxQty = row1.BoxQty;
								exception1_tmp.SAP_Code = row1.SAP_Code;
								exception1_tmp.ProductName = row1.ProductName;
								exception1_tmp.Dose = row1.Dose;
								exception1_tmp.BoxQty1 = row1.BoxQty1;
								exception1_tmp.IsPromote = row1.IsPromote;
								exception1_tmp.Status = row1.Status;
						...
						if (row2 != null) {
							...
							pstmt_tDBOutput_1.setInt(2, row2.HUB_ID);

							if (row2.Source == null) {
								pstmt_tDBOutput_1.setNull(3,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3, row2.Source);
							}

							if (row2.LoadDate != null) {
								pstmt_tDBOutput_1.setTimestamp(
										4,
										new java.sql.Timestamp(row2.LoadDate
												.getTime()));
							} else {
							...
							if (row2.Dose == null) {
								...
								pstmt_tDBOutput_1.setString(6, row2.Dose);
							}
							...
							if (row2.BoxQty == null) {
								...
								pstmt_tDBOutput_1.setInt(7, row2.BoxQty);
							}

							if (row2.IsPromote == null) {
								pstmt_tDBOutput_1.setNull(8,
										java.sql.Types.BOOLEAN);
							} else {
								pstmt_tDBOutput_1.setBoolean(8, row2.IsPromote);
							}
							...
							if (row2.Status == null) {
								...
								pstmt_tDBOutput_1.setInt(9, row2.Status);
							}
						...
						if (exception1 != null) {
							...
							if (exception1.Shortcut != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.Shortcut));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception1.BoxQty != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.BoxQty));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception1.SAP_Code != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.SAP_Code));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception1.ProductName != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.ProductName));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception1.Dose != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.Dose));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception1.BoxQty1 != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.BoxQty1));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception1.IsPromote != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.IsPromote));

							} //

							strBuffer_tLogRow_1.append("|");

							if (exception1.Status != null) { //

								strBuffer_tLogRow_1.append(String
										.valueOf(exception1.Status));
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2
										.contains(rsmd_tDBInput_2
												...
												.toUpperCase(
														java.util.Locale.ENGLISH))) {
									row3.BK1_ShortName = FormatterUtils
											.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row3.BK1_ShortName = tmpContent_tDBInput_2;
								}
							} else {
								row3.BK1_ShortName = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							row3.BK2_BoxQty = null;
						} else {

							if (rs_tDBInput_2.getObject(3) != null) {
								row3.BK2_BoxQty = rs_tDBInput_2.getInt(3);
							} else {
								row3.BK2_BoxQty = null;
							}
						}
						...
						row3_HashRow.BK1_ShortName = row3.BK1_ShortName;

						row3_HashRow.BK2_BoxQty = row3.BK2_BoxQty;
	...
	public static void main(String[] args) {
		final SAT_STMS_PRODUCT SAT_STMS_PRODUCTClass = new SAT_STMS_PRODUCT();

		int exitCode = SAT_STMS_PRODUCTClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SAT_STMS_PRODUCT.class
					.getClassLoader().getResourceAsStream(
							"deepsea/sat_stms_product_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = SAT_STMS_PRODUCT.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : SAT_STMS_PRODUCT");
		}
...
/************************************************************************************************
 * 126757 characters generated by Talend Open Studio for Big Data on the 15
 * November, 2018 4:18:17 PM ICT
 ************************************************************************************************/
