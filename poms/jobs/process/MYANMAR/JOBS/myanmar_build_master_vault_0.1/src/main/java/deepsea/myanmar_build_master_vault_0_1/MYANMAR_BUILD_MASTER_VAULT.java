...
package deepsea.myanmar_build_master_vault_0_1;
...
/**
 * Job: MYANMAR_BUILD_MASTER_VAULT Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class MYANMAR_BUILD_MASTER_VAULT implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "MYANMAR_BUILD_MASTER_VAULT";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MYANMAR_BUILD_MASTER_VAULT.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MYANMAR_BUILD_MASTER_VAULT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final MYANMAR_BUILD_MASTER_VAULT MYANMAR_BUILD_MASTER_VAULTClass = new MYANMAR_BUILD_MASTER_VAULT();

        int exitCode = MYANMAR_BUILD_MASTER_VAULTClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MYANMAR_BUILD_MASTER_VAULT.class.getClassLoader().getResourceAsStream("deepsea/myanmar_build_master_vault_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MYANMAR_BUILD_MASTER_VAULT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MYANMAR_BUILD_MASTER_VAULT");
        }
...
/************************************************************************************************
 *     67576 characters generated by Talend Open Studio for Big Data 
 *     on the March 19, 2019 3:38:53 PM SGT
 ************************************************************************************************/