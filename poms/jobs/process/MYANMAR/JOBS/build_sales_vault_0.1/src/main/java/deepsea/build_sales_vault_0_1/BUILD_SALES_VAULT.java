...
package deepsea.build_sales_vault_0_1;
...
/**
 * Job: BUILD_SALES_VAULT Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class BUILD_SALES_VAULT implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "BUILD_SALES_VAULT";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				BUILD_SALES_VAULT.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(BUILD_SALES_VAULT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		deepsea.check_schema_0_1.CHECK_SCHEMA childJob_tRunJob_4 = new deepsea.check_schema_0_1.CHECK_SCHEMA();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		deepsea.build_sales_links_0_1.BUILD_SALES_LINKS childJob_tRunJob_3 = new deepsea.build_sales_links_0_1.BUILD_SALES_LINKS();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final BUILD_SALES_VAULT BUILD_SALES_VAULTClass = new BUILD_SALES_VAULT();

        int exitCode = BUILD_SALES_VAULTClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = BUILD_SALES_VAULT.class.getClassLoader().getResourceAsStream("deepsea/build_sales_vault_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = BUILD_SALES_VAULT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : BUILD_SALES_VAULT");
        }
...
/************************************************************************************************
 *     58966 characters generated by Talend Open Studio for Big Data 
 *     on the October 15, 2018 4:56:23 PM CST
 ************************************************************************************************/