...
public class BUILD_SALES_VAULT implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(BUILD_SALES_VAULT.this, new Object[] { e,
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUILD_SALES_VAULT.class
					.getClassLoader().getResourceAsStream(
							"deepsea/build_sales_vault_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = BUILD_SALES_VAULT.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : BUILD_SALES_VAULT");
		}
...
/************************************************************************************************
 * 52333 characters generated by Talend Open Studio for Big Data on the 4
 * December, 2018 11:49:09 AM AEDT
 ************************************************************************************************/
