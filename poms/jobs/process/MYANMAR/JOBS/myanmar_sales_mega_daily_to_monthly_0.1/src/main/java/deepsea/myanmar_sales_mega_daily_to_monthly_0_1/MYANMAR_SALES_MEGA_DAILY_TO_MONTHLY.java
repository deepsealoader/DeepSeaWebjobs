...
package deepsea.myanmar_sales_mega_daily_to_monthly_0_1;
...
/**
 * Job: MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_nO6OILgPEei30bV-SVSjVA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY = new byte[0];
    static byte[] commonByteArray_DEEPSEA_MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY.length == 0) {
   					commonByteArray_DEEPSEA_MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		deepsea.myanmar_update_one_month_sales_0_1.MYANMAR_UPDATE_ONE_MONTH_SALES childJob_tRunJob_1 = new deepsea.myanmar_update_one_month_sales_0_1.MYANMAR_UPDATE_ONE_MONTH_SALES();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY MYANMAR_SALES_MEGA_DAILY_TO_MONTHLYClass = new MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY();

        int exitCode = MYANMAR_SALES_MEGA_DAILY_TO_MONTHLYClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY.class.getClassLoader().getResourceAsStream("deepsea/myanmar_sales_mega_daily_to_monthly_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MYANMAR_SALES_MEGA_DAILY_TO_MONTHLY");
        }
...
/************************************************************************************************
 *     330778 characters generated by Talend Open Studio for Big Data 
 *     on the March 19, 2019 3:17:16 PM SGT
 ************************************************************************************************/