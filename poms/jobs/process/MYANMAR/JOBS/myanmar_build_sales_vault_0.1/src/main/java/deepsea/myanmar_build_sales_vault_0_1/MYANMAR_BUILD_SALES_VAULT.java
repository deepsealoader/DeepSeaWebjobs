...
package deepsea.myanmar_build_sales_vault_0_1;
...
/**
 * Job: MYANMAR_BUILD_SALES_VAULT Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class MYANMAR_BUILD_SALES_VAULT implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "MYANMAR_BUILD_SALES_VAULT";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MYANMAR_BUILD_SALES_VAULT.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MYANMAR_BUILD_SALES_VAULT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			if (osName_tRunJob_1 != null && osName_tRunJob_1.toLowerCase().startsWith("win")){
		      			...
		      			paraList_tRunJob_1.add("java");
		        				...
		        				paraList_tRunJob_1.add(dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/advancedPersistentLookupLib-1.2.jar;../lib/commons-collections-3.2.2.jar;../lib/dom4j-1.6.1.jar;../lib/jboss-serialization.jar;../lib/log4j-1.2.15.jar;../lib/log4j-1.2.16.jar;../lib/mongo-java-driver-3.5.0.jar;../lib/postgresql-8.3-603.jdbc3.jar;../lib/trove.jar;hub_sales_0_1.jar;"));
		      					...
		      					paraList_tRunJob_1.add("deepsea.hub_sales_0_1.HUB_SALES");
	...
	java.util.List<String> paraList_tRunJob_3 = new java.util.ArrayList<String>();
			...
			if (osName_tRunJob_3 != null && osName_tRunJob_3.toLowerCase().startsWith("win")){
		      			...
		      			paraList_tRunJob_3.add("java");
		        				...
		        				paraList_tRunJob_3.add(dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(".;../lib/routines.jar;../lib/advancedPersistentLookupLib-1.2.jar;../lib/commons-codec-1.6.jar;../lib/commons-collections-3.2.2.jar;../lib/commons-collections4-4.1.jar;../lib/commons-httpclient-3.0.1.jar;../lib/commons-lang-2.6.jar;../lib/commons-lang3-3.6.jar;../lib/commons-logging-1.1.jar;../lib/dom4j-1.6.1.jar;../lib/geronimo-stax-api_1.0_spec-1.0.1.jar;../lib/jboss-serialization.jar;../lib/jcifs-1.3.0.jar;../lib/jersey-client-1.4.jar;../lib/jersey-core-1.4.jar;../lib/log4j-1.2.15.jar;../lib/log4j-1.2.16.jar;../lib/mongo-java-driver-3.5.0.jar;../lib/poi-3.16-20170419_modified_talend.jar;../lib/poi-ooxml-3.16-20170419_modified_talend.jar;../lib/poi-ooxml-schemas-3.16-20170419.jar;../lib/poi-scratchpad-3.16-20170419.jar;../lib/postgresql-8.3-603.jdbc3.jar;../lib/talendExcel-1.3-20180215.jar;../lib/trove.jar;../lib/xmlbeans-2.6.0.jar;myanmar_build_sales_links_0_1.jar;dsendexception_0_1.jar;myanmar_generate_customer_diff_0_1.jar;link_sales_0_1.jar;"));
		      				
		      					paraList_tRunJob_3.add("deepsea.myanmar_build_sales_links_0_1.MYANMAR_BUILD_SALES_LINKS");
 ...
 */
    ...
    public static void main(String[] args){
        final MYANMAR_BUILD_SALES_VAULT MYANMAR_BUILD_SALES_VAULTClass = new MYANMAR_BUILD_SALES_VAULT();

        int exitCode = MYANMAR_BUILD_SALES_VAULTClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MYANMAR_BUILD_SALES_VAULT.class.getClassLoader().getResourceAsStream("deepsea/myanmar_build_sales_vault_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MYANMAR_BUILD_SALES_VAULT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MYANMAR_BUILD_SALES_VAULT");
        }
...
/************************************************************************************************
 *     65683 characters generated by Talend Open Studio for Big Data 
 *     on the January 20, 2019 11:17:18 AM CST
 ************************************************************************************************/