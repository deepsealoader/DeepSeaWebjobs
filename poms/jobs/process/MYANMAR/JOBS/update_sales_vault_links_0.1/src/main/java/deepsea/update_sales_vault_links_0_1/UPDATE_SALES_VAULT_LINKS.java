...
package deepsea.update_sales_vault_links_0_1;
...
/**
 * Job: UPDATE_SALES_VAULT_LINKS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class UPDATE_SALES_VAULT_LINKS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "UPDATE_SALES_VAULT_LINKS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				UPDATE_SALES_VAULT_LINKS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(UPDATE_SALES_VAULT_LINKS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final UPDATE_SALES_VAULT_LINKS UPDATE_SALES_VAULT_LINKSClass = new UPDATE_SALES_VAULT_LINKS();

        int exitCode = UPDATE_SALES_VAULT_LINKSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = UPDATE_SALES_VAULT_LINKS.class.getClassLoader().getResourceAsStream("deepsea/update_sales_vault_links_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = UPDATE_SALES_VAULT_LINKS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : UPDATE_SALES_VAULT_LINKS");
        }
...
/************************************************************************************************
 *     48713 characters generated by Talend Open Studio for Big Data 
