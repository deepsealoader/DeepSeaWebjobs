...
package deepsea.build_master_vault_0_1;
...
/**
 * Job: BUILD_MASTER_VAULT Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class BUILD_MASTER_VAULT implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "BUILD_MASTER_VAULT";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				BUILD_MASTER_VAULT.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(BUILD_MASTER_VAULT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tMongoDBRow_3_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
				end_Hash.put(errorComponent, System.currentTimeMillis());
				
				((java.util.Map)threadLocal.get()).put("status", "failure");
				
					tMongoDBRow_3_onSubJobError(exception, errorComponent, globalMap);
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tMongoDBRow_3_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		deepsea.build_master_hubs_0_1.BUILD_MASTER_HUBS childJob_tRunJob_1 = new deepsea.build_master_hubs_0_1.BUILD_MASTER_HUBS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		deepsea.build_master_links_0_1.BUILD_MASTER_LINKS childJob_tRunJob_2 = new deepsea.build_master_links_0_1.BUILD_MASTER_LINKS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		deepsea.build_master_sats_0_1.BUILD_MASTER_SATS childJob_tRunJob_3 = new deepsea.build_master_sats_0_1.BUILD_MASTER_SATS();
	    // pass DataSources
...
end_Hash.put("tMongoDBConnection_1", System.currentTimeMillis());
				...
				tMongoDBRow_3Process(globalMap);
...
public void tMongoDBRow_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tMongoDBRow_3_SUBPROCESS_STATE", 0);
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		ok_Hash.put("tMongoDBRow_3", false);
		start_Hash.put("tMongoDBRow_3", System.currentTimeMillis());
		
	
	currentComponent="tMongoDBRow_3";

	
		int tos_count_tMongoDBRow_3 = 0;
		
    	class BytesLimit65535_tMongoDBRow_3{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tMongoDBRow_3().limitLog4jByte();
	com.mongodb.Mongo mongo_tMongoDBRow_3=null;
	com.mongodb.DB db_tMongoDBRow_3=null;
	
		mongo_tMongoDBRow_3=(com.mongodb.Mongo)globalMap.get("mongo_tMongoDBConnection_1");
		db_tMongoDBRow_3 = mongo_tMongoDBRow_3.getDB("DEEPSEA");
		
	com.mongodb.CommandResult result_tMongoDBRow_3=null;
...
/**
 * [tMongoDBRow_3 begin ] stop
 */
	
	/**
	 * [tMongoDBRow_3 main ] start
	 */
	...
	try{
			...
			result_tMongoDBRow_3=db_tMongoDBRow_3.doEval("db.exceptions.drop()");
		
		if(result_tMongoDBRow_3.ok()){
			
			    System.out.println(result_tMongoDBRow_3);
		    
		}else{
			
                System.out.println(result_tMongoDBRow_3);
		}
	} catch(Exception e_tMongoDBRow_3) {
		
			    System.err.println(e_tMongoDBRow_3.getMessage());
			    
	}
 


	tos_count_tMongoDBRow_3++;

/**
 * [tMongoDBRow_3 main ] stop
 */
	
	/**
	 * [tMongoDBRow_3 process_data_begin ] start
	 */
...
/**
 * [tMongoDBRow_3 process_data_begin ] stop
 */
	
	/**
	 * [tMongoDBRow_3 process_data_end ] start
	 */
...
/**
 * [tMongoDBRow_3 process_data_end ] stop
 */
	
	/**
	 * [tMongoDBRow_3 end ] start
	 */
...
ok_Hash.put("tMongoDBRow_3", true);
end_Hash.put("tMongoDBRow_3", System.currentTimeMillis());




/**
 * [tMongoDBRow_3 end ] stop
 */
				}//end the resume
 ...
 */
		...
		globalMap.put("tMongoDBRow_3_SUBPROCESS_STATE", 1);
	}
    ...
    public static void main(String[] args){
        final BUILD_MASTER_VAULT BUILD_MASTER_VAULTClass = new BUILD_MASTER_VAULT();

        int exitCode = BUILD_MASTER_VAULTClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = BUILD_MASTER_VAULT.class.getClassLoader().getResourceAsStream("deepsea/build_master_vault_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = BUILD_MASTER_VAULT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : BUILD_MASTER_VAULT");
        }
...
/************************************************************************************************
 *     64075 characters generated by Talend Open Studio for Big Data 
 *     on the 4 October, 2018 12:33:45 PM SGT
 ************************************************************************************************/