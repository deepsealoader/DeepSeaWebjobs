...
/**
 * Job: BUILD_MASTER_VAULT Purpose: Build Master Vault<br>
 * Description: Build Master Vault <br>
...
public class BUILD_MASTER_VAULT implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(BUILD_MASTER_VAULT.this, new Object[] { e,
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUILD_MASTER_VAULT.class
					.getClassLoader().getResourceAsStream(
							"deepsea/build_master_vault_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = BUILD_MASTER_VAULT.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : BUILD_MASTER_VAULT");
		}
...
/************************************************************************************************
 * 50903 characters generated by Talend Open Studio for Big Data on the 19
 * December, 2018 1:00:34 PM CET
 ************************************************************************************************/
