...
package deepsea.job_build_master_vault_0_1;
...
/**
 * Job: JOB_BUILD_MASTER_VAULT Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class JOB_BUILD_MASTER_VAULT implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "JOB_BUILD_MASTER_VAULT";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				JOB_BUILD_MASTER_VAULT.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(JOB_BUILD_MASTER_VAULT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "myanmar.master.producthierachy.servier";
		if(obj_tRunJob_1!=null) {
		...
		deepsea.hub_product_0_1.HUB_PRODUCT childJob_tRunJob_1 = new deepsea.hub_product_0_1.HUB_PRODUCT();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = "myanmar.master.producthierachy.mega";
		if(obj_tRunJob_3!=null) {
		...
		deepsea.hub_product_0_1.HUB_PRODUCT childJob_tRunJob_3 = new deepsea.hub_product_0_1.HUB_PRODUCT();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "myanmar.master.producthierachy.servier";
		if(obj_tRunJob_4!=null) {
		...
		obj_tRunJob_4 = "myanmar.master.producthierachy.mega";
		if(obj_tRunJob_4!=null) {
		...
		deepsea.sal_product_0_1.SAL_PRODUCT childJob_tRunJob_4 = new deepsea.sal_product_0_1.SAL_PRODUCT();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = "ProductHierarchy";
		...
		obj_tRunJob_2 = "myanmar.master.producthierachy.servier";
		if(obj_tRunJob_2!=null) {
		...
		deepsea.sat_product_0_1.SAT_PRODUCT childJob_tRunJob_2 = new deepsea.sat_product_0_1.SAT_PRODUCT();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final JOB_BUILD_MASTER_VAULT JOB_BUILD_MASTER_VAULTClass = new JOB_BUILD_MASTER_VAULT();

        int exitCode = JOB_BUILD_MASTER_VAULTClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = JOB_BUILD_MASTER_VAULT.class.getClassLoader().getResourceAsStream("deepsea/job_build_master_vault_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = JOB_BUILD_MASTER_VAULT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : JOB_BUILD_MASTER_VAULT");
        }
...
/************************************************************************************************
 *     53568 characters generated by Talend Open Studio for Big Data 
