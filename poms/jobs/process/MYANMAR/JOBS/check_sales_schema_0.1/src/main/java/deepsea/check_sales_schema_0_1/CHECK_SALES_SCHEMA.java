...
package deepsea.check_sales_schema_0_1;
...
/**
 * Job: CHECK_SALES_SCHEMA Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class CHECK_SALES_SCHEMA implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "CHECK_SALES_SCHEMA";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_vm5rENA9Eei2putC5JowCA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				CHECK_SALES_SCHEMA.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CHECK_SALES_SCHEMA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_CHECK_SALES_SCHEMA = new byte[0];
    static byte[] commonByteArray_DEEPSEA_CHECK_SALES_SCHEMA = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_CHECK_SALES_SCHEMA.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_CHECK_SALES_SCHEMA.length == 0) {
   					commonByteArray_DEEPSEA_CHECK_SALES_SCHEMA = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_CHECK_SALES_SCHEMA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_CHECK_SALES_SCHEMA, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_CHECK_SALES_SCHEMA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_CHECK_SALES_SCHEMA) {
 ...
 */
	...
	if ((row2.hash == null) || ("".equals(row2.hash))) {
		...
		row2.hash != null
			...
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row2.hash);
		}
		...
		errorMessageThrough += "|wrong type";
			...
			resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
			errorCodeThrough = 0;
			resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"num:");
			errorMessageThrough = "";	try {
		if(
		row2.locality != null
		&& (!"".equals(row2.locality))
		) {
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row2.locality);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		errorMessageThrough += "|wrong type";
			...
			resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
			errorCodeThrough = 0;
			resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"locality:");
			errorMessageThrough = "";	try {
		if(
		row2.adminArea1 != null
		&& (!"".equals(row2.adminArea1))
		) {
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row2.adminArea1);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		errorMessageThrough += "|wrong type";
			...
			resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
			errorCodeThrough = 0;
			resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"adminArea1:");
			errorMessageThrough = "";	try {
		if(
		row2.customerCode != null
		&& (!"".equals(row2.customerCode))
		) {
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row2.customerCode);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		...
		&& (!"".equals(row2.customerName))
		) {
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row2.customerName);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		errorMessageThrough += "|wrong type";
			...
			resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
			errorCodeThrough = 0;
			resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"customerName:");
			errorMessageThrough = "";	try {
		if(
		row2.customerType != null
		&& (!"".equals(row2.customerType))
		) {
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row2.customerType);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		errorMessageThrough += "|wrong type";
			...
			resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
			errorCodeThrough = 0;
			resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"customerType:");
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row2.productCode == null) || ("".equals(row2.productCode))) {
		ifPassedThrough = false;
		errorCodeThrough += 4;
		errorMessageThrough += "|empty or null";
	}	try {
		if(
		row2.productCode != null
		) {
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row2.productCode);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		...
		&& (!"".equals(row2.productName))
		) {
			String tester_tSchemaComplianceCheck_1 = String.valueOf(row2.productName);
		}
	} catch(java.lang.Exception e) {
		ifPassedThrough = false;
		errorCodeThrough += 2;
		errorMessageThrough += "|wrong type";
			...
			resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
			errorCodeThrough = 0;
			resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"productName:");
			errorMessageThrough = "";
			resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
			errorCodeThrough = 0;
			resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"amount:");
			errorMessageThrough = "";
			resultErrorCodeThrough = handleErrorCode(errorCodeThrough,resultErrorCodeThrough);
			errorCodeThrough = 0;
			resultErrorMessageThrough = handleErrorMessage(errorMessageThrough,resultErrorMessageThrough,"quantity:");
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row2.date == null) || ("".equals(row2.date))) {
		ifPassedThrough = false;
		errorCodeThrough += 4;
		errorMessageThrough += "|empty or null";
	}
 ...
 */
    ...
    row3.productCode = utility_tExtractFields_1.UnPivot(doc_tExtractFields_1, "tag", "value", "productCode");
...
if(row3 != null) { 
  ...
  boolean bHasError_tConvertType_1 = false;             
          ...
          try {
              ...
              row2.locality=TypeConvert.String2String(row3.locality);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              ...
              row2.adminArea1=TypeConvert.String2String(row3.adminArea1);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              ...
              row2.customerCode=TypeConvert.String2String(row3.customerCode);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              ...
              row2.customerName=TypeConvert.String2String(row3.customerName);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              ...
              row2.customerType=TypeConvert.String2String(row3.customerType);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              ...
              row2.productCode=TypeConvert.String2String(row3.productCode);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              ...
              row2.productName=TypeConvert.String2String(row3.productName);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          ...
          try {
              ...
              row2.date=TypeConvert.String2Date(row3.date, "MM/dd/yy");            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }
...
if(row2 != null) { 
	...
	if (!rsvUtil_tSchemaComplianceCheck_1.ifPassedThrough) {
		...
		exception1.hash = row2.hash;
		exception1.num = row2.num;
		exception1.locality = row2.locality;
		exception1.adminArea1 = row2.adminArea1;
		exception1.customerCode = row2.customerCode;
		exception1.customerName = row2.customerName;
		exception1.customerType = row2.customerType;
		exception1.productCode = row2.productCode;
		exception1.productName = row2.productName;
		exception1.amount = row2.amount;
		exception1.quantity = row2.quantity;
		exception1.date = row2.date;
...
if(exception1 != null) { 
	...
	currentComponent="tNormalize_1";
            ...
            if(exception1.errorMessage != null) {
				if("".equals(exception1.errorMessage)){
		        	normalizeRecord_tNormalize_1[0] = "";
		        }else{
	                
	                		normalizeRecord_tNormalize_1 = exception1.errorMessage.split(";",-1);
            	...
            	for(int i_tNormalize_1 = 0 ; i_tNormalize_1 < lastNoEmptyIndex_tNormalize_1 ; i_tNormalize_1++) {
	                ...
	                nb_line_tNormalize_1++;               
	                        	...
	                        	row5.hash = exception1.hash;
	                        
	                        	row5.num = exception1.num;
	                        
	                        	row5.locality = exception1.locality;
	                        
	                        	row5.adminArea1 = exception1.adminArea1;
	                        
	                        	row5.customerCode = exception1.customerCode;
	                        
	                        	row5.customerName = exception1.customerName;
	                        
	                        	row5.customerType = exception1.customerType;
	                        
	                        	row5.productCode = exception1.productCode;
	                        
	                        	row5.productName = exception1.productName;
	                        
	                        	row5.amount = exception1.amount;
	                        
	                        	row5.quantity = exception1.quantity;
	                        
	                        	row5.date = exception1.date;
	                        
	                        	row5.errorCode = exception1.errorCode;
	                        
	                        	row5.errorMessage = normalizeRecord_tNormalize_1[i_tNormalize_1];
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = row5.errorMessage.split(":")[0];
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "Schema invalid:" + row5.errorMessage.split(":")[1];
		if(obj_tRunJob_1!=null) {
	...
	int nb_line_tMongoDBInput_3 = 0;
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_3=null;
				...
				try{
					...
					org.bson.Document myQuery_tMongoDBInput_3 = org.bson.Document.parse("{'name': '" + context.getCOLLECTION() + "'}, {'_id':1}");
				...
				try{
					...
					for (com.mongodb.DBObject index: coll_tMongoDBInput_4.listIndexes(com.mongodb.DBObject.class)) {
	                    ...
	                    for (String key: ((com.mongodb.DBObject)index.get("key")).keySet()) {
	                        ...
	                        // - is followed at some point by a colon
	                        // - there is no comma between the the DBcolumnName and the colon
	                        if  (("{'name': '" + jobName + "'}, {'_id':1}").matches(".*" + key + "[^,]*:.*")) {
	                            // We have an index, do not print error message
	                            needIndexWarning = false;
	                        } else {
	                            // This index is not in the query, add it into the indexList
					...
					org.bson.Document myQuery_tMongoDBInput_4 = org.bson.Document.parse("{'name': '" + jobName + "'}, {'_id':1}");
 ...
 */
    ...
    public static void main(String[] args){
        final CHECK_SALES_SCHEMA CHECK_SALES_SCHEMAClass = new CHECK_SALES_SCHEMA();

        int exitCode = CHECK_SALES_SCHEMAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CHECK_SALES_SCHEMA.class.getClassLoader().getResourceAsStream("deepsea/check_sales_schema_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CHECK_SALES_SCHEMA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CHECK_SALES_SCHEMA");
        }
...
/************************************************************************************************
 *     228517 characters generated by Talend Open Studio for Big Data 
 *     on the October 16, 2018 8:44:33 PM CST
 ************************************************************************************************/