...
/**
 * Job: reretest Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class reretest implements TalendJob {
	...
	private final String jobName = "reretest";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(reretest.this, new Object[] { e,
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				deepsea.myanmar_build_sales_links_0_1.MYANMAR_BUILD_SALES_LINKS childJob_tRunJob_3 = new deepsea.myanmar_build_sales_links_0_1.MYANMAR_BUILD_SALES_LINKS();
				// pass DataSources
	...
	public static void main(String[] args) {
		final reretest reretestClass = new reretest();

		int exitCode = reretestClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = reretest.class.getClassLoader()
					.getResourceAsStream(
							"deepsea/reretest_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = reretest.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : reretest");
		}
...
/************************************************************************************************
 * 49910 characters generated by Talend Open Studio for Big Data on the January
 * 13, 2019 10:51:26 AM CST
 ************************************************************************************************/
