...
public class test implements TalendJob {
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_DEEPSEA_test = new byte[0];
		static byte[] commonByteArray_DEEPSEA_test = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEEPSEA_test.length) {
					if (length < 1024
							&& commonByteArray_DEEPSEA_test.length == 0) {
						commonByteArray_DEEPSEA_test = new byte[1024];
					} else {
						commonByteArray_DEEPSEA_test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEEPSEA_test, 0, length);
				strReturn = new String(commonByteArray_DEEPSEA_test, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEEPSEA_test) {
	...
	public void tFileInputExcel_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object source_tFileInputExcel_1 = "C:/Users/admin/Desktop/Myanmar/master/OrganizationHierarchy.xlsx";
				...
				try {
					...
					sheetList_tFileInputExcel_1
							.addAll(regexUtil_tFileInputExcel_1.getSheets(
									workbook_tFileInputExcel_1, 1, false));
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test.class.getClassLoader()
					.getResourceAsStream(
							"deepsea/test_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 54488 characters generated by Talend Open Studio for Big Data on the
 * September 24, 2018 11:30:20 AM SGT
 ************************************************************************************************/
