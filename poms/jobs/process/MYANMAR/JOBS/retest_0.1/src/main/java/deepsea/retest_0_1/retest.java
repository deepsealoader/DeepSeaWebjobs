...
/**
 * Job: retest Purpose: retest<br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class retest implements TalendJob {
	...
	private final String jobName = "retest";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(retest.this, new Object[] { e,
	...
	public static void main(String[] args) {
		final retest retestClass = new retest();

		int exitCode = retestClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = retest.class.getClassLoader()
					.getResourceAsStream(
							"deepsea/retest_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = retest.class.getClassLoader().getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : retest");
		}
...
/************************************************************************************************
 * 23774 characters generated by Talend Open Studio for Big Data on the January
 * 13, 2019 10:48:31 AM CST
 ************************************************************************************************/
