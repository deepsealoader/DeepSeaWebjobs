...
package deepsea.sales_mega_daily_to_monthly_0_1;
...
/**
 * Job: SALES_MEGA_DAILY_TO_MONTHLY Purpose: Concat daily sales  to one monthly file<br>
 * Description: Concat daily sales to one monthly file <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SALES_MEGA_DAILY_TO_MONTHLY implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "SALES_MEGA_DAILY_TO_MONTHLY";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SALES_MEGA_DAILY_TO_MONTHLY.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SALES_MEGA_DAILY_TO_MONTHLY.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_SALES_MEGA_DAILY_TO_MONTHLY = new byte[0];
    static byte[] commonByteArray_DEEPSEA_SALES_MEGA_DAILY_TO_MONTHLY = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_SALES_MEGA_DAILY_TO_MONTHLY.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_SALES_MEGA_DAILY_TO_MONTHLY.length == 0) {
   					commonByteArray_DEEPSEA_SALES_MEGA_DAILY_TO_MONTHLY = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_SALES_MEGA_DAILY_TO_MONTHLY = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_SALES_MEGA_DAILY_TO_MONTHLY, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_SALES_MEGA_DAILY_TO_MONTHLY, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SALES_MEGA_DAILY_TO_MONTHLY) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		deepsea.update_one_month_sales_0_1.UPDATE_ONE_MONTH_SALES childJob_tRunJob_1 = new deepsea.update_one_month_sales_0_1.UPDATE_ONE_MONTH_SALES();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final SALES_MEGA_DAILY_TO_MONTHLY SALES_MEGA_DAILY_TO_MONTHLYClass = new SALES_MEGA_DAILY_TO_MONTHLY();

        int exitCode = SALES_MEGA_DAILY_TO_MONTHLYClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SALES_MEGA_DAILY_TO_MONTHLY.class.getClassLoader().getResourceAsStream("deepsea/sales_mega_daily_to_monthly_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SALES_MEGA_DAILY_TO_MONTHLY.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SALES_MEGA_DAILY_TO_MONTHLY");
        }
...
/************************************************************************************************
 *     328141 characters generated by Talend Open Studio for Big Data 
 *     on the 19 December, 2018 12:59:17 PM CET
 ************************************************************************************************/