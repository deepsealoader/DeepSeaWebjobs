...
package deepsea.sat_organization_0_1;
...
/**
 * Job: SAT_ORGANIZATION Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAT_ORGANIZATION implements TalendJob {
...
public String getTABLE(){
	...
	private final String jobName = "SAT_ORGANIZATION";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_3uEvoL-sEeip__KOlv70Sw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SAT_ORGANIZATION.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAT_ORGANIZATION.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row9Struct implements routines.system.IPersistableRow<row9Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_SAT_ORGANIZATION = new byte[0];
    static byte[] commonByteArray_DEEPSEA_SAT_ORGANIZATION = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_SAT_ORGANIZATION.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_SAT_ORGANIZATION.length == 0) {
   					commonByteArray_DEEPSEA_SAT_ORGANIZATION = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_SAT_ORGANIZATION = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_SAT_ORGANIZATION, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_SAT_ORGANIZATION, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAT_ORGANIZATION) {
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"hub_id\",\"source\",\"code\",\"parent_code\",\"department_code\",\"name_en\",\"name_lo\",\"level\") VALUES (?,?,?,?,?,?,?,?)";
 ...
 */
    ...
    row3.DepartmentCode = utility_tExtractFields_1.UnPivot(doc_tExtractFields_1, "tag", "value", "DepartmentCode");
...
if(row3 != null) { 
  ...
  boolean bHasError_tConvertType_1 = false;             
          ...
          try {
              if ("".equals(row3.DepartmentCode)){  
                row3.DepartmentCode = null;
              }
              row2.DepartmentCode=TypeConvert.String2String(row3.DepartmentCode);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
...
row8_tmp.departmentCode = row2.DepartmentCode ;
...
if(row8 != null) { 
	...
	row10.departmentCode = row8.departmentCode;
...
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
                    ...
                    if(row9.departmentCode == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, row9.departmentCode);
}
 ...
 */
    ...
    public static void main(String[] args){
        final SAT_ORGANIZATION SAT_ORGANIZATIONClass = new SAT_ORGANIZATION();

        int exitCode = SAT_ORGANIZATIONClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAT_ORGANIZATION.class.getClassLoader().getResourceAsStream("deepsea/sat_organization_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAT_ORGANIZATION.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAT_ORGANIZATION");
        }
...
/************************************************************************************************
 *     197971 characters generated by Talend Open Studio for Big Data 
