...
if(row3 != null) { 
  ...
  boolean bHasError_tConvertType_1 = false;             
          ...
          try {
              if ("".equals(row3.providerCode)){  
                row3.providerCode = null;
              }
              row2.providerCode=TypeConvert.String2String(row3.providerCode);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          ...
          try {
              if ("".equals(row3.geographyCoef)){  
                row3.geographyCoef = null;
              }
              row2.geographyCoef=TypeConvert.String2float(row3.geographyCoef);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              if ("".equals(row3.splitNumber)){  
                row3.splitNumber = null;
              }
              row2.splitNumber=TypeConvert.String2float(row3.splitNumber);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
...
/************************************************************************************************
 *     282843 characters generated by Talend Open Studio for Big Data 
 *     on the 4 December, 2018 11:39:59 AM AEDT
 ************************************************************************************************/