...
package deepsea.sat_source_channel_0_1;
...
/**
 * Job: SAT_SOURCE_CHANNEL Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAT_SOURCE_CHANNEL implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "SAT_SOURCE_CHANNEL";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_EthoAM6oEeiznP0ccyyRWw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SAT_SOURCE_CHANNEL.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAT_SOURCE_CHANNEL.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row9Struct implements routines.system.IPersistableRow<row9Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_SAT_SOURCE_CHANNEL = new byte[0];
    static byte[] commonByteArray_DEEPSEA_SAT_SOURCE_CHANNEL = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_SAT_SOURCE_CHANNEL.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_SAT_SOURCE_CHANNEL.length == 0) {
   					commonByteArray_DEEPSEA_SAT_SOURCE_CHANNEL = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_SAT_SOURCE_CHANNEL = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_SAT_SOURCE_CHANNEL, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_SAT_SOURCE_CHANNEL, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAT_SOURCE_CHANNEL) {
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"hub_id\",\"source\",\"code\",\"name\") VALUES (?,?,?,?)";
 ...
 */
    ...
    public static void main(String[] args){
        final SAT_SOURCE_CHANNEL SAT_SOURCE_CHANNELClass = new SAT_SOURCE_CHANNEL();

        int exitCode = SAT_SOURCE_CHANNELClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAT_SOURCE_CHANNEL.class.getClassLoader().getResourceAsStream("deepsea/sat_source_channel_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAT_SOURCE_CHANNEL.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAT_SOURCE_CHANNEL");
        }
...
/************************************************************************************************
 *     191392 characters generated by Talend Open Studio for Big Data 
