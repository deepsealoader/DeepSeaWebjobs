...
package deepsea.sat_employee_0_1;
...
/**
 * Job: SAT_EMPLOYEE Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAT_EMPLOYEE implements TalendJob {
...
public String getTABLE(){
	...
	private final String jobName = "SAT_EMPLOYEE";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_x2zKcMCBEeikjKnyntMfTA", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAT_EMPLOYEE.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row9Struct implements routines.system.IPersistableRow<row9Struct> {
    ...
    static byte[] commonByteArray_DEEPSEA_SAT_EMPLOYEE = new byte[0];
			    ...
			    public java.util.Date arrivalDate;

				public java.util.Date getArrivalDate () {
					return this.arrivalDate;
				}
				
			    public java.util.Date departureDate;
			    ...
			    public String jobTitleLo;

				public String getJobTitleLo () {
					return this.jobTitleLo;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_SAT_EMPLOYEE.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_SAT_EMPLOYEE.length == 0) {
   					commonByteArray_DEEPSEA_SAT_EMPLOYEE = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_SAT_EMPLOYEE = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_SAT_EMPLOYEE, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_SAT_EMPLOYEE, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAT_EMPLOYEE) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.arrivalDate = readDate(dis);
					
					this.departureDate = readDate(dis);
					
					this.jobTitleEn = readString(dis);
					
					this.jobTitleLo = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.arrivalDate,dos);
					
					// java.util.Date
				
						writeDate(this.departureDate,dos);
					
					// String
				
						writeString(this.jobTitleEn,dos);
					
					// String
				
						writeString(this.jobTitleLo,dos);
    ...
    public String toString() {
		...
		sb.append(",jobTitleEn="+jobTitleEn);
		sb.append(",jobTitleLo="+jobTitleLo);
	    sb.append("]");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    static byte[] commonByteArray_DEEPSEA_SAT_EMPLOYEE = new byte[0];
			    ...
			    public String JobTitle_En;

				public String getJobTitle_En () {
					return this.JobTitle_En;
				}
				
			    public String JobTitle_Lo;

				public String getJobTitle_Lo () {
					return this.JobTitle_Lo;
				}
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAT_EMPLOYEE) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.JobTitle_En = readString(dis);
					
					this.JobTitle_Lo = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.JobTitle_En,dos);
					
					// String
				
						writeString(this.JobTitle_Lo,dos);
    ...
    public String toString() {
		...
		sb.append(",Name_Lo="+Name_Lo);
		sb.append(",Visa="+Visa);
		sb.append(",Email="+Email);
		sb.append(",ArrivalDate="+String.valueOf(ArrivalDate));
		sb.append(",DepartureDate="+String.valueOf(DepartureDate));
		sb.append(",JobTitle_En="+JobTitle_En);
		sb.append(",JobTitle_Lo="+JobTitle_Lo);
	    sb.append("]");
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAT_EMPLOYEE) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.ArrivalDate = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.ArrivalDate,dos);
 ...
 */
    ...
    row3.Name_En = utility_tExtractFields_1.UnPivot(doc_tExtractFields_1, "tag", "value", "Name_En");
    row3.Name_Lo = utility_tExtractFields_1.UnPivot(doc_tExtractFields_1, "tag", "value", "Name_Lo");
    ...
    row3.JobTitle_En = utility_tExtractFields_1.UnPivot(doc_tExtractFields_1, "tag", "value", "JobTitle_En");
    row3.JobTitle_Lo = utility_tExtractFields_1.UnPivot(doc_tExtractFields_1, "tag", "value", "JobTitle_Lo");
...
if(row3 != null) { 
  ...
  boolean bHasError_tConvertType_1 = false;             
          ...
          try {
              if ("".equals(row3.Name_En)){  
                row3.Name_En = null;
              }
              row2.Name_En=TypeConvert.String2String(row3.Name_En);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              if ("".equals(row3.Name_Lo)){  
                row3.Name_Lo = null;
              }
              row2.Name_Lo=TypeConvert.String2String(row3.Name_Lo);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          ...
          try {
              if ("".equals(row3.Email)){  
                row3.Email = null;
              }
              row2.Email=TypeConvert.String2String(row3.Email);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              if ("".equals(row3.ArrivalDate)){  
                row3.ArrivalDate = null;
              }
              row2.ArrivalDate=TypeConvert.String2Date(row3.ArrivalDate, "dd-MM-yyyy");            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              if ("".equals(row3.DepartureDate)){  
                row3.DepartureDate = null;
              }
              row2.DepartureDate=TypeConvert.String2Date(row3.DepartureDate, "dd-MM-yyyy");            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              if ("".equals(row3.JobTitle_En)){  
                row3.JobTitle_En = null;
              }
              row2.JobTitle_En=TypeConvert.String2String(row3.JobTitle_En);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }           
          try {
              if ("".equals(row3.JobTitle_Lo)){  
                row3.JobTitle_Lo = null;
              }
              row2.JobTitle_Lo=TypeConvert.String2String(row3.JobTitle_Lo);            
          } catch(java.lang.Exception e){
            bHasError_tConvertType_1 = true;            
              System.err.println(e.getMessage());          
          }
...
row8_tmp.nameEn = row2.Name_En ;
row8_tmp.nameLo = row2.Name_Lo ;
...
row8_tmp.jobTitleEn = row2.JobTitle_En ;
row8_tmp.jobTitleLo = row2.JobTitle_Lo ;
row8 = row8_tmp;
...
if(row8 != null) { 
	...
	row10.visa = row8.visa;

	
	row10.email = row8.email;

	
	row10.arrivalDate = row8.arrivalDate;

	
	row10.departureDate = row8.departureDate;

	
	row10.jobTitleEn = row8.jobTitleEn;

	
	row10.jobTitleLo = row8.jobTitleLo;
 ...
 */
    ...
    public static void main(String[] args){
        final SAT_EMPLOYEE SAT_EMPLOYEEClass = new SAT_EMPLOYEE();

        int exitCode = SAT_EMPLOYEEClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAT_EMPLOYEE.class.getClassLoader().getResourceAsStream("deepsea/sat_employee_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAT_EMPLOYEE.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAT_EMPLOYEE");
        }
...
/************************************************************************************************
 *     208185 characters generated by Talend Open Studio for Big Data 
 *     on the 28 September, 2018 5:22:26 PM CEST
 ************************************************************************************************/