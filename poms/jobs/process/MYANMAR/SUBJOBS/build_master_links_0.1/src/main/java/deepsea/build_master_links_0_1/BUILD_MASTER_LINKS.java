...
public class BUILD_MASTER_LINKS implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(BUILD_MASTER_LINKS.this, new Object[] { e,
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_4.add("--context_type " + "COUNTRY" + "="
						+ "id_String");

				parentContextMap_tRunJob_4.put("DEEPSEA_AUTH_TOKEN",
						context.DEEPSEA_AUTH_TOKEN);
				paraList_tRunJob_4.add("--context_type " + "DEEPSEA_AUTH_TOKEN"
						+ "=" + "id_String");

				parentContextMap_tRunJob_4.put("DEEPSEA_HOSTNAME",
						context.DEEPSEA_HOSTNAME);
				paraList_tRunJob_4.add("--context_type " + "DEEPSEA_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_4.put("MONGODB_HOSTNAME",
						context.MONGODB_HOSTNAME);
				paraList_tRunJob_4.add("--context_type " + "MONGODB_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_4.put("POSTGRES_HOSTNAME",
						context.POSTGRES_HOSTNAME);
				paraList_tRunJob_4.add("--context_type " + "POSTGRES_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_4.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_4.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
				...
				if (obj_tRunJob_4 != null) {
					paraList_tRunJob_4
							.add("--context_param BUSINESS_KEY1="
									+ RuntimeUtils
											.tRunJobConvertContext(obj_tRunJob_4));
				} else {
					paraList_tRunJob_4
				...
				if (obj_tRunJob_4 != null) {
					paraList_tRunJob_4
							.add("--context_param BUSINESS_KEY2="
									+ RuntimeUtils
											.tRunJobConvertContext(obj_tRunJob_4));
				} else {
					paraList_tRunJob_4
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parentContextMap_tRunJob_1.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_1.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parentContextMap_tRunJob_2.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_2.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_5.add("--context_type " + "COUNTRY" + "="
						+ "id_String");

				parentContextMap_tRunJob_5.put("DEEPSEA_AUTH_TOKEN",
						context.DEEPSEA_AUTH_TOKEN);
				paraList_tRunJob_5.add("--context_type " + "DEEPSEA_AUTH_TOKEN"
						+ "=" + "id_String");

				parentContextMap_tRunJob_5.put("DEEPSEA_HOSTNAME",
						context.DEEPSEA_HOSTNAME);
				paraList_tRunJob_5.add("--context_type " + "DEEPSEA_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_5.put("MONGODB_HOSTNAME",
						context.MONGODB_HOSTNAME);
				paraList_tRunJob_5.add("--context_type " + "MONGODB_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_5.put("POSTGRES_HOSTNAME",
						context.POSTGRES_HOSTNAME);
				paraList_tRunJob_5.add("--context_type " + "POSTGRES_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_5.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_5.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parentContextMap_tRunJob_3.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_3.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_6.add("--context_type " + "COUNTRY" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("DEEPSEA_AUTH_TOKEN",
						context.DEEPSEA_AUTH_TOKEN);
				paraList_tRunJob_6.add("--context_type " + "DEEPSEA_AUTH_TOKEN"
						+ "=" + "id_String");

				parentContextMap_tRunJob_6.put("DEEPSEA_HOSTNAME",
						context.DEEPSEA_HOSTNAME);
				paraList_tRunJob_6.add("--context_type " + "DEEPSEA_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_6.put("MONGODB_HOSTNAME",
						context.MONGODB_HOSTNAME);
				paraList_tRunJob_6.add("--context_type " + "MONGODB_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_6.put("POSTGRES_HOSTNAME",
						context.POSTGRES_HOSTNAME);
				paraList_tRunJob_6.add("--context_type " + "POSTGRES_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_6.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_6.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
	...
	public void tRunJob_13Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_13.add("--context_type " + "COUNTRY" + "="
						+ "id_String");

				parentContextMap_tRunJob_13.put("DEEPSEA_AUTH_TOKEN",
						context.DEEPSEA_AUTH_TOKEN);
				paraList_tRunJob_13.add("--context_type "
						+ "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");

				parentContextMap_tRunJob_13.put("DEEPSEA_HOSTNAME",
						context.DEEPSEA_HOSTNAME);
				paraList_tRunJob_13.add("--context_type " + "DEEPSEA_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_13.put("MONGODB_HOSTNAME",
						context.MONGODB_HOSTNAME);
				paraList_tRunJob_13.add("--context_type " + "MONGODB_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_13.put("POSTGRES_HOSTNAME",
						context.POSTGRES_HOSTNAME);
				paraList_tRunJob_13.add("--context_type " + "POSTGRES_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_13.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_13.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
				...
				while (propertyNames_tRunJob_13.hasMoreElements()) {
					...
					if (value_tRunJob_13 != null) {
						paraList_tRunJob_13.add("--context_param "
								+ key_tRunJob_13 + "=" + value_tRunJob_13);
					} else {
						paraList_tRunJob_13
								.add("--context_param "
										+ key_tRunJob_13
				...
				if (obj_tRunJob_13 != null) {
					paraList_tRunJob_13.add("--context_param TYPE="
							+ RuntimeUtils
				...
				obj_tRunJob_13 = "Mega";
				if (obj_tRunJob_13 != null) {
					paraList_tRunJob_13.add("--context_param SHEET_NAME="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_13));
				} else {
					paraList_tRunJob_13
				...
				if (obj_tRunJob_13 != null) {
					paraList_tRunJob_13.add("--context_param BUSINESS_KEY1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_13));
				} else {
					paraList_tRunJob_13
				...
				parentContextMap_tRunJob_13
						.put("BUSINESS_KEY1", obj_tRunJob_13);

				obj_tRunJob_13 = "providerCode";
				if (obj_tRunJob_13 != null) {
					paraList_tRunJob_13.add("--context_param BUSINESS_KEY2="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_13));
				} else {
					paraList_tRunJob_13
				...
				parentContextMap_tRunJob_13
						.put("BUSINESS_KEY2", obj_tRunJob_13);

				obj_tRunJob_13 = "source_channel";
				if (obj_tRunJob_13 != null) {
					paraList_tRunJob_13.add("--context_param TABLE1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_13));
				} else {
					paraList_tRunJob_13
				...
				if (obj_tRunJob_13 != null) {
					paraList_tRunJob_13.add("--context_param SOURCE1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_13));
				} else {
					paraList_tRunJob_13
				...
				obj_tRunJob_13 = "customer";
				if (obj_tRunJob_13 != null) {
					paraList_tRunJob_13.add("--context_param TABLE2="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_13));
				} else {
					paraList_tRunJob_13
				...
				if (obj_tRunJob_13 != null) {
					paraList_tRunJob_13.add("--context_param SOURCE2="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_13));
				} else {
					paraList_tRunJob_13
				...
				if (childJob_tRunJob_13.getErrorCode() != null
					...
					throw new RuntimeException("Child job running failed.\n"
							+ childJob_tRunJob_13.getException().getClass()
									.getName() + ": "
							+ childJob_tRunJob_13.getException().getMessage());
				}
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_7.add("--context_type " + "COUNTRY" + "="
						+ "id_String");

				parentContextMap_tRunJob_7.put("DEEPSEA_AUTH_TOKEN",
						context.DEEPSEA_AUTH_TOKEN);
				paraList_tRunJob_7.add("--context_type " + "DEEPSEA_AUTH_TOKEN"
						+ "=" + "id_String");

				parentContextMap_tRunJob_7.put("DEEPSEA_HOSTNAME",
						context.DEEPSEA_HOSTNAME);
				paraList_tRunJob_7.add("--context_type " + "DEEPSEA_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_7.put("MONGODB_HOSTNAME",
						context.MONGODB_HOSTNAME);
				paraList_tRunJob_7.add("--context_type " + "MONGODB_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_7.put("POSTGRES_HOSTNAME",
						context.POSTGRES_HOSTNAME);
				paraList_tRunJob_7.add("--context_type " + "POSTGRES_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_7.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_7.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_8.add("--context_type " + "COUNTRY" + "="
						+ "id_String");

				parentContextMap_tRunJob_8.put("DEEPSEA_AUTH_TOKEN",
						context.DEEPSEA_AUTH_TOKEN);
				paraList_tRunJob_8.add("--context_type " + "DEEPSEA_AUTH_TOKEN"
						+ "=" + "id_String");

				parentContextMap_tRunJob_8.put("DEEPSEA_HOSTNAME",
						context.DEEPSEA_HOSTNAME);
				paraList_tRunJob_8.add("--context_type " + "DEEPSEA_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_8.put("MONGODB_HOSTNAME",
						context.MONGODB_HOSTNAME);
				paraList_tRunJob_8.add("--context_type " + "MONGODB_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_8.put("POSTGRES_HOSTNAME",
						context.POSTGRES_HOSTNAME);
				paraList_tRunJob_8.add("--context_type " + "POSTGRES_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_8.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_8.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
	...
	public void tRunJob_9Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_9.add("--context_type " + "COUNTRY" + "="
						+ "id_String");

				parentContextMap_tRunJob_9.put("DEEPSEA_AUTH_TOKEN",
						context.DEEPSEA_AUTH_TOKEN);
				paraList_tRunJob_9.add("--context_type " + "DEEPSEA_AUTH_TOKEN"
						+ "=" + "id_String");

				parentContextMap_tRunJob_9.put("DEEPSEA_HOSTNAME",
						context.DEEPSEA_HOSTNAME);
				paraList_tRunJob_9.add("--context_type " + "DEEPSEA_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_9.put("MONGODB_HOSTNAME",
						context.MONGODB_HOSTNAME);
				paraList_tRunJob_9.add("--context_type " + "MONGODB_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_9.put("POSTGRES_HOSTNAME",
						context.POSTGRES_HOSTNAME);
				paraList_tRunJob_9.add("--context_type " + "POSTGRES_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_9.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_9.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
				...
				if (childJob_tRunJob_9.getErrorCode() != null
					...
					throw new RuntimeException("Child job running failed.\n"
							+ childJob_tRunJob_9.getException().getClass()
									.getName() + ": "
							+ childJob_tRunJob_9.getException().getMessage());
				}
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_10.add("--context_type " + "COUNTRY" + "="
						+ "id_String");

				parentContextMap_tRunJob_10.put("DEEPSEA_AUTH_TOKEN",
						context.DEEPSEA_AUTH_TOKEN);
				paraList_tRunJob_10.add("--context_type "
						+ "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");

				parentContextMap_tRunJob_10.put("DEEPSEA_HOSTNAME",
						context.DEEPSEA_HOSTNAME);
				paraList_tRunJob_10.add("--context_type " + "DEEPSEA_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_10.put("MONGODB_HOSTNAME",
						context.MONGODB_HOSTNAME);
				paraList_tRunJob_10.add("--context_type " + "MONGODB_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_10.put("POSTGRES_HOSTNAME",
						context.POSTGRES_HOSTNAME);
				paraList_tRunJob_10.add("--context_type " + "POSTGRES_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_10.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_10.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
				...
				if (obj_tRunJob_10 != null) {
					paraList_tRunJob_10.add("--context_param TYPE="
							+ RuntimeUtils
				...
				if (obj_tRunJob_10 != null) {
					paraList_tRunJob_10.add("--context_param QUOTA_TYPE="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_10));
				} else {
					paraList_tRunJob_10
				...
				if (obj_tRunJob_10 != null) {
					paraList_tRunJob_10.add("--context_param BUSINESS_KEY1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_10));
				} else {
					paraList_tRunJob_10
				...
				parentContextMap_tRunJob_10
						.put("BUSINESS_KEY1", obj_tRunJob_10);

				obj_tRunJob_10 = "product";
				if (obj_tRunJob_10 != null) {
					paraList_tRunJob_10.add("--context_param TABLE1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_10));
				} else {
					paraList_tRunJob_10
				...
				if (obj_tRunJob_10 != null) {
					paraList_tRunJob_10.add("--context_param SOURCE1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_10));
				} else {
					paraList_tRunJob_10
				...
				obj_tRunJob_10 = "sales_objective_qty";
				if (obj_tRunJob_10 != null) {
					paraList_tRunJob_10.add("--context_param TABLE2="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_10));
				} else {
					paraList_tRunJob_10
				...
				if (obj_tRunJob_10 != null) {
					paraList_tRunJob_10.add("--context_param SOURCE2="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_10));
				} else {
					paraList_tRunJob_10
				...
				if (childJob_tRunJob_10.getErrorCode() != null
					...
					throw new RuntimeException("Child job running failed.\n"
							+ childJob_tRunJob_10.getException().getClass()
									.getName() + ": "
							+ childJob_tRunJob_10.getException().getMessage());
				}
	...
	public void tRunJob_11Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_11.add("--context_type " + "COUNTRY" + "="
						+ "id_String");

				parentContextMap_tRunJob_11.put("DEEPSEA_AUTH_TOKEN",
						context.DEEPSEA_AUTH_TOKEN);
				paraList_tRunJob_11.add("--context_type "
						+ "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");

				parentContextMap_tRunJob_11.put("DEEPSEA_HOSTNAME",
						context.DEEPSEA_HOSTNAME);
				paraList_tRunJob_11.add("--context_type " + "DEEPSEA_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_11.put("MONGODB_HOSTNAME",
						context.MONGODB_HOSTNAME);
				paraList_tRunJob_11.add("--context_type " + "MONGODB_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_11.put("POSTGRES_HOSTNAME",
						context.POSTGRES_HOSTNAME);
				paraList_tRunJob_11.add("--context_type " + "POSTGRES_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_11.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_11.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
				...
				while (propertyNames_tRunJob_11.hasMoreElements()) {
					...
					if (value_tRunJob_11 != null) {
						paraList_tRunJob_11.add("--context_param "
								+ key_tRunJob_11 + "=" + value_tRunJob_11);
					} else {
						paraList_tRunJob_11
								.add("--context_param "
										+ key_tRunJob_11
				...
				if (obj_tRunJob_11 != null) {
					paraList_tRunJob_11.add("--context_param TYPE="
							+ RuntimeUtils
				...
				if (obj_tRunJob_11 != null) {
					paraList_tRunJob_11.add("--context_param QUOTA_TYPE="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_11));
				} else {
					paraList_tRunJob_11
				...
				if (obj_tRunJob_11 != null) {
					paraList_tRunJob_11.add("--context_param BUSINESS_KEY1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_11));
				} else {
					paraList_tRunJob_11
				...
				parentContextMap_tRunJob_11
						.put("BUSINESS_KEY1", obj_tRunJob_11);

				obj_tRunJob_11 = "geography";
				if (obj_tRunJob_11 != null) {
					paraList_tRunJob_11.add("--context_param TABLE1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_11));
				} else {
					paraList_tRunJob_11
				...
				if (obj_tRunJob_11 != null) {
					paraList_tRunJob_11.add("--context_param SOURCE1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_11));
				} else {
					paraList_tRunJob_11
				...
				obj_tRunJob_11 = "sales_objective_qty";
				if (obj_tRunJob_11 != null) {
					paraList_tRunJob_11.add("--context_param TABLE2="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_11));
				} else {
					paraList_tRunJob_11
				...
				if (obj_tRunJob_11 != null) {
					paraList_tRunJob_11.add("--context_param SOURCE2="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_11));
				} else {
					paraList_tRunJob_11
				...
				if (childJob_tRunJob_11.getErrorCode() != null
					...
					throw new RuntimeException("Child job running failed.\n"
							+ childJob_tRunJob_11.getException().getClass()
									.getName() + ": "
							+ childJob_tRunJob_11.getException().getMessage());
				}
	...
	public void tRunJob_12Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_12.add("--context_type " + "COUNTRY" + "="
						+ "id_String");

				parentContextMap_tRunJob_12.put("DEEPSEA_AUTH_TOKEN",
						context.DEEPSEA_AUTH_TOKEN);
				paraList_tRunJob_12.add("--context_type "
						+ "DEEPSEA_AUTH_TOKEN" + "=" + "id_String");

				parentContextMap_tRunJob_12.put("DEEPSEA_HOSTNAME",
						context.DEEPSEA_HOSTNAME);
				paraList_tRunJob_12.add("--context_type " + "DEEPSEA_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_12.put("MONGODB_HOSTNAME",
						context.MONGODB_HOSTNAME);
				paraList_tRunJob_12.add("--context_type " + "MONGODB_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_12.put("POSTGRES_HOSTNAME",
						context.POSTGRES_HOSTNAME);
				paraList_tRunJob_12.add("--context_type " + "POSTGRES_HOSTNAME"
						+ "=" + "id_String");

				parentContextMap_tRunJob_12.put("WEBJOB_NAME",
						context.WEBJOB_NAME);
				paraList_tRunJob_12.add("--context_type " + "WEBJOB_NAME" + "="
						+ "id_String");
				...
				if (obj_tRunJob_12 != null) {
					paraList_tRunJob_12.add("--context_param TYPE="
							+ RuntimeUtils
				...
				if (obj_tRunJob_12 != null) {
					paraList_tRunJob_12.add("--context_param QUOTA_TYPE="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_12));
				} else {
					paraList_tRunJob_12
				...
				if (obj_tRunJob_12 != null) {
					paraList_tRunJob_12.add("--context_param BUSINESS_KEY1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_12));
				} else {
					paraList_tRunJob_12
				...
				parentContextMap_tRunJob_12
						.put("BUSINESS_KEY1", obj_tRunJob_12);

				obj_tRunJob_12 = "source_channel";
				if (obj_tRunJob_12 != null) {
					paraList_tRunJob_12.add("--context_param TABLE1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_12));
				} else {
					paraList_tRunJob_12
				...
				if (obj_tRunJob_12 != null) {
					paraList_tRunJob_12.add("--context_param SOURCE1="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_12));
				} else {
					paraList_tRunJob_12
				...
				obj_tRunJob_12 = "sales_objective_qty";
				if (obj_tRunJob_12 != null) {
					paraList_tRunJob_12.add("--context_param TABLE2="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_12));
				} else {
					paraList_tRunJob_12
				...
				if (obj_tRunJob_12 != null) {
					paraList_tRunJob_12.add("--context_param SOURCE2="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_12));
				} else {
					paraList_tRunJob_12
				...
				if (childJob_tRunJob_12.getErrorCode() != null
					...
					throw new RuntimeException("Child job running failed.\n"
							+ childJob_tRunJob_12.getException().getClass()
									.getName() + ": "
							+ childJob_tRunJob_12.getException().getMessage());
				}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUILD_MASTER_LINKS.class
					.getClassLoader().getResourceAsStream(
							"deepsea/build_master_links_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = BUILD_MASTER_LINKS.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : BUILD_MASTER_LINKS");
		}
...
/************************************************************************************************
 * 174438 characters generated by Talend Open Studio for Big Data on the 1
 * December, 2018 11:53:11 PM CST
 ************************************************************************************************/
