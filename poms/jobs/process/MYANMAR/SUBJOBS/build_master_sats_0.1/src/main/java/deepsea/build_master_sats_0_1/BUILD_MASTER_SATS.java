		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(BUILD_MASTER_SATS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = BUILD_MASTER_SATS.class.getClassLoader().getResourceAsStream("deepsea/build_master_sats_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = BUILD_MASTER_SATS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : BUILD_MASTER_SATS");
        }
...
/************************************************************************************************
 *     105960 characters generated by Talend Open Studio for Big Data 
 *     on the 4 December, 2018 11:40:01 AM AEDT
 ************************************************************************************************/