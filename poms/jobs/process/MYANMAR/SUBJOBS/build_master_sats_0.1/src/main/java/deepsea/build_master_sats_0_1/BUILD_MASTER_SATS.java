...
package deepsea.build_master_sats_0_1;
...
/**
 * Job: BUILD_MASTER_SATS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class BUILD_MASTER_SATS implements TalendJob {
	...
	private final String jobName = "BUILD_MASTER_SATS";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					BUILD_MASTER_SATS.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(BUILD_MASTER_SATS.this, new Object[] { e,
	...
	public void tRunJob_9Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				obj_tRunJob_9 = "myanmar.master.salesobjectiveval.servier";
				if (obj_tRunJob_9 != null) {
					paraList_tRunJob_9
							.add("--context_param SOURCE="
									+ RuntimeUtils
	...
	public static void main(String[] args) {
		final BUILD_MASTER_SATS BUILD_MASTER_SATSClass = new BUILD_MASTER_SATS();

		int exitCode = BUILD_MASTER_SATSClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUILD_MASTER_SATS.class
					.getClassLoader().getResourceAsStream(
							"deepsea/build_master_sats_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = BUILD_MASTER_SATS.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : BUILD_MASTER_SATS");
		}
...
/************************************************************************************************
 * 105930 characters generated by Talend Open Studio for Big Data on the 1
 * December, 2018 11:54:01 PM CST
 ************************************************************************************************/
