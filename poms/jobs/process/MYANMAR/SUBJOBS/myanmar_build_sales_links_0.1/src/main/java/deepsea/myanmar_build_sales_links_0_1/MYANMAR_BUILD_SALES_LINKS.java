...
package deepsea.myanmar_build_sales_links_0_1;
...
/**
 * Job: MYANMAR_BUILD_SALES_LINKS Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class MYANMAR_BUILD_SALES_LINKS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "MYANMAR_BUILD_SALES_LINKS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MYANMAR_BUILD_SALES_LINKS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MYANMAR_BUILD_SALES_LINKS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "sales.mega.monthly";
		...
		obj_tRunJob_1 = "myanmar.master.producthierarchy.mega";
		if(obj_tRunJob_1!=null) {
		...
		obj_tRunJob_1 = "myanmar.sales.mega.monthly";
		if(obj_tRunJob_1!=null) {
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = "sales.mega.monthly";
		...
		obj_tRunJob_3 = "myanmar.master.customer.mega";
		if(obj_tRunJob_3!=null) {
		...
		obj_tRunJob_3 = "myanmar.sales.mega.monthly";
		if(obj_tRunJob_3!=null) {
		...
		deepsea.myanmar_generate_customer_diff_0_1.MYANMAR_GENERATE_CUSTOMER_DIFF childJob_tRunJob_3 = new deepsea.myanmar_generate_customer_diff_0_1.MYANMAR_GENERATE_CUSTOMER_DIFF();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = "sales.mega.monthly";
		...
		obj_tRunJob_2 = "myanmar.master.customer.mega";
		if(obj_tRunJob_2!=null) {
		...
		obj_tRunJob_2 = "myanmar.sales.mega.monthly";
		if(obj_tRunJob_2!=null) {
 ...
 */
    ...
    public static void main(String[] args){
        final MYANMAR_BUILD_SALES_LINKS MYANMAR_BUILD_SALES_LINKSClass = new MYANMAR_BUILD_SALES_LINKS();

        int exitCode = MYANMAR_BUILD_SALES_LINKSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MYANMAR_BUILD_SALES_LINKS.class.getClassLoader().getResourceAsStream("deepsea/myanmar_build_sales_links_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MYANMAR_BUILD_SALES_LINKS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MYANMAR_BUILD_SALES_LINKS");
        }
...
/************************************************************************************************
 *     59768 characters generated by Talend Open Studio for Big Data 
