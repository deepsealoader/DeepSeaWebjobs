...
package deepsea.myanmar_generate_customer_diff_0_1;
...
/**
 * Job: MYANMAR_GENERATE_CUSTOMER_DIFF Purpose: Generate a report of not found customer<br>
 * Description: Add a diff sheet in the customer file with all customer not found in the cusomter master when processing new sales. This process is custom for Myanmar to find back the geography code from the locality. <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class MYANMAR_GENERATE_CUSTOMER_DIFF implements TalendJob {
...
public String getSHEET_NAME(){
	...
	private final String jobName = "MYANMAR_GENERATE_CUSTOMER_DIFF";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_urb7cBbVEemq9Nsldu20OQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MYANMAR_GENERATE_CUSTOMER_DIFF.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MYANMAR_GENERATE_CUSTOMER_DIFF.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row14Struct implements routines.system.IPersistableRow<row14Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_MYANMAR_GENERATE_CUSTOMER_DIFF = new byte[0];
    static byte[] commonByteArray_DEEPSEA_MYANMAR_GENERATE_CUSTOMER_DIFF = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_MYANMAR_GENERATE_CUSTOMER_DIFF.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_MYANMAR_GENERATE_CUSTOMER_DIFF.length == 0) {
   					commonByteArray_DEEPSEA_MYANMAR_GENERATE_CUSTOMER_DIFF = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_MYANMAR_GENERATE_CUSTOMER_DIFF = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_MYANMAR_GENERATE_CUSTOMER_DIFF, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_MYANMAR_GENERATE_CUSTOMER_DIFF, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_MYANMAR_GENERATE_CUSTOMER_DIFF) {
 ...
 */
	 ...
	 */
		...
		ok_Hash.put("tFuzzyMatch_1", false);
		start_Hash.put("tFuzzyMatch_1", System.currentTimeMillis());
		
	
	currentComponent="tFuzzyMatch_1";
		...
		int tos_count_tFuzzyMatch_1 = 0;
		
    	class BytesLimit65535_tFuzzyMatch_1{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tFuzzyMatch_1().limitLog4jByte();


int nb_line_tFuzzyMatch_1 = 0;

java.util.Set<row11Struct> tSet_row11_tFuzzyMatch_1 = ((java.util.Map<row11Struct, row11Struct>) globalMap.get("tHash_row11")).keySet();

org.apache.commons.codec.language.Metaphone metaphone_tFuzzyMatch_1 = new org.apache.commons.codec.language.Metaphone();
...
row19_tmp.SourceChannelCode = null;
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		...
                        		    		row2HashKey.businessKey = row19.GeographyCode;
...
row20_tmp.geographyCode = row2.geographyCode ;
...
if(row20 != null) { 
	...
	currentComponent="tFuzzyMatch_1";
			...
			//row20
				...
				java.util.Iterator<row11Struct> tItr_row11_tFuzzyMatch_1 = tSet_row11_tFuzzyMatch_1.iterator();

                
                	row10.VALUE = metaphone_tFuzzyMatch_1.metaphone("" + row20.NameEn);
                
                        while(tItr_row11_tFuzzyMatch_1.hasNext()){
                        
                        	String lookUpValue_tFuzzyMatch_1 = "" + tItr_row11_tFuzzyMatch_1.next().name_en;
                        	
                        	if(metaphone_tFuzzyMatch_1.metaphone(lookUpValue_tFuzzyMatch_1).equals(row10.VALUE)){
                        	
                        		row10.MATCHING = lookUpValue_tFuzzyMatch_1;
	...
	tos_count_tFuzzyMatch_1++;

/**
 * [tFuzzyMatch_1 main ] stop
 */
	
	/**
	 * [tFuzzyMatch_1 process_data_begin ] start
	 */
...
/**
 * [tFuzzyMatch_1 process_data_begin ] stop
 */
 ...
 */
	...
	/**
	 * [tFuzzyMatch_1 process_data_end ] start
	 */
...
/**
 * [tFuzzyMatch_1 process_data_end ] stop
 */
...
globalMap.put("tFuzzyMatch_1_NB_LINE",nb_line_tFuzzyMatch_1);
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
...
ok_Hash.put("tFuzzyMatch_1", true);
end_Hash.put("tFuzzyMatch_1", System.currentTimeMillis());




/**
 * [tFuzzyMatch_1 end ] stop
 */
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row12.GeographyCode = aggregated_row_tAggregateRow_1.ServierCode;
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
			...
			//row2
				...
				row2_HashRow.geographyCode = row2.geographyCode;
...
public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tHash_row11";
    	...
    	class BytesLimit65535_tHash_row11{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tHash_row11().limitLog4jByte();
 ...
 */
    ...
    public static void main(String[] args){
        final MYANMAR_GENERATE_CUSTOMER_DIFF MYANMAR_GENERATE_CUSTOMER_DIFFClass = new MYANMAR_GENERATE_CUSTOMER_DIFF();

        int exitCode = MYANMAR_GENERATE_CUSTOMER_DIFFClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MYANMAR_GENERATE_CUSTOMER_DIFF.class.getClassLoader().getResourceAsStream("deepsea/myanmar_generate_customer_diff_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MYANMAR_GENERATE_CUSTOMER_DIFF.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MYANMAR_GENERATE_CUSTOMER_DIFF");
        }
...
/************************************************************************************************
 *     383825 characters generated by Talend Open Studio for Big Data 
 *     on the January 20, 2019 11:17:16 AM CST
 ************************************************************************************************/