...
package deepsea.myanmar_build_master_sats_0_1;
...
/**
 * Job: MYANMAR_BUILD_MASTER_SATS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class MYANMAR_BUILD_MASTER_SATS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "MYANMAR_BUILD_MASTER_SATS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MYANMAR_BUILD_MASTER_SATS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MYANMAR_BUILD_MASTER_SATS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final MYANMAR_BUILD_MASTER_SATS MYANMAR_BUILD_MASTER_SATSClass = new MYANMAR_BUILD_MASTER_SATS();

        int exitCode = MYANMAR_BUILD_MASTER_SATSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MYANMAR_BUILD_MASTER_SATS.class.getClassLoader().getResourceAsStream("deepsea/myanmar_build_master_sats_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MYANMAR_BUILD_MASTER_SATS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MYANMAR_BUILD_MASTER_SATS");
        }
 ...
 *     on the January 13, 2019 10:27:48 AM CST
 ************************************************************************************************/