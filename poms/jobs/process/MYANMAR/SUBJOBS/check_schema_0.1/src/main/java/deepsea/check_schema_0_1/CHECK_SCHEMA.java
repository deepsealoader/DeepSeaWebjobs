...
package deepsea.check_schema_0_1;
...
/**
 * Job: CHECK_SCHEMA Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class CHECK_SCHEMA implements TalendJob {
...
public String getWEBJOB_NAME(){
	...
	private final String jobName = "CHECK_SCHEMA";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CHECK_SCHEMA.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_CHECK_SCHEMA = new byte[0];
    static byte[] commonByteArray_DEEPSEA_CHECK_SCHEMA = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_CHECK_SCHEMA.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_CHECK_SCHEMA.length == 0) {
   					commonByteArray_DEEPSEA_CHECK_SCHEMA = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_CHECK_SCHEMA = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_CHECK_SCHEMA, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_CHECK_SCHEMA, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_CHECK_SCHEMA) {
 ...
 */
	...
	if ((row2.hash == null) || ("".equals(row2.hash))) {
		...
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row2.locality == null) || ("".equals(row2.locality))) {
		ifPassedThrough = false;
		errorCodeThrough += 4;
		errorMessageThrough += "|empty or null";
	}	try {
		...
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row2.adminArea1 == null) || ("".equals(row2.adminArea1))) {
		ifPassedThrough = false;
		errorCodeThrough += 4;
		errorMessageThrough += "|empty or null";
	}	try {
		...
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row2.customerCode == null) || ("".equals(row2.customerCode))) {
		ifPassedThrough = false;
		errorCodeThrough += 4;
		errorMessageThrough += "|empty or null";
	}	try {
		...
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row2.customerName == null) || ("".equals(row2.customerName))) {
		ifPassedThrough = false;
		errorCodeThrough += 4;
		errorMessageThrough += "|empty or null";
	}	try {
		...
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row2.customerType == null) || ("".equals(row2.customerType))) {
		ifPassedThrough = false;
		errorCodeThrough += 4;
		errorMessageThrough += "|empty or null";
	}	try {
	...
	if ((row2.productCode == null) || ("".equals(row2.productCode))) {
		...
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row2.productName == null) || ("".equals(row2.productName))) {
		ifPassedThrough = false;
		errorCodeThrough += 4;
		errorMessageThrough += "|empty or null";
	}	try {
		...
		errorMessageThrough += "|wrong type";
			...
			errorMessageThrough = "";
	// validate nullable (empty as null)
	if ((row2.amount == null) || ("".equals(row2.amount))) {
		ifPassedThrough = false;
		errorCodeThrough += 4;
		errorMessageThrough += "|empty or null";
	}
	...
	int nb_line_tMongoDBInput_4 = 0;
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_4=null;
				...
				try{
					...
					org.bson.Document myQuery_tMongoDBInput_4 = org.bson.Document.parse("{'name': '" + context.getWEBJOB_NAME() + "'}, {'_id':1}");
 ...
 */
    ...
    public static void main(String[] args){
        final CHECK_SCHEMA CHECK_SCHEMAClass = new CHECK_SCHEMA();

        int exitCode = CHECK_SCHEMAClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CHECK_SCHEMA.class.getClassLoader().getResourceAsStream("deepsea/check_schema_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CHECK_SCHEMA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CHECK_SCHEMA");
        }
...
/************************************************************************************************
 *     229610 characters generated by Talend Open Studio for Big Data 
