...
/**
 * Job: GENERATE_CUSTOMER_DIFF Purpose: Link Masters<br>
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    ...
    static byte[] commonByteArray_DEEPSEA_GENERATE_CUSTOMER_DIFF = new byte[0];
			    ...
			    public String businessKey2a;

				public String getBusinessKey2a () {
					return this.businessKey2a;
				}
				
			    public String businessKey2b;

				public String getBusinessKey2b () {
					return this.businessKey2b;
				}
		...
		synchronized(commonByteArrayLock_DEEPSEA_GENERATE_CUSTOMER_DIFF) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.businessKey2a = readString(dis);
					
					this.businessKey2b = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.businessKey2a,dos);
					
					// String
				
						writeString(this.businessKey2b,dos);
    ...
    public String toString() {
		...
		sb.append(",businessKey2a="+businessKey2a);
		sb.append(",businessKey2b="+businessKey2b);
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_1=null;
				...
				try{
	            	...
	            	// maybe due to authorization
							...
							aggregationStages.add(org.bson.Document.parse("{ $match : {'file.country.$id': ObjectId('" + globalMap.get("COUNTRY_ID").toString() + "'), 'file.collection.$id' : ObjectId('" + globalMap.get("COLLECTION_ID").toString() + "')} }"));
				...
				if(valueObj_tMongoDBInput_1!=null && valueObj_tMongoDBInput_1.toString().length() > 0) {
					row1.num = valueObj_tMongoDBInput_1.toString();
				}else{
					row1.num = null;
				}
...
row7_tmp.businessKey1 = row9.businessKey ;
row7_tmp.businessKey2a = row9.hash ;
row7_tmp.businessKey2b = String.valueOf(row9.num) ;
row7_tmp.customerName = row9.customerName ;
row7_tmp.locality = row9.locality ;
row7 = row7_tmp;
...
row19_tmp.ProviderCode = row5.businessKey1 ;
row19_tmp.locality = row5.locality ;
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		...
                        		    		row2HashKey.businessKey = row19.locality ;
 ...
 */
	...
	currentComponent="tFileOutputExcel_1";
		...
		xlsxTool_tFileOutputExcel_1.setSheet("Mega.Diff");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
        ...
        new BytesLimit65535_tAdvancedHash_row4().limitLog4jByte();
			   		...
			   		// source node:tDBInput_5 - inputs:(after_tMongoDBInput_1) outputs:(row4,row4) | target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
...
/************************************************************************************************
 *     386642 characters generated by Talend Open Studio for Big Data 
 *     on the 9 November, 2018 8:19:22 AM CST
 ************************************************************************************************/