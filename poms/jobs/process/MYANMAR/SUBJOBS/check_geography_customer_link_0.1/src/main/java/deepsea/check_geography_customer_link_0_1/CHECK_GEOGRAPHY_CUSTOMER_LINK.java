...
+"level, n.nodeId, CAST(CONCAT(n.nodeId, '*', sg.code) AS VARCHAR(100))\n    FROM sat_geography sg\n        INNER JOIN nod"
+"es n ON sg.parent_code = n.code AND sg.level = n.level + 1\n),\nconstants(maxlevel) AS\n(\n    SELECT\n        MAX(level"
+") AS maxlevel\n    FROM\n        sat_geography\n)\nSELECT DISTINCT\n	sc.code,\n    sc.name_en,\n    sc.geography_code,\n"
+"    sg.level\nFROM\n    link_geography_customer lgc\n        INNER JOIN hub_geography hg ON lgc.hub_id1 = hg.id\n       "
+"     INNER JOIN sat_geography sg ON hg.id = sg.hub_id\n                LEFT JOIN nodes n ON sg.code = n.code AND 5 = n.l"
+"evel\n        INNER JOIN hub_customer hc ON lgc.hub_id2 = hc.id\n            INNER JOIN sat_customer sc ON hc.id=sc.hub_"
+"id\n    CROSS JOIN constants\nWHERE\n    n.nodeId IS NULL AND\n    lgc.source='myanmar.master.customer.mega'";
			...
			com.mongodb.client.MongoDatabase db_tMongoDBInput_1=null;
				...
				try{
	            	...
	            	// maybe due to authorization
							...
							aggregationStages.add(org.bson.Document.parse("{ $match : {'file.metadata.type' : 'Customer', 'sheetName' : 'Mega' } }"));
...
/************************************************************************************************
 *     174879 characters generated by Talend Open Studio for Big Data 
