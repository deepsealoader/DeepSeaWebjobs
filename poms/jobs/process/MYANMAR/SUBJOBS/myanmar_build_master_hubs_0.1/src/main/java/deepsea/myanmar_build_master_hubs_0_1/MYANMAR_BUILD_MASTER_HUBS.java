...
package deepsea.myanmar_build_master_hubs_0_1;
...
/**
 * Job: MYANMAR_BUILD_MASTER_HUBS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class MYANMAR_BUILD_MASTER_HUBS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "MYANMAR_BUILD_MASTER_HUBS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MYANMAR_BUILD_MASTER_HUBS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MYANMAR_BUILD_MASTER_HUBS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		obj_tRunJob_5 = "myanmar.master.markethierarchy.servier";
		if(obj_tRunJob_5!=null) {
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		obj_tRunJob_7 = "myanmar.master.organizationhierarchy.servier";
		if(obj_tRunJob_7!=null) {
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		obj_tRunJob_6 = "myanmar.master.sourcechannel.servier";
		if(obj_tRunJob_6!=null) {
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = "myanmar.master.producthierarchy.mega";
		if(obj_tRunJob_3!=null) {
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		obj_tRunJob_4 = "myanmar.master.geographyhierarchy.servier";
		if(obj_tRunJob_4!=null) {
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		obj_tRunJob_8 = "myanmar.master.customer.mega";
		if(obj_tRunJob_8!=null) {
 ...
 */
    ...
    public static void main(String[] args){
        final MYANMAR_BUILD_MASTER_HUBS MYANMAR_BUILD_MASTER_HUBSClass = new MYANMAR_BUILD_MASTER_HUBS();

        int exitCode = MYANMAR_BUILD_MASTER_HUBSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MYANMAR_BUILD_MASTER_HUBS.class.getClassLoader().getResourceAsStream("deepsea/myanmar_build_master_hubs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MYANMAR_BUILD_MASTER_HUBS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MYANMAR_BUILD_MASTER_HUBS");
        }
...
/************************************************************************************************
 *     125354 characters generated by Talend Open Studio for Big Data 
 *     on the February 6, 2019 8:57:05 AM CST
 ************************************************************************************************/