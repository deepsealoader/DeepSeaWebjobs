...
public class BUILD_SALES_LINKS implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(BUILD_SALES_LINKS.this, new Object[] { e,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (obj_tRunJob_1 != null) {
					paraList_tRunJob_1
							.add("--context_param EXCEPTION_IF_NO_LINK="
									+ RuntimeUtils
											.tRunJobConvertContext(obj_tRunJob_1));
				} else {
					paraList_tRunJob_1
				...
				parentContextMap_tRunJob_1.put("EXCEPTION_IF_NO_LINK",
						obj_tRunJob_1);

				obj_tRunJob_1 = false;
				if (obj_tRunJob_1 != null) {
					paraList_tRunJob_1
							.add("--context_param FORCE_UPDATE="
									+ RuntimeUtils
											.tRunJobConvertContext(obj_tRunJob_1));
				} else {
					paraList_tRunJob_1
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parentContextMap_tRunJob_2.put("EXCEPTION_IF_NO_LINK",
						obj_tRunJob_2);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUILD_SALES_LINKS.class
					.getClassLoader().getResourceAsStream(
							"deepsea/build_sales_links_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = BUILD_SALES_LINKS.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : BUILD_SALES_LINKS");
		}
...
/************************************************************************************************
 * 56363 characters generated by Talend Open Studio for Big Data on the 1
 * December, 2018 11:54:34 PM CST
 ************************************************************************************************/
