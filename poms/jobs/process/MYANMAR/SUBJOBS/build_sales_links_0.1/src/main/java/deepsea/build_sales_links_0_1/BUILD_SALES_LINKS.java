...
package deepsea.build_sales_links_0_1;
...
/**
 * Job: BUILD_SALES_LINKS Purpose: <br>
 * Description:  <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class BUILD_SALES_LINKS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "BUILD_SALES_LINKS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				BUILD_SALES_LINKS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(BUILD_SALES_LINKS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = "myanmar.master.geographyhierarchy.servier";
		if(obj_tRunJob_3!=null) {
		...
		deepsea.link_sales_geography_0_1.LINK_SALES_GEOGRAPHY childJob_tRunJob_3 = new deepsea.link_sales_geography_0_1.LINK_SALES_GEOGRAPHY();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final BUILD_SALES_LINKS BUILD_SALES_LINKSClass = new BUILD_SALES_LINKS();

        int exitCode = BUILD_SALES_LINKSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = BUILD_SALES_LINKS.class.getClassLoader().getResourceAsStream("deepsea/build_sales_links_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = BUILD_SALES_LINKS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : BUILD_SALES_LINKS");
        }
...
/************************************************************************************************
 *     60940 characters generated by Talend Open Studio for Big Data 
 *     on the October 15, 2018 2:58:46 AM CST
 ************************************************************************************************/