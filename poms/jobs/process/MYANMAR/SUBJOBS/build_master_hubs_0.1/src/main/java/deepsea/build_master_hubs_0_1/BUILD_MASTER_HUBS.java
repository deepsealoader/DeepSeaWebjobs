...
package deepsea.build_master_hubs_0_1;
...
/**
 * Job: BUILD_MASTER_HUBS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class BUILD_MASTER_HUBS implements TalendJob {
...
public String getPOSTGRES_HOSTNAME(){
	...
	private final String jobName = "BUILD_MASTER_HUBS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				BUILD_MASTER_HUBS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(BUILD_MASTER_HUBS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final BUILD_MASTER_HUBS BUILD_MASTER_HUBSClass = new BUILD_MASTER_HUBS();

        int exitCode = BUILD_MASTER_HUBSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = BUILD_MASTER_HUBS.class.getClassLoader().getResourceAsStream("deepsea/build_master_hubs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = BUILD_MASTER_HUBS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : BUILD_MASTER_HUBS");
        }
...
/************************************************************************************************
 *     127258 characters generated by Talend Open Studio for Big Data 
