...
public class BUILD_MASTER_HUBS implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(BUILD_MASTER_HUBS.this, new Object[] { e,
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (obj_tRunJob_5 != null) {
					paraList_tRunJob_5
							.add("--context_param BUSINESS_KEY="
									+ RuntimeUtils
											.tRunJobConvertContext(obj_tRunJob_5));
				} else {
					paraList_tRunJob_5
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (obj_tRunJob_10 != null) {
					paraList_tRunJob_10.add("--context_param SOURCE="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_10));
				} else {
					paraList_tRunJob_10
				...
				if (obj_tRunJob_10 != null) {
					paraList_tRunJob_10.add("--context_param TABLE="
							+ RuntimeUtils
									.tRunJobConvertContext(obj_tRunJob_10));
				} else {
					paraList_tRunJob_10
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = BUILD_MASTER_HUBS.class
					.getClassLoader().getResourceAsStream(
							"deepsea/build_master_hubs_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = BUILD_MASTER_HUBS.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : BUILD_MASTER_HUBS");
		}
...
/************************************************************************************************
 * 127194 characters generated by Talend Open Studio for Big Data on the 1
 * December, 2018 11:52:20 PM CST
 ************************************************************************************************/
