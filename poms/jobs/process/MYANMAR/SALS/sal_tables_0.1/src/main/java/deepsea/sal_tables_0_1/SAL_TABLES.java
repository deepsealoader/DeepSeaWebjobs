...
package deepsea.sal_tables_0_1;
...
/**
 * Job: SAL_TABLES Purpose: Link tables<br>
 * Description: Link tables <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAL_TABLES implements TalendJob {
...
public String getSOURCE2(){
	...
	private final String jobName = "SAL_TABLES";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_nQaEUL-hEeip__KOlv70Sw", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAL_TABLES.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row12Struct implements routines.system.IPersistableRow<row12Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_SAL_TABLES = new byte[0];
    static byte[] commonByteArray_DEEPSEA_SAL_TABLES = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_SAL_TABLES.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_SAL_TABLES.length == 0) {
   					commonByteArray_DEEPSEA_SAL_TABLES = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_SAL_TABLES = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_SAL_TABLES, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_SAL_TABLES, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAL_TABLES) {
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	...
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + (String) globalMap.get("SAL_TABLE");
}
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_4 ) {
exception1_tmp.source = row5.source ;
exception1_tmp.businessKey1 = row5.businessKey1 ;
exception1_tmp.businessKey2 = row5.businessKey2 ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
exception2_tmp.source = row10.source ;
exception2_tmp.hubId1 = row10.hubId1 ;
exception2_tmp.businessKey2 = row10.businessKey2 ;
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread.currentThread().getId() + "", "WARN","","Product not found with code: " + exception2.businessKey2,"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_2", 4, "Product not found with code: " + exception2.businessKey2, 42);
	tLogCatcher_1Process(globalMap);
	globalMap.put("tWarn_2_WARN_MESSAGES", "Product not found with code: " + exception2.businessKey2); 
...
try {
	...
	resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread.currentThread().getId() + "", "WARN","","Product not found with code: " + exception1.businessKey1,"", "");
	tLogCatcher_1.addMessage("tWarn", "tWarn_1", 4, "Product not found with code: " + exception1.businessKey1, 42);
	tLogCatcher_1Process(globalMap);
	globalMap.put("tWarn_1_WARN_MESSAGES", "Product not found with code: " + exception1.businessKey1); 
 ...
 */
	...
	currentComponent="tDBInput_2";
        ...
        new BytesLimit65535_tDBInput_2().limitLog4jByte();
		    ...
		    String dbquery_tDBInput_2 = "SELECT DISTINCT\n	hash\nfrom\n	" + globalMap.get("HUB_TABLE") + " as a inner join " + globalMap.get("SAL_TABLE") + " as b on a.id = b.hub_id2\nWHERE\n	a.source = '" + context.getSOURCE2() + "'";
...
globalMap.put("SAL_TABLE",  TalendString.unionString("_", "sal", context.getTABLE()));
globalMap.put("HUB_TABLE", TalendString.unionString("_", "hub", context.getTABLE()));
 ...
 */
    ...
    public static void main(String[] args){
        final SAL_TABLES SAL_TABLESClass = new SAL_TABLES();

        int exitCode = SAL_TABLESClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAL_TABLES.class.getClassLoader().getResourceAsStream("deepsea/sal_tables_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAL_TABLES.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAL_TABLES");
        }
...
/************************************************************************************************
 *     237201 characters generated by Talend Open Studio for Big Data 
 *     on the 28 September, 2018 5:22:21 PM CEST
 ************************************************************************************************/