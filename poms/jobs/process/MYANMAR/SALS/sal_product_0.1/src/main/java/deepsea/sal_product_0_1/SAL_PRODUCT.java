...
package deepsea.sal_product_0_1;
...
/**
 * Job: SAL_PRODUCT Purpose: Update Product SAL<br>
 * Description: Update Product SAL <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class SAL_PRODUCT implements TalendJob {
...
public String getBUSINESS_KEY2(){
	...
	private final String jobName = "SAL_PRODUCT";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_LOmEAL8gEei1o6hwlGs10Q", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SAL_PRODUCT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row12Struct implements routines.system.IPersistableRow<row12Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_SAL_PRODUCT = new byte[0];
    static byte[] commonByteArray_DEEPSEA_SAL_PRODUCT = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_SAL_PRODUCT.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_SAL_PRODUCT.length == 0) {
   					commonByteArray_DEEPSEA_SAL_PRODUCT = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_SAL_PRODUCT = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_SAL_PRODUCT, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_SAL_PRODUCT, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_SAL_PRODUCT) {
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = "sal_product";
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + "sal_product";
}
 ...
 */
	...
	currentComponent="tDBInput_2";
        ...
        new BytesLimit65535_tDBInput_2().limitLog4jByte();
		    ...
		    String dbquery_tDBInput_2 = "SELECT DISTINCT\n	hash\nfrom\n	hub_product inner join sal_product on hub_product.id = sal_product.hub_id2\nWHERE\n	hub_produ"
+"ct.source = '" + context.getSOURCE2() + "'";
 ...
 */
    ...
    public static void main(String[] args){
        final SAL_PRODUCT SAL_PRODUCTClass = new SAL_PRODUCT();

        int exitCode = SAL_PRODUCTClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SAL_PRODUCT.class.getClassLoader().getResourceAsStream("deepsea/sal_product_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SAL_PRODUCT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SAL_PRODUCT");
        }
...
/************************************************************************************************
 *     220987 characters generated by Talend Open Studio for Big Data 
 *     on the September 24, 2018 9:16:00 AM SGT
 ************************************************************************************************/