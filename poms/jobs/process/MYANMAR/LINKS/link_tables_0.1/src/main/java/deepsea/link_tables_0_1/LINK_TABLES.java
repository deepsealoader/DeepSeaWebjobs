...
package deepsea.link_tables_0_1;
...
/**
 * Job: LINK_TABLES Purpose: Link tables<br>
 * Description: Link tables <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class LINK_TABLES implements TalendJob {
...
public String getSOURCE2(){
	...
	private final String jobName = "LINK_TABLES";
...
private RunStat runStat = new RunStat();
	...
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_zYv94L-bEeip__KOlv70Sw", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LINK_TABLES.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row12Struct implements routines.system.IPersistableRow<row12Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_LINK_TABLES = new byte[0];
    static byte[] commonByteArray_DEEPSEA_LINK_TABLES = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_LINK_TABLES.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_LINK_TABLES.length == 0) {
   					commonByteArray_DEEPSEA_LINK_TABLES = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_LINK_TABLES = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_LINK_TABLES, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_LINK_TABLES, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_LINK_TABLES) {
 ...
 */
    ...
    public static void main(String[] args){
        final LINK_TABLES LINK_TABLESClass = new LINK_TABLES();

        int exitCode = LINK_TABLESClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LINK_TABLES.class.getClassLoader().getResourceAsStream("deepsea/link_tables_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LINK_TABLES.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LINK_TABLES");
        }
...
/************************************************************************************************
 *     237932 characters generated by Talend Open Studio for Big Data 
 *     on the 28 September, 2018 5:22:22 PM CEST
 ************************************************************************************************/