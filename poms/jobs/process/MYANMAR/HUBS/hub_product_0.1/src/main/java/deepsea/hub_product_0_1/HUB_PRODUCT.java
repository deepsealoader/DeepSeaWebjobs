...
package deepsea.hub_product_0_1;
...
/**
 * Job: HUB_PRODUCT Purpose: Update Product HUB<br>
 * Description: Update Product HUB <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HUB_PRODUCT implements TalendJob {
...
public String getBUSINESS_KEY(){
	...
	private final String jobName = "HUB_PRODUCT";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HUB_PRODUCT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_HUB_PRODUCT = new byte[0];
    static byte[] commonByteArray_DEEPSEA_HUB_PRODUCT = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_HUB_PRODUCT.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_HUB_PRODUCT.length == 0) {
   					commonByteArray_DEEPSEA_HUB_PRODUCT = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_HUB_PRODUCT = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_HUB_PRODUCT, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_HUB_PRODUCT, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_HUB_PRODUCT) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + "hub_product";
}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = "hub_product";
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + "hub_product";
}
				...
				try{
					...
					for (com.mongodb.DBObject index: coll_tMongoDBInput_2.listIndexes(com.mongodb.DBObject.class)) {
	                    ...
	                    for (String key: ((com.mongodb.DBObject)index.get("key")).keySet()) {
	                        ...
	                        // - is followed at some point by a colon
	                        // - there is no comma between the the DBcolumnName and the colon
	                        if  (("{'metadata.type' : 'ProductHierarchy'}, {_id: 1}").matches(".*" + key + "[^,]*:.*")) {
	                            // We have an index, do not print error message
	                            needIndexWarning = false;
	                        } else {
	                            // This index is not in the query, add it into the indexList
					...
					org.bson.Document myQuery_tMongoDBInput_2 = org.bson.Document.parse("{'metadata.type' : 'ProductHierarchy'}, {_id: 1}");
 ...
 */
    ...
    public static void main(String[] args){
        final HUB_PRODUCT HUB_PRODUCTClass = new HUB_PRODUCT();

        int exitCode = HUB_PRODUCTClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HUB_PRODUCT.class.getClassLoader().getResourceAsStream("deepsea/hub_product_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HUB_PRODUCT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HUB_PRODUCT");
        }
...
/************************************************************************************************
 *     184028 characters generated by Talend Open Studio for Big Data 
