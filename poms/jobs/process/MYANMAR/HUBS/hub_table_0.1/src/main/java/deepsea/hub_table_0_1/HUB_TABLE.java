...
/**
 * Job: HUB_TABLE Purpose: Update Table HUB<br>
 * Description: Update Table HUB <br>
 * @author romualdrousseau@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class HUB_TABLE implements TalendJob {
...
public String getTABLE(){
	...
	private final String jobName = "HUB_TABLE";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HUB_TABLE.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_DEEPSEA_HUB_TABLE = new byte[0];
    static byte[] commonByteArray_DEEPSEA_HUB_TABLE = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DEEPSEA_HUB_TABLE.length) {
				if(length < 1024 && commonByteArray_DEEPSEA_HUB_TABLE.length == 0) {
   					commonByteArray_DEEPSEA_HUB_TABLE = new byte[1024];
				} else {
   					commonByteArray_DEEPSEA_HUB_TABLE = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DEEPSEA_HUB_TABLE, 0, length);
			strReturn = new String(commonByteArray_DEEPSEA_HUB_TABLE, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DEEPSEA_HUB_TABLE) {
 ...
 */
    ...
    public static void main(String[] args){
        final HUB_TABLE HUB_TABLEClass = new HUB_TABLE();

        int exitCode = HUB_TABLEClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HUB_TABLE.class.getClassLoader().getResourceAsStream("deepsea/hub_table_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HUB_TABLE.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HUB_TABLE");
        }
...
/************************************************************************************************
 *     202021 characters generated by Talend Open Studio for Big Data 
 *     on the 28 September, 2018 5:22:19 PM CEST
 ************************************************************************************************/